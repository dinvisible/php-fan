...
{
    protected const SOURCE_FILE = 'core/block/admin/upload_size_limit_provider.php';
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 4) . '/core/block/admin/upload_size_limit_provider_aware_trait.php');
