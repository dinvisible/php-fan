...
final class LegacyDiSourceInventoryTest extends TestCase
{
    ...
    public function testCacheConfigFatalConstructionUsesInjectedFactory(): void
    {
        ...
        $this->assertStringNotContainsString('private mixed $configCacheFatalExceptionFactory', $source);
    ...
    public function testBootstrapLoaderFilesystemOperationsAreInjected(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $fatalExceptionFactory = null;', $source);
    ...
    public function testDebugMetaFileChecksAreInjected(): void
    {
        ...
        $this->assertStringNotContainsString('private mixed $arrayAdducer', $source);
    ...
    public function testCookieStateDependencyIsInjected(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $cookieValueEncoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $cookieValueDecoder = null;', $source);
    ...
    public function testUserStateDependencyIsInjected(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $userEngineFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $instanceKeyEncoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $snapshotEncoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $snapshotDecoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $arrayAdducer = null;', $source);
        ...
        $this->assertStringNotContainsString('private mixed $userEngineFactory = null;', $source);
    ...
    public function testUserBaseEngineUsesFacadeFatalExceptionFactory(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $snapshotEncoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $snapshotDecoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $arrayValueReader = null;', $source);
        $this->assertStringContainsString('private ?\Closure $arrayAdducer = null;', $source);
    ...
    public function testRestServiceDependenciesAreInjectedWithoutNullableClosureState(): void
    {
        ...
        $this->assertIsString($source);
        $this->assertStringContainsString('private ?\Closure $jsonFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $curlFactory = null;', $source);
        ...
        $this->assertStringNotContainsString('private mixed $jsonFactory', $source);
        $this->assertStringNotContainsString('private mixed $curlFactory', $source);
        $this->assertStringNotContainsString('private mixed $errorFactory', $source);
    ...
    public function testCacheBaseEngineUsesInjectedFatalExceptionFactory(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $payloadEncoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $payloadDecoder = null;', $source);
        $this->assertStringContainsString('private ?\Closure $jsonPayloadChecker = null;', $source);
    ...
    public function testFileDataCacheWrapperFileMetadataOperationsAreInjected(): void
    {
        ...
        $this->assertIsString($source);
        $this->assertStringContainsString('private ?\Closure $cacheFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $entityFactory = null;', $source);
        ...
        $this->assertStringNotContainsString('private mixed $cacheFactory', $source);
        $this->assertStringNotContainsString('private mixed $entityFactory', $source);
    ...
    public function testBaseModelEntityFatalExceptionConstructionIsInjected(): void
    {
        ...
        $this->assertStringContainsString('private ?\Closure $namespaceResolver = null;', $entitySource);
        ...
        $this->assertStringNotContainsString('private mixed $namespaceResolver', $entitySource);
    ...
    public function testSoapRuntimeObjectsAreInjected(): void
    {
        ...
        $this->assertIsString($factorySource);
        $this->assertStringContainsString('private ?\Closure $arrayValueReader = null;', $source);
        $this->assertStringContainsString('private ?\Closure $soapHeaderFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $soapClientFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $soapVarFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $domDocumentFactory = null;', $source);
        $this->assertStringContainsString('private ?\Closure $streamContextFactory = null;', $source);
        $this->assertStringContainsString('$this->arrayValueReader = \Closure::fromCallable(', $source);
