...
require_once __DIR__ . '/../../mock/core/exception/RuntimeStubs.php';
require_once __DIR__ . '/../../../core/exception/base.php';
require_once __DIR__ . '/../../../core/exception/fatal.php';
...
class ExceptionFatalTest extends TestCase
{
    ...
    {
        $source = file_get_contents(__DIR__ . '/../../../core/exception/fatal.php');
