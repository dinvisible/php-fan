...
require_once __DIR__ . '/../../mock/core/exception/TestException.php';

use FanTest\core\exception\TestException;
...
class ExceptionBaseTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/exception/base.php');
