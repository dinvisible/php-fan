...
use FanTest\core\base\meta\TestMetaBlock;
...
require_once dirname(__DIR__, 4) . '/core/block/base.php';
...
class MetaMakerTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 4) . '/core/base/meta/maker.php');
