...
{
    protected const SOURCE_FILE = 'core/adapter/request_input_native_environment.php';
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/adapter/request_input_native_environment.php');
