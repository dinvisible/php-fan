...
{
    protected const SOURCE_FILE = 'core/service/tab.php';
    ...
    public function testArrayConfigRowsAreConvertedToArrays(): void
    {
        ...
        require_once dirname(__DIR__, 3) . '/core/service/config/row.php';
    ...
    {
        require_once dirname(__DIR__, 3) . '/core/di/container_interface.php';
        require_once dirname(__DIR__, 3) . '/core/base/service.php';
        require_once dirname(__DIR__, 3) . '/core/base/service/single.php';

        if (!class_exists('\fan\core\service\tab', false)) {
            require_once dirname(__DIR__, 3) . '/core/service/tab.php';
        }
