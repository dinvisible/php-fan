...
{
    protected const SOURCE_FILE = 'core/service/matcher/item.php';
    ...
    {
        require_once dirname(__DIR__, 4) . '/core/service/matcher/item.php';
    ...
    {
        require_once dirname(__DIR__, 4) . '/core/service/matcher/item/base.php';
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 4) . '/core/service/matcher/item/base.php');
    ...
    {
        require_once dirname(__DIR__, 4) . '/unit/mock/core/base/DataFunctions.php';
        require_once dirname(__DIR__, 4) . '/core/base/data.php';
        require_once dirname(__DIR__, 4) . '/core/service/config/row.php';
        require_once dirname(__DIR__, 4) . '/core/service/matcher/item.php';
