...
final class BootstrapOperationsFactoryTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/factory/bootstrap_operations_factory.php');
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 3) . '/core/application/bootstrap_static_operations.php');
    }
}
