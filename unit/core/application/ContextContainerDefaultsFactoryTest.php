...
final class ContextContainerDefaultsFactoryTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/factory/context_container_defaults_factory.php');
        $contextCoreSource = file_get_contents(dirname(__DIR__, 3) . '/core/factory/context_core_defaults_provider_factory.php');
