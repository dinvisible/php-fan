...
final class BootstrapOperationsDefaultsProviderFactoryTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/factory/bootstrap_operations_defaults_provider_factory.php');
        $defaultsSource = file_get_contents(dirname(__DIR__, 3) . '/core/factory/bootstrap_operations_defaults_factory.php');
