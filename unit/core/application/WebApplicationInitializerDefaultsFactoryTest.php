...
final class WebApplicationInitializerDefaultsFactoryTest extends TestCase
{
    ...
    public function testFactoryOwnsWebApplicationInitializerDefaultDependencies(): void
    {
        ...
        $this->assertStringContainsString("require_once dirname(__DIR__) . '/core/functions.php';", $composerAutoloadSource);
        ...
        $this->assertStringContainsString('}, true, true);', $composerAutoloadSource);
