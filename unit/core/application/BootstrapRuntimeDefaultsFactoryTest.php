...
final class BootstrapRuntimeDefaultsFactoryTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/core/factory/bootstrap_runtime_defaults_factory.php');
        $contextDefaultsSource = file_get_contents(dirname(__DIR__, 3) . '/core/factory/context_defaults_factory.php');
        $contextCoreDefaultsSource = file_get_contents(dirname(__DIR__, 3) . '/core/factory/context_core_defaults_provider_factory.php');
