...
final class BootstrapContextTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/application/context.php');
        $containerFactorySource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/context_container_factory.php');
        $defaultsFactorySource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/context_defaults_factory.php');
        $coreDefaultsFactorySource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/context_core_defaults_provider_factory.php');
    ...
    public function testContextRejectsInvalidDefaultFactories(): void
    {
        ...
        $this->assertStringContainsString('Bootstrap context default factories must provide callable', file_get_contents(dirname(__DIR__, 3) . '/_core/application/context.php'));
    }
