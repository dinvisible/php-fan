...
final class BootstrapApplicationTest extends TestCase
{
    ...
    public function testApplicationInjectsFatalExceptionFactoryIntoLoaderCallback(): void
    {
        ...
        $loader = $defineObj->invoke(
            ...
            'loader',
            loader::class,
            dirname(__DIR__, 3) . '/_core/application/loader.php'
        );
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/application/application.php');
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 3) . '/_core/application/context_registry_state_default_factory.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 3) . '/_core/application/context_registry_state_factory.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 3) . '/_core/bootstrap.php');
    }
