...
final class RequestInputDefaultsProviderFactoryTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/request_input_defaults_provider_factory.php');
        $defaultsSource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/runtime/request_input_defaults_factory.php');
