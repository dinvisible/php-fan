...
require_once dirname(__DIR__, 3) . '/_core/factory/transfer_exception_factory.php';
require_once dirname(__DIR__, 2) . '/mock/_core/base/TransferStubs.php';
require_once dirname(__DIR__, 3) . '/_core/base/transfer.php';
require_once dirname(__DIR__, 3) . '/_core/base/transfer/out.php';
require_once dirname(__DIR__, 3) . '/_core/base/transfer/transfer_int.php';
require_once dirname(__DIR__, 3) . '/_core/base/transfer/sham.php';

final class ServiceTransferTest extends SourceFileContractTestCase
{
    protected const SOURCE_FILE = '_core/service/transfer.php';
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/service/transfer.php');
