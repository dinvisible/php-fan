...
final class PhpArrayFileLoaderTest extends TestCase
{
    ...
    {
        $adapterSource = file_get_contents(dirname(__DIR__, 3) . '/_core/adapter/php_array_file.php');
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/adapter/php_array_file_loader.php');
