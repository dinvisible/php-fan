...
final class LegacyDiSourceInventoryTest extends TestCase
{
    ...
    {
        $allowedFiles = [
            '_core/factory/service_factory_map.php' => true,
        ];
        $matches = [];
    ...
    {
        $stateSource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/session_state.php');
        $registrySource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_state_registry.php');
    ...
    public function testRequestInputConcreteConstructionIsLimitedToExplicitBoundaries(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/runtime/request_input_factory.php' => true,
            ],
    ...
    public function testDateExceptionConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/date_exception_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cache.php');
    ...
    public function testConfigRowConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/config_row_factory.php' => true,
            ],
    ...
    public function testServiceFatalExceptionConstructionIsLimitedToKnownBoundariesAndPendingLeafThrowSites(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/service_exception_factory.php' => true,
            ],
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/exception/template/fatal.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/template_exception_factory.php');
    }

    public function testTemplateExceptionFactoryIsNotRegistered(): void
    {
        $registrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    public function testPlainFatalExceptionConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/plain_exception_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/exception/plain/fatal.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/plain_exception_factory.php');
        $registrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    public function testProjectFatalExceptionConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/fatal_exception_factory.php' => true,
            ],
    ...
    public function testCoreFatalExceptionConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/core_fatal_exception_factory.php' => true,
            ],
    ...
    public function testError500ExceptionConstructionIsLimitedToExplicitBoundaries(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/error500_exception_factory.php' => true,
            ],
    ...
    public function testRequestInputFileLoadIsLimitedToExplicitFactories(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/request_input_source_defaults_provider_factory.php' => true,
            ],
    ...
    {
        $allowedFiles = [
            '_core/adapter/bootstrap_loader_file_storage.php' => true,
            '_core/adapter/compiled_template_loader.php' => true,
            '_core/adapter/error_demonstrator_loader.php' => true,
            '_core/adapter/php_array_file.php' => true,
            '_core/adapter/php_template_file.php' => true,
            '_core/adapter/project_tool_loader.php' => true,
            '_core/adapter/zend_autoloader.php' => true,
            '_core/application/application.php' => true,
            '_core/factory/application_container_defaults_provider_factory.php' => true,
            '_core/factory/application_container_creator_defaults_provider_factory.php' => true,
            '_core/factory/application_container_factory_callable_factory.php' => true,
            '_core/factory/application_container_factory_provider_defaults_provider_factory.php' => true,
            '_core/factory/application_container_operations_defaults_provider_factory.php' => true,
            '_core/factory/application_container_registrar_defaults_provider_factory.php' => true,
            '_core/factory/application_container_registry_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_autoloader_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_loader_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_object_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_runtime_service_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_runtime_state_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_runtime_operations_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_runtime_service_factory_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_runtime_state_factory_defaults_provider_factory.php' => true,
            '_core/factory/context_core_defaults_provider_factory.php' => true,
            '_core/factory/context_factory.php' => true,
            '_core/factory/context_error_handling_defaults_provider_factory.php' => true,
            '_core/factory/context_support_defaults_provider_factory.php' => true,
            '_core/factory/error_logger_defaults_provider_factory.php' => true,
            '_core/application/loader.php' => true,
            '_core/factory/bootstrap_operations_defaults_provider_factory.php' => true,
            '_core/factory/request_input_source_defaults_provider_factory.php' => true,
            '_core/factory/request_input_defaults_provider_factory.php' => true,
            '_core/factory/bootstrap_state_defaults_factory.php' => true,
            '_core/factory/application_container_factory.php' => true,
            '_core/di/application_adapter_registry_defaults_provider.php' => true,
            '_core/factory/application_core_service_factory_defaults_provider_factory.php' => true,
            '_core/factory/application_deferred_service_factory_provider_factory.php' => true,
            '_core/factory/application_factory_provider_defaults_provider_factory.php' => true,
            '_core/factory/application_model_factory_defaults_provider_factory.php' => true,
            '_core/factory/application_registry_defaults_provider_factory.php' => true,
            '_core/factory/application_runtime_factory_defaults_provider_factory.php' => true,
            '_core/factory/application_service_creator_defaults_provider_factory.php' => true,
            '_core/factory/application_service_engine_factory_defaults_provider_factory.php' => true,
            '_core/factory/application_service_factory_defaults_provider_factory.php' => true,
            '_core/factory/application_service_factory_defaults_provider.php' => true,
            '_core/factory/application_service_registrar_defaults_provider_factory.php' => true,
            '_core/factory/application_service_sub_factory_defaults_provider_factory.php' => true,
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/service_factory_registry.php');
    ...
    public function testBootstrapConcreteDefaultsAreLimitedToExplicitFactories(): void
    {
        ...
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/bootstrap_config_defaults_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/application/loader.php');
        $applicationSource = file_get_contents(dirname(__DIR__, 2) . '/_core/application/application.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/application/application.php');

        $this->assertIsString($source);
        $this->assertStringContainsString('$bootstrapFileStorage = $this->context()->bootstrapLoaderFileStorage();', $source);
        $this->assertStringContainsString('$bootstrapFileStorage->realPath(CORE_DIR . \'/../_project\')', $source);
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/bootstrap.php');
        $this->assertDoesNotMatchRegularExpression(
    ...
    public function testRootWebEntrypointDelegatesToWebInitializer(): void
    {
        ...
        $initializerSource = file_get_contents(dirname(__DIR__, 2) . '/_core/application/web_application_initializer.php');
        $initializerDefaultsSource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/web_application_initializer_defaults_factory.php');
        $runnerSource = file_get_contents(dirname(__DIR__, 2) . '/_core/application/request_runner.php');
        $defaultsSource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/request_runner_defaults_factory.php');
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/application/bootstrap_context_setter.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/application/bootstrap_config_loader.php');
    ...
    public function testBootstrapLayerDoesNotOwnSelfDefaultFactories(): void
    {
        ...
        foreach ($this->productionPhpFiles() as $file) {
            $relativePath = $this->relativePath($file);
            if (!str_starts_with($relativePath, '_core/application/')) {
                continue;
            }
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/request_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/request.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/request.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/request_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/service_engine_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/curl_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/curl.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/curl_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_client_service_creator.php');
    ...
    {
        $allowedFiles = [
            '_core/adapter/curl_adapter.php' => true,
        ];
        $matches = [];
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/debug_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/debug.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/debug_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/reflector_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/reflector.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/reflector_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/entity.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_entity_factory.php');
        $defaultsFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_model_factory_defaults_provider_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/block_context.php');
        $registrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/adapter/reflection_class_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/file_system_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/file_system.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/plain/image.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/plain/db_file.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/matcher/item.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/header_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/header.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/header_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/error_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/error.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/error/demonstrator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/runtime/error_demonstrator_factory.php');
        $loaderSource = file_get_contents(dirname(__DIR__, 2) . '/_core/adapter/error_demonstrator_loader.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/date_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/date.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/date_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/cookie_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cookie.php');
    ...
    public function testCookieStateConstructionIsLimitedToCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/application_container_factory.php' => true,
                'unit/_core/service/CookieStateTest.php' => true,
                'unit/_core/service/CookieTest.php' => true,
                'unit/_core/di/CookieServiceFactoryTest.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/user.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_user_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/user/entity.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_engine_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/user/base.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_engine_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/user/config.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_engine_factory.php');
    ...
    public function testUserStateConstructionIsLimitedToCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/application_container_factory.php' => true,
                'unit/_core/service/UserStateTest.php' => true,
                'unit/_core/service/UserTest.php' => true,
                'unit/_core/di/UserServiceFactoryTest.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/service.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/bootstrap_runtime.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/json_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/obfuscator_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/obfuscator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/pager_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/role_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/translation_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/translation.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/locale_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/locale.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/locale_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/rest_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/rest.php');
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/form.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/form_state.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/form_service_factory.php');
    }
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/application.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/block_exception_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/block_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/cache_engine_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cache/base.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cache/file.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cache/memcache.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/cache_engine_factory.php');
        ...
        $this->assertPatternOnlyAppearsInAllowedFiles(
            '/new\s+\\\\Memcache\s*\(/',
            [
                '_core/factory/cache_engine_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/cache_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/cache/wrapper/file_data.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/config_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_infrastructure_service_creator.php');
        $supportRegistrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/config.php');
        $rowSource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/config/row.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/config_row_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/config/base.php');
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/database_engine_factory.php');
    }
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/adapter/data_loader.php');
        $runtimeDefaultsProviderSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_runtime_adapter_defaults_provider.php');
        $registryDefaultsProviderFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_registry_defaults_provider_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/block/loader/base.php');
        $blockBaseSource = file_get_contents(dirname(__DIR__, 2) . '/_core/block/base.php');
        $tabSource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/tab.php');
        $tabFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_service_factory.php');
        $supportRegistrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/tab.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_service_factory.php');
        $supportRegistrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/tab/delegate/urlMaker.php');
        $tabSource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/tab.php');
        $delegateFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_delegate_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/view/router.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/view_router_factory.php');
        $supportRegistrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    public function testTemplateServiceLayerIsRemoved(): void
    {
        ...
        $creatorSource = file_get_contents($root . '/_core/di/application_content_service_creator.php');
        $registrarSource = file_get_contents($root . '/_core/di/application_content_service_registrar.php');
        ...
        foreach ([
            ...
            '/_core/di/template_service_factory.php',
            '/_core/di/template_type_factory.php',
            '/_core/di/template_exception_factory.php',
    ...
    {
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_pager_service_creator.php');
        $supportRegistrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/form/validator/base.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/form/validator/number.php');
    }

    public function testDatabaseEngineBaseDoesNotOwnLegacyMysqlGlobalConstants(): void
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/database/base.php');
    }
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/email_engine_factory.php');
    }

    public function testEmailServiceFactoryDoesNotOwnConfiguredServiceDefault(): void
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/email_service_factory.php');
    }

    public function testEmailServiceDependenciesAreInjectedWithoutNullableClosureState(): void
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/service/email.php');
    }
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/entity_designer_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/entity_encapsulant_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/block/root/html.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/block/base.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/meta/maker.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/meta_maker_factory.php');
        $registrarSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/image_modify_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/image_modify.php');
    ...
    public function testImageModifyStateConstructionIsLimitedToCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/application_container_factory.php' => true,
                'unit/_core/service/ImageModifyStateTest.php' => true,
                'unit/_core/service/ImageModifyTest.php' => true,
                'unit/_core/di/ImageModifyServiceFactoryTest.php' => true,
            ],
    ...
    {
        $modifySource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/image_modify.php');
        $drawSource = file_get_contents(dirname(__DIR__, 2) . '/_core/service/image_draw.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/image_modify_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_utility_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/spec_file/image/row.php');
    ...
    {
        $rowSource = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/spec_file/image/row.php');
    ...
    public function testSpecFileImageRowStateConstructionIsLimitedToRuntimeCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/bootstrap_runtime_state_defaults_provider_factory.php' => true,
                '_core/factory/application_container_factory.php' => true,
                'unit/_core/base/model/spec_file/image/RowStateTest.php' => true,
                'unit/_core/base/model/spec_file/image/RowTest.php' => true,
                'unit/_core/di/EntityServiceFactoryTest.php' => true,
                'unit/_core/service/BootstrapRuntimeTest.php' => true,
                'unit/_core/service/EntityTest.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/matcher_item_component_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/matcher_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_entity_factory.php');
    ...
    {
        $entitySource = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/entity.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_entity_factory.php');
        $exceptionFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_entity_exception_factory.php');
    ...
    {
        $rowSource = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/row.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_row_factory.php');
        $exceptionFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_row_exception_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_request_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/request.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/rowset.php');
    ...
    public function testModelRequestFileStorageConstructionIsLimitedToCompositionRoot(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/di/application_adapter_registry.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_row_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/model_rowset_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/plain_controller_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/plain_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/session_engine_factory.php');
    ...
    public function testPearSessionHttpCallsAreLimitedToAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/adapter/pear_http_session.php' => true,
            ],
            'PEAR HTTP session static calls outside adapter'
        );

        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/session/pear.php');
    ...
    public function testNativeSessionCallsAreLimitedToAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/adapter/native_session.php' => true,
            ],
            'Native session calls outside adapter'
        );

        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/session/inbuilt.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/session_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/session.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/session_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_session_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/soap_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/soap.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/service/soap.php');
        $factorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/soap_service_factory.php');
        $creatorSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_utility_service_creator.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_delegate_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_service_factory.php');
    ...
    public function testTabViewDefinerConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/view_definer_factory.php' => true,
            ],
    ...
    public function testBlockMetaMakerConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/meta_maker_factory.php' => true,
            ],
    ...
    public function testDelayedMetaConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/delayed_meta_factory.php' => true,
            ],
    ...
    public function testTransferExceptionConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/transfer_exception_factory.php' => true,
            ],
    ...
    public function testViewRouterConstructionIsLimitedToExplicitFactory(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/view_router_factory.php' => true,
            ],
    ...
    public function testViewKeeperConstructionIsLimitedToExplicitFactories(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/view_keeper_factory.php' => true,
                '_core/factory/view_loader_json_keeper_factory.php' => true,
                '_core/factory/view_loader_text_keeper_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/tab_view_parser_factory.php');
    ...
    {
        $root = dirname(__DIR__, 2);
        $providerSource = file_get_contents($root . '/_core/factory/service_factory_registry.php');
        $bundleSource = file_get_contents($root . '/_core/factory/application_service_factory_bundle.php');
        $optionsSource = file_get_contents($root . '/_core/factory/application_service_factory_options.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/adapter/compiled_template_loader.php');
        ...
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/di/application_compiled_template_adapter_defaults_provider.php' => true,
                'unit/_core/adapter/CompiledTemplateLoaderStateTest.php' => true,
                'unit/_core/adapter/CompiledTemplateLoaderTest.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/timer_program_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/timer_service_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_engine_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/user_service_factory.php');
    ...
    {
        $allowedFiles = [
            '_core/adapter/request_input_native_environment.php' => true,
        ];
        $matches = [];
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/adapter/php_template_file.php');
    ...
    {
        $allowedFiles = [
            '_core/adapter/warning_capture.php' => true,
            '_core/runtime/error_handler_registrar.php' => true,
        ];
        $matches = [];
    ...
    {
        $allowedFiles = [
            '_core/runtime/php_runtime_settings.php' => true,
        ];
        $matches = [];
    ...
    public function testPhpRuntimeSettingsConstructionIsLimitedToCompositionRoot(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/di/application_support_service_registrar.php' => true,
                '_core/factory/context_error_handling_defaults_provider_factory.php' => true,
            ],
    ...
    {
        $providerSource = file_get_contents(dirname(__DIR__, 2) . '/_core/block/admin/upload_size_limit_provider.php');
        $traitSource = file_get_contents(dirname(__DIR__, 2) . '/_core/block/admin/upload_size_limit_provider_aware_trait.php');
    ...
    public function testNativeCookieWritesAreLimitedToExplicitAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            '/\bsetcookie\s*\(/',
            [
                '_core/adapter/cookie_writer.php' => true,
            ],
    ...
    {
        $allowedFiles = [
            '_core/adapter/error_log_writer.php' => true,
        ];
        $matches = [];
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/runtime/error_logger.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/exception/base.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/exception/fatal.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/data.php');
    ...
    {
        $allowedFiles = [
            '_core/adapter/header_writer.php' => true,
        ];
        $matches = [];
    ...
    public function testImageMetadataReadsAreLimitedToExplicitAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            '/\bgetimagesize\s*\(/',
            [
                '_core/adapter/image_metadata_reader.php' => true,
            ],
    ...
    public function testImageMetadataReaderConstructionIsLimitedToCompositionRoot(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/di/application_image_adapter_defaults_provider.php' => true,
            ],
    ...
    public function testImageResourceCreationIsLimitedToExplicitAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/adapter/image_resource_factory.php' => true,
            ],
    ...
    public function testImageCanvasOperationsAreLimitedToExplicitAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/adapter/image_canvas_operations.php' => true,
            ],
    ...
    public function testImageOutputWritesAreLimitedToExplicitAdapter(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/adapter/image_output_writer.php' => true,
            ],
    ...
    public function testSafeSerializerStaticCallsAreLimitedToExplicitOperationsBoundary(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            '/\bsafe_serializer::/',
            [
                '_core/adapter/safe_serializer_operations.php' => true,
            ],
    ...
    {
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/adapter/php_mailer.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/application_mailer_adapter_defaults_provider.php');
    ...
    public function testCoreAdapterDefaultsAreInjectedIntoCoreProvider(): void
    {
        ...
        $coreProviderSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_adapter_defaults_provider.php');
    ...
    {
        $runtimeProviderSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_runtime_adapter_defaults_provider.php');
        $sessionProviderSource = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_session_adapter_defaults_provider.php');
        $registryDefaultsProviderFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_registry_defaults_provider_factory.php');
    ...
    {
        $contextContainerFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_container_factory.php');
        $contextDefaultsFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_defaults_factory.php');
        $contextCoreDefaultsFactorySource = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_core_defaults_provider_factory.php');
        ...
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/container_registry.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/container_registry_state.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/container_registry_state_factory.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/container_provider.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/di/container_provider_factory.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/application/container_registry_state_factory.php');
        $this->assertFileDoesNotExist(dirname(__DIR__, 2) . '/_core/application/container_registry_state_setter.php');
    ...
    public function testContextCoreDefaultsConsumptionIsLimitedToCompositionRoot(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/context_defaults_factory.php' => true,
            ],
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/base/model/file_data/row.php');
    ...
    {
        $routerSource = file_get_contents(dirname(__DIR__, 2) . '/_core/view/router/loader.php');
        $parserSource = file_get_contents(dirname(__DIR__, 2) . '/_core/view/parser/loader.php');
        $blockSource = file_get_contents(dirname(__DIR__, 2) . '/_core/block/base.php');
    ...
    public function testViewLoaderStateConstructionIsLimitedToRuntimeCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                '_core/factory/bootstrap_runtime_state_defaults_provider_factory.php' => true,
                '_core/factory/application_container_factory.php' => true,
                '_core/factory/view_loader_state_factory.php' => true,
                'unit/_core/service/BootstrapRuntimeTest.php' => true,
                'unit/_core/view/parser/LoaderTest.php' => true,
                'unit/_core/view/router/LoaderStateTest.php' => true,
                'unit/_core/view/router/LoaderTest.php' => true,
            ],
    ...
    {
        $makerSource = file_get_contents(dirname(__DIR__, 2) . '/_core/base/meta/maker.php');
        $blockSource = file_get_contents(dirname(__DIR__, 2) . '/_core/block/base.php');
    ...
    public function testMetaMakerStateConstructionIsLimitedToRuntimeCompositionAndTests(): void
    {
        $this->assertPatternOnlyAppearsInAllowedFiles(
            ...
            [
                ...
                '_core/factory/application_service_factory_defaults_provider_factory.php' => true,
                '_core/factory/application_container_factory.php' => true,
                'unit/mock/_core/base/meta/MetaDoubles.php' => true,
                'unit/_core/base/meta/MakerStateTest.php' => true,
                'unit/_core/base/meta/MakerTest.php' => true,
                'unit/_core/service/BootstrapRuntimeTest.php' => true,
            ],
    ...
    private function productionPhpFiles(): array
    {
        ...
        foreach (['_core', '_project', 'htdocs'] as $directory) {
            $path = $root . '/' . $directory;
            if (!is_dir($path)) {
                continue;
            }
    ...
    private function isApplicationAdapterCompositionRoot(string $relativePath, string $pattern): bool
    {
        return in_array($relativePath, [
            '_core/di/application_adapter_registry.php',
            '_core/di/application_adapter_registry_defaults_provider.php',
            '_core/di/application_core_adapter_defaults_provider.php',
            '_core/di/application_storage_adapter_defaults_provider.php',
        ], true)
    ...
    {
        return $relativePath === '_core/di/application_state_registry.php'
    ...
    {
        return $relativePath === '_core/di/application_container_dependency_provider.php'
            && (
