...
final class FunctionsServiceContainerTest extends TestCase
{
    ...
    {
        $code = file_get_contents(dirname(__DIR__, 2) . '/_core/functions.php');
    ...
    {
        $code = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_container_factory.php');
    ...
    {
        $contextContainerFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_container_factory.php');
        $contextDefaultsFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_defaults_factory.php');
        $contextCoreDefaultsFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/context_core_defaults_provider_factory.php');
        $factoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_container_factory.php');
    ...
    {
        $factoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_container_factory.php');
        $supportRegistrarCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_support_service_registrar.php');
        $dependencyProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_container_dependency_provider.php');
        $factoryProviderDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_factory_provider_defaults_provider_factory.php');
    ...
    {
        $factoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_container_factory.php');
        $adapterRegistryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry.php');
        $adapterDefaultsProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry_defaults_provider.php');
        $coreAdapterDefaultsProviderCode = $this->applicationCoreAdapterDefaultsProviderCode();
        $registryDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_registry_defaults_provider_factory.php');
    ...
    public function testDatabaseEngineGraphDoesNotRegisterRemovedAdodbAdapter(): void
    {
        ...
        $adapterRegistryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry.php');
        $adapterDefaultsProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry_defaults_provider.php');
        $runtimeDefaultsProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_runtime_adapter_defaults_provider.php');
        $registryDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_registry_defaults_provider_factory.php');
        $dependencyProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_container_dependency_provider.php');
        $factoryProviderDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_factory_provider_defaults_provider_factory.php');
        $engineDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_engine_factory_defaults_provider_factory.php');
        $runtimeDefaultsProviderFactoryCode = $this->applicationRuntimeFactoryDefaultsProviderFactoryCode();
    ...
    public function testRemovedAdodbSessionGlobalsAreNotRegistered(): void
    {
        ...
        $adapterRegistryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry.php');
        $adapterDefaultsProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_adapter_registry_defaults_provider.php');
        $sessionDefaultsProviderCode = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_session_adapter_defaults_provider.php');
        $registryDefaultsProviderFactoryCode = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_registry_defaults_provider_factory.php');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_adapter_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_storage_adapter_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_engine_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_sub_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_sub_factory_defaults_provider_factory.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_factory_defaults_provider_factory.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_core_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_core_service_factory_defaults_provider_factory.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_client_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_infrastructure_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_pager_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_utility_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_navigation_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_content_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_session_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_user_service_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_service_factory_bundle.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_container_dependency_bundle.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_runtime_factory_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_runtime_factory_defaults_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_runtime_factory_defaults_provider_factory.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/factory/application_deferred_service_factory_provider.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_service_graph_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_infrastructure_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_content_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_navigation_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_controller_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_client_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_pager_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_utility_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_session_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_user_service_registrar.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_service_graph_registration_context.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_core_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_content_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_navigation_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_controller_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_infrastructure_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_client_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_pager_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_utility_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_session_service_creator.php');
        $this->assertIsString($source);
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2) . '/_core/di/application_user_service_creator.php');
        $this->assertIsString($source);
