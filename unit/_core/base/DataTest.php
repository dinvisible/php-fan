...
use FanTest\_core\base\TestDataWithoutDefaultSubDataFactory;
use FanTest\_core\base\DataErrorLoggerDouble;
...
class DataTest extends TestCase
{
    ...
    public function testMissingSubDataFactoryFailsAtInjectedBoundary(): void
    {
        ...
        $this->expectExceptionMessage('Sub-data factory is not configured for data class "FanTest\_core\base\TestDataWithoutDefaultSubDataFactory".');
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/base/data.php');
