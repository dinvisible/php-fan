...
require_once dirname(__DIR__, 3) . '/_core/factory/view_keeper_factory.php';
require_once dirname(__DIR__, 3) . '/_core/view/router.php';
require_once dirname(__DIR__, 3) . '/_core/view/router/simple.php';
require_once dirname(__DIR__, 3) . '/_core/view/router/html.php';
require_once dirname(__DIR__, 3) . '/_core/view/router/json.php';
require_once dirname(__DIR__, 3) . '/_core/view/router/loader_state.php';
require_once dirname(__DIR__, 3) . '/_core/view/router/loader.php';
require_once dirname(__DIR__, 3) . '/_core/view/parser.php';
require_once dirname(__DIR__, 3) . '/_core/view/parser/html.php';
require_once dirname(__DIR__, 3) . '/_core/view/parser/json.php';
require_once dirname(__DIR__, 3) . '/_core/view/parser/loader.php';
