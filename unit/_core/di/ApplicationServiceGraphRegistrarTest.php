...
final class ApplicationServiceGraphRegistrarTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_service_graph_registrar.php');
        $coreRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_core_service_registrar.php');
        $infrastructureRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_infrastructure_service_registrar.php');
        $contentRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_content_service_registrar.php');
        $navigationRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_navigation_service_registrar.php');
        $controllerRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_controller_service_registrar.php');
        $clientRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_client_service_registrar.php');
        $formRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_pager_service_registrar.php');
        $utilityRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_utility_service_registrar.php');
        $sessionRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_session_service_registrar.php');
        $userRegistrarSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_user_service_registrar.php');
