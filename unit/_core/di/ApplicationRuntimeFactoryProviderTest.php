...
final class ApplicationRuntimeFactoryProviderTest extends TestCase
{
    ...
    {
        $providerSource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/application_runtime_factory_provider.php');
        ...
        $defaultsProviderSource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/application_runtime_factory_defaults_provider.php');
        $defaultsProviderFactorySource = file_get_contents(dirname(__DIR__, 3) . '/_core/factory/application_runtime_factory_defaults_provider_factory.php');
        $adapterRegistrySource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_adapter_registry.php');
        $adapterDefaultsProviderSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_adapter_registry_defaults_provider.php');
        $coreAdapterDefaultsProviderSource = file_get_contents(dirname(__DIR__, 3) . '/_core/di/application_core_adapter_defaults_provider.php');
