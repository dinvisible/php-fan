...
- Расположение: `core/base/data.php:79`
...
- Расположение: `core/base/data.php:100`
...
- Расположение: `core/base/data.php:125`
...
- Расположение: `core/base/data.php:178`
...
- Расположение: `core/base/data.php:195`
...
- Расположение: `core/base/data.php:207`
...
- Расположение: `core/base/data.php:220`
...
- Расположение: `core/base/data.php:235`
...
- Расположение: `core/base/data.php:275`
...
- Расположение: `core/base/data.php:295`
...
- Расположение: `core/base/data.php:308`
...
- Расположение: `core/base/data.php:321`
...
- Расположение: `core/base/data.php:331`
...
- Расположение: `core/base/data.php:351`
...
- Расположение: `core/base/data.php:374`
...
- Расположение: `core/base/data.php:474`
...
- Расположение: `core/base/data.php:487`
...
- Расположение: `core/base/data.php:569`
- Сигнатура: `function __serialize(): array`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\data`.

### `fan\core\base\data::serialize`

- Расположение: `core/base/data.php:584`
...
- Расположение: `core/base/expression_evaluator.php:35`
...
- Расположение: `core/base/expression_evaluator.php:48`
...
- Расположение: `core/base/expression_evaluator.php:103`
...
- Расположение: `core/base/expression_evaluator.php:131`
...
- Расположение: `core/base/expression_evaluator.php:148`
...
- Расположение: `core/base/expression_evaluator.php:160`
...
- Расположение: `core/base/expression_evaluator.php:175`
...
- Расположение: `core/base/expression_evaluator.php:189`
...
- Расположение: `core/base/expression_evaluator.php:204`
...
- Расположение: `core/base/expression_evaluator.php:224`
...
- Расположение: `core/base/expression_evaluator.php:244`
...
- Расположение: `core/base/expression_evaluator.php:259`
...
- Расположение: `core/base/expression_evaluator.php:278`
...
- Расположение: `core/base/expression_evaluator.php:300`
...
- Расположение: `core/base/expression_evaluator.php:334`
...
- Расположение: `core/base/expression_evaluator.php:351`
...
- Расположение: `core/base/expression_evaluator.php:365`
...
- Расположение: `core/base/expression_evaluator.php:375`
...
- Расположение: `core/base/expression_evaluator.php:385`
...
- Расположение: `core/base/meta/delayed.php:41`
...
- Расположение: `core/base/meta/delayed.php:53`
...
- Расположение: `core/base/meta/maker.php:102`
...
- Расположение: `core/base/meta/maker.php:120`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/base/meta/maker.php:132`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\meta\maker`.

### `fan\core\base\meta\maker::__call`

- Расположение: `core/base/meta/maker.php:145`
- Сигнатура: `function __call($method, $arguments = [])`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\meta\maker`.

### `fan\core\base\meta\maker::getIterator`

- Расположение: `core/base/meta/maker.php:155`
...
- Расположение: `core/base/meta/maker.php:164`
...
- Расположение: `core/base/meta/maker.php:176`
...
- Расположение: `core/base/meta/maker.php:187`
...
- Расположение: `core/base/meta/maker.php:202`
...
- Расположение: `core/base/meta/maker.php:219`
...
- Расположение: `core/base/meta/maker.php:237`
...
- Расположение: `core/base/meta/maker.php:257`
...
- Расположение: `core/base/meta/maker.php:273`
...
- Расположение: `core/base/meta/maker.php:291`
...
- Расположение: `core/base/meta/maker.php:307`
...
- Расположение: `core/base/meta/maker.php:320`
...
- Расположение: `core/base/meta/maker.php:333`
...
- Расположение: `core/base/meta/maker.php:346`
...
- Расположение: `core/base/meta/maker.php:371`
...
- Расположение: `core/base/meta/maker.php:388`
...
- Расположение: `core/base/meta/maker.php:407`
...
- Расположение: `core/base/meta/maker.php:425`
...
- Расположение: `core/base/meta/maker.php:447`
...
- Расположение: `core/base/meta/row.php:51`
...
- Расположение: `core/base/meta/row.php:72`
...
- Расположение: `core/base/meta/row.php:89`
...
- Расположение: `core/base/meta/row.php:107`
- Сигнатура: `function _makeSubData($key, $value)`
- Описание: Выполняет логику `make sub data` и возвращает вычисленный результат.
...
- Расположение: `core/base/model/entity.php:107`
...
- Расположение: `core/base/model/entity.php:137`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/base/model/entity.php:151`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\model\entity`.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/base/model/entity.php:167`
...
- Расположение: `core/base/model/entity.php:180`
...
- Расположение: `core/base/model/entity.php:198`
...
- Расположение: `core/base/model/entity.php:213`
...
- Расположение: `core/base/model/entity.php:232`
...
- Расположение: `core/base/model/entity.php:247`
...
- Расположение: `core/base/model/entity.php:264`
...
- Расположение: `core/base/model/entity.php:282`
...
- Расположение: `core/base/model/entity.php:298`
...
- Расположение: `core/base/model/entity.php:313`
...
- Расположение: `core/base/model/entity.php:327`
...
- Расположение: `core/base/model/entity.php:341`
...
- Расположение: `core/base/model/entity.php:374`
...
- Расположение: `core/base/model/entity.php:389`
...
- Расположение: `core/base/model/entity.php:427`
...
- Расположение: `core/base/model/entity.php:447`
...
- Расположение: `core/base/model/entity.php:466`
...
- Расположение: `core/base/model/entity.php:478`
...
- Расположение: `core/base/model/entity.php:489`
...
- Расположение: `core/base/model/entity.php:505`
...
- Расположение: `core/base/model/entity.php:531`
...
- Расположение: `core/base/model/entity.php:546`
...
- Расположение: `core/base/model/entity.php:556`
...
- Расположение: `core/base/model/entity.php:568`
...
- Расположение: `core/base/model/entity.php:578`
...
- Расположение: `core/base/model/entity.php:587`
...
- Расположение: `core/base/model/entity.php:608`
...
- Расположение: `core/base/model/entity.php:618`
...
- Расположение: `core/base/model/entity.php:630`
...
- Расположение: `core/base/model/entity.php:642`
...
- Расположение: `core/base/model/entity.php:654`
...
- Расположение: `core/base/model/entity.php:668`
...
- Расположение: `core/base/model/entity.php:685`
...
- Расположение: `core/base/model/entity.php:697`
...
- Расположение: `core/base/model/entity.php:709`
...
- Расположение: `core/base/model/entity.php:722`
...
- Расположение: `core/base/model/entity.php:734`
...
- Расположение: `core/base/model/entity.php:763`
...
- Расположение: `core/base/model/entity.php:777`
...
- Расположение: `core/base/model/entity.php:795`
...
- Расположение: `core/base/model/entity.php:809`
...
- Расположение: `core/base/model/entity.php:853`
...
- Расположение: `core/base/model/entity.php:891`
...
- Расположение: `core/base/model/entity.php:908`
...
- Расположение: `core/base/model/file_data/row.php:58`
...
- Расположение: `core/base/model/file_data/row.php:75`
...
- Расположение: `core/base/model/file_data/row.php:96`
...
- Расположение: `core/base/model/file_data/row.php:110`
...
- Расположение: `core/base/model/file_data/row.php:146`
...
- Расположение: `core/base/model/file_data/row.php:186`
...
- Расположение: `core/base/model/file_data/row.php:210`
...
- Расположение: `core/base/model/file_data/row.php:232`
...
- Расположение: `core/base/model/file_data/row.php:275`
...
- Расположение: `core/base/model/file_data/row.php:287`
...
- Расположение: `core/base/model/file_data/row.php:314`
...
- Расположение: `core/base/model/file_data/row.php:337`
...
- Расположение: `core/base/model/file_data/row.php:374`
...
- Расположение: `core/base/model/file_data/row.php:397`
...
- Расположение: `core/base/model/file_data/row.php:411`
...
- Расположение: `core/base/model/file_data/row.php:427`
...
- Расположение: `core/base/model/file_data/row.php:445`
...
- Расположение: `core/base/model/file_data/row.php:471`
...
- Расположение: `core/base/model/file_data/row.php:497`
...
- Расположение: `core/base/model/file_data/row.php:520`
...
- Расположение: `core/base/model/file_data/row.php:538`
...
- Расположение: `core/base/model/file_data/row.php:585`
...
- Расположение: `core/base/model/file_data/row.php:601`
...
- Расположение: `core/base/model/file_data/row.php:627`
...
- Расположение: `core/base/model/file_data/row.php:652`
...
- Расположение: `core/base/model/request.php:39`
...
- Расположение: `core/base/model/request.php:54`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/base/model/request.php:66`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\model\request`.

### `fan\core\base\model\request::__call`

- Расположение: `core/base/model/request.php:80`
...
- Расположение: `core/base/model/request.php:101`
...
- Расположение: `core/base/model/request.php:120`
...
- Расположение: `core/base/model/request.php:133`
...
- Расположение: `core/base/model/request.php:144`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\base\model\request::getEntity`

- Расположение: `core/base/model/request.php:154`
...
- Расположение: `core/base/model/request.php:167`
...
- Расположение: `core/base/model/request.php:180`
...
- Расположение: `core/base/model/row.php:88`
- Сигнатура: `function __construct(\fan\core\base\model\entity $entity, &$data = [], ?\fan\core\base\model\rowset $rowset = null)`
...
- Расположение: `core/base/model/row.php:104`
...
- Расположение: `core/base/model/row.php:112`
...
- Расположение: `core/base/model/row.php:120`
...
- Расположение: `core/base/model/row.php:128`
...
- Расположение: `core/base/model/row.php:138`
...
- Расположение: `core/base/model/row.php:148`
...
- Расположение: `core/base/model/row.php:158`
...
- Расположение: `core/base/model/row.php:168`
...
- Расположение: `core/base/model/row.php:183`
...
- Расположение: `core/base/model/row.php:196`
...
- Расположение: `core/base/model/row.php:212`
...
- Расположение: `core/base/model/row.php:241`
...
- Расположение: `core/base/model/row.php:267`
...
- Расположение: `core/base/model/row.php:300`
...
- Расположение: `core/base/model/row.php:314`
...
- Расположение: `core/base/model/row.php:359`
...
- Расположение: `core/base/model/row.php:369`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\base\model\row::getFields`

- Расположение: `core/base/model/row.php:381`
...
- Расположение: `core/base/model/row.php:412`
...
- Расположение: `core/base/model/row.php:433`
...
- Расположение: `core/base/model/row.php:478`
...
- Расположение: `core/base/model/row.php:550`
- Сигнатура: `function delete()`
...
- Расположение: `core/base/model/row.php:586`
...
- Расположение: `core/base/model/row.php:609`
...
- Расположение: `core/base/model/row.php:630`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/base/model/row.php:639`
...
- Расположение: `core/base/model/row.php:649`
...
- Расположение: `core/base/model/row.php:659`
...
- Расположение: `core/base/model/row.php:669`
...
- Расположение: `core/base/model/row.php:679`
...
- Расположение: `core/base/model/row.php:695`
...
- Расположение: `core/base/model/row.php:718`
...
- Расположение: `core/base/model/row.php:732`
...
- Расположение: `core/base/model/row.php:750`
...
- Расположение: `core/base/model/row.php:796`
...
- Расположение: `core/base/model/row.php:835`
...
- Расположение: `core/base/model/row.php:856`
...
- Расположение: `core/base/model/row.php:871`
...
- Расположение: `core/base/model/row.php:883`
...
- Расположение: `core/base/model/row.php:898`
...
- Расположение: `core/base/model/row.php:915`
...
- Расположение: `core/base/model/row.php:952`
...
- Расположение: `core/base/model/row.php:970`
...
- Расположение: `core/base/model/row.php:987`
...
- Расположение: `core/base/model/row.php:1001`
...
- Расположение: `core/base/model/row.php:1018`
...
- Расположение: `core/base/model/row.php:1033`
...
- Расположение: `core/base/model/row.php:1046`
...
- Расположение: `core/base/model/row.php:1070`
...
- Расположение: `core/base/model/row.php:1082`
- Сигнатура: `function __get($fieldName)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\model\row`.

### `fan\core\base\model\row::__call`

- Расположение: `core/base/model/row.php:1094`
- Сигнатура: `function __call($method, $args)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\base\model\row`.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/base/model/row.php:1193`
...
- Расположение: `core/base/model/rowset.php:34`
...
- Расположение: `core/base/model/rowset.php:56`
- Сигнатура: `function toArray($recursive = false)`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\base\model\rowset::getRowsById`

- Расположение: `core/base/model/rowset.php:75`
...
- Расположение: `core/base/model/rowset.php:98`
...
- Расположение: `core/base/model/rowset.php:147`
...
- Расположение: `core/base/model/rowset.php:165`
...
- Расположение: `core/base/model/rowset.php:179`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/base/model/rowset.php:191`
...
- Расположение: `core/base/model/rowset.php:203`
- Сигнатура: `function serialize()`
- Описание: Выполняет логику `serialize` и возвращает вычисленный результат.
...
- Расположение: `core/base/model/rowset.php:216`
...
- Расположение: `core/base/model/spec_file/image/entity.php:40`
...
- Расположение: `core/base/model/spec_file/image/entity.php:55`
...
- Расположение: `core/base/model/spec_file/image/entity.php:69`
...
- Расположение: `core/base/model/spec_file/image/entity.php:86`
...
- Расположение: `core/base/model/spec_file/image/entity.php:119`
...
- Расположение: `core/base/model/spec_file/image/entity.php:168`
...
- Расположение: `core/base/model/spec_file/image/row.php:34`
...
- Расположение: `core/base/model/spec_file/image/row.php:55`
...
- Расположение: `core/base/model/spec_file/image/row.php:72`
...
- Расположение: `core/base/model/spec_file/image/row.php:91`
...
- Расположение: `core/base/model/spec_file/image/row.php:107`
...
- Расположение: `core/base/model/spec_file/image/row.php:126`
...
- Расположение: `core/base/model/spec_file/image/row.php:142`
...
- Расположение: `core/base/model/spec_file/image/row.php:182`
...
- Расположение: `core/base/model/spec_file/image/row.php:198`
...
- Расположение: `core/base/model/spec_file/image/row.php:220`
- Сигнатура: `function checkAccess()`
- Описание: Проверяет условие или валидирует данные `access` и возвращает результат либо выбрасывает исключение.

### `fan\core\base\model\spec_file\image\row::checkIsOwner`

- Расположение: `core/base/model/spec_file/image/row.php:230`
- Сигнатура: `function checkIsOwner()`
- Описание: Проверяет условие или валидирует данные `is owner` и возвращает результат либо выбрасывает исключение.

### `fan\core\base\model\spec_file\image\row::fetchHtml`

- Расположение: `core/base/model/spec_file/image/row.php:244`
...
- Расположение: `core/base/model/spec_file/image/row.php:262`
...
- Расположение: `core/base/model/spec_file/image/row.php:281`
...
- Расположение: `core/base/model/spec_file/image/row.php:297`
...
- Расположение: `core/base/model/spec_file/image/row.php:318`
...
- Расположение: `core/base/model/spec_file/image/row.php:362`
...
- Расположение: `core/base/model/spec_file/row.php:33`
- Сигнатура: `function delete()`
...
- Расположение: `core/base/model/spec_file/row.php:48`
...
- Расположение: `core/base/model/spec_file/row.php:58`
...
- Расположение: `core/base/model/spec_file/row.php:75`
...
- Расположение: `core/base/model/spec_file/row.php:85`
...
- Расположение: `core/base/model/spec_file/row.php:101`
- Сигнатура: `function setAccessType(string $key, bool $save = true)`
...
- Расположение: `core/base/model/spec_file/row.php:119`
...
- Расположение: `core/base/model/spec_file/row.php:132`
...
- Расположение: `core/base/model/spec_file/row.php:142`
- Сигнатура: `function checkAccess()`
- Описание: Проверяет условие или валидирует данные `access` и возвращает результат либо выбрасывает исключение.

### `fan\core\base\model\spec_file\row::checkIsOwner`

- Расположение: `core/base/model/spec_file/row.php:152`
- Сигнатура: `function checkIsOwner()`
- Описание: Проверяет условие или валидирует данные `is owner` и возвращает результат либо выбрасывает исключение.
...
- Расположение: `core/base/service.php:63`
...
- Расположение: `core/base/service.php:81`
...
- Расположение: `core/base/service.php:93`
...
- Расположение: `core/base/service.php:100`
...
- Расположение: `core/base/service.php:110`
...
- Расположение: `core/base/service.php:125`
...
- Расположение: `core/base/service.php:141`
...
- Расположение: `core/base/service.php:158`
...
- Расположение: `core/base/service.php:168`
...
- Расположение: `core/base/service.php:180`
...
- Расположение: `core/base/service.php:200`
...
- Расположение: `core/base/service.php:212`
...
- Расположение: `core/base/service.php:222`
...
- Расположение: `core/base/service.php:237`
...
- Расположение: `core/base/service.php:254`
...
- Расположение: `core/base/service.php:271`
...
- Расположение: `core/base/service.php:284`
...
- Расположение: `core/base/service.php:318`
...
- Расположение: `core/base/service.php:340`
...
- Расположение: `core/base/service.php:357`
...
- Расположение: `core/base/service.php:381`
...
- Расположение: `core/base/service.php:402`
...
- Расположение: `core/base/service.php:425`
...
- Расположение: `core/base/service/multi.php:29`
...
- Расположение: `core/base/service/multi.php:43`
- Сигнатура: `function isSingleton()`
- Описание: Проверяет условие или валидирует данные `singleton` и возвращает результат либо выбрасывает исключение.
...
- Расположение: `core/base/service/single.php:34`
...
- Расположение: `core/base/service/single.php:53`
- Сигнатура: `function isSingleton()`
- Описание: Проверяет условие или валидирует данные `singleton` и возвращает результат либо выбрасывает исключение.

### `fan\core\base\service\single::_saveInstance`

- Расположение: `core/base/service/single.php:65`
- Сигнатура: `function _saveInstance()`
- Описание: Выполняет логику `save instance` и возвращает вычисленный результат.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/base/timer_program.php:40`
...
- Расположение: `core/base/timer_program.php:50`
...
- Расположение: `core/base/timer_program.php:62`
...
- Расположение: `core/base/timer_program.php:74`
...
- Расположение: `core/base/transfer.php:42`
...
- Расположение: `core/base/transfer.php:57`
...
- Расположение: `core/base/transfer.php:67`
...
- Расположение: `core/base/transfer.php:83`
...
- Расположение: `core/base/transfer.php:93`
...
- Расположение: `core/base/transfer.php:103`
...
- Расположение: `core/base/transfer.php:113`
...
- Расположение: `core/base/transfer/out.php:28`
...
- Расположение: `core/base/transfer/sham.php:28`
- Сигнатура: `function __construct($newUrn, $newQueryString = null, $dbOper = null)`
...
- Расположение: `core/base/transfer/transfer_int.php:28`
- Сигнатура: `function __construct($newUrn, $newQueryString = null, $dbOper = null)`
...
- Расположение: `core/block/admin/base.php:31`
...
- Расположение: `core/block/admin/base.php:49`
...
- Расположение: `core/block/admin/base.php:121`
...
- Расположение: `core/block/admin/base.php:154`
...
- Расположение: `core/block/admin/base.php:180`
...
- Расположение: `core/block/admin/base.php:200`
...
- Расположение: `core/block/admin/data.php:50`
...
- Расположение: `core/block/admin/data.php:108`
...
- Расположение: `core/block/admin/data.php:121`
...
- Расположение: `core/block/admin/data.php:136`
...
- Расположение: `core/block/admin/data.php:162`
...
- Расположение: `core/block/admin/data.php:175`
...
- Расположение: `core/block/admin/data.php:198`
...
- Расположение: `core/block/admin/data.php:248`
...
- Расположение: `core/block/admin/data.php:258`
...
- Расположение: `core/block/admin/data.php:273`
...
- Расположение: `core/block/admin/data.php:288`
...
- Расположение: `core/block/admin/data.php:303`
...
- Расположение: `core/block/admin/data.php:316`
...
- Расположение: `core/block/admin/data.php:331`
...
- Расположение: `core/block/admin/data.php:370`
...
- Расположение: `core/block/admin/data.php:383`
...
- Расположение: `core/block/admin/data.php:405`
...
- Расположение: `core/block/admin/data.php:428`
...
- Расположение: `core/block/admin/data.php:449`
...
- Расположение: `core/block/admin/data.php:465`
...
- Расположение: `core/block/admin/data.php:481`
...
- Расположение: `core/block/admin/data.php:497`
...
- Расположение: `core/block/admin/data.php:513`
...
- Расположение: `core/block/admin/data.php:533`
...
- Расположение: `core/block/admin/data.php:553`
...
- Расположение: `core/block/admin/data.php:577`
...
- Расположение: `core/block/admin/data.php:601`
...
- Расположение: `core/block/admin/data.php:621`
...
- Расположение: `core/block/admin/data_form.php:35`
- Сигнатура: `function validateData(&$edit, &$insert)`
- Описание: Проверяет условие или валидирует данные `data` и возвращает результат либо выбрасывает исключение.

### `fan\core\block\admin\data_form::parseData`

- Расположение: `core/block/admin/data_form.php:57`
- Сигнатура: `function parseData($edit, $insert)`
...
- Расположение: `core/block/admin/data_form.php:79`
- Сигнатура: `function initTplVar()`
...
- Расположение: `core/block/admin/data_form.php:97`
- Сигнатура: `function getMainData($data, $force = [])`
...
- Расположение: `core/block/admin/data_form.php:113`
...
- Расположение: `core/block/admin/data_form.php:135`
- Сигнатура: `function getFieldLabel($name)`
...
- Расположение: `core/block/admin/data_form.php:152`
...
- Расположение: `core/block/admin/data_info.php:30`
- Сигнатура: `function getMainData($data, $force = [])`
...
- Расположение: `core/block/admin/data_info.php:43`
- Сигнатура: `function getExtraData()`
...
- Расположение: `core/block/admin/data_table.php:35`
- Сигнатура: `function validateData(&$edit, &$insert)`
- Описание: Проверяет условие или валидирует данные `data` и возвращает результат либо выбрасывает исключение.

### `fan\core\block\admin\data_table::validateDataOnce`

- Расположение: `core/block/admin/data_table.php:60`
...
- Расположение: `core/block/admin/data_table.php:83`
- Сигнатура: `function parseData($edit, $insert)`
...
- Расположение: `core/block/admin/data_table.php:130`
- Сигнатура: `function deleteData($del)`
...
- Расположение: `core/block/admin/data_table.php:154`
- Сигнатура: `function initTplVar()`
...
- Расположение: `core/block/admin/data_table.php:198`
- Сигнатура: `function getExtraData()`
...
- Расположение: `core/block/admin/data_table.php:218`
- Сигнатура: `function getContentData($cacheEnable = true)`
...
- Расположение: `core/block/admin/data_table.php:271`
...
- Расположение: `core/block/admin/data_table.php:287`
- Сигнатура: `function getFieldLabel($name)`
...
- Расположение: `core/block/admin/data_table.php:304`
...
- Расположение: `core/block/admin/data_table.php:318`
...
- Расположение: `core/block/admin/form_pattern.php:26`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/index.php:27`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/index.php:37`
...
- Расположение: `core/block/admin/select_dependent.php:26`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/select_dependent.php:49`
...
- Расположение: `core/block/admin/structure.php:26`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/structure.php:68`
- Сигнатура: `function initTplVar()`
...
- Расположение: `core/block/admin/structure.php:77`
- Сигнатура: `function getAddParam()`
...
- Расположение: `core/block/admin/structure.php:87`
- Сигнатура: `function getExtraData()`
...
- Расположение: `core/block/admin/structure.php:97`
- Сигнатура: `function getCondition()`
...
- Расположение: `core/block/admin/upload_file.php:41`
...
- Расположение: `core/block/admin/upload_file.php:64`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/upload_file.php:137`
...
- Расположение: `core/block/admin/upload_file.php:157`
...
- Расположение: `core/block/admin/upload_file.php:176`
...
- Расположение: `core/block/admin/upload_file.php:195`
...
- Расположение: `core/block/admin/upload_file.php:213`
...
## `core/block/admin/upload_flash.php`

### `fan\core\block\admin\upload_flash::finishConstruct`

- Расположение: `core/block/admin/upload_flash.php:41`
- Сигнатура: `function finishConstruct($container, $containerMeta, $allowSetEmbedded = true)`
...
- Расположение: `core/block/admin/upload_flash.php:64`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/upload_flash.php:137`
- Сигнатура: `function checkMainTableId(&$mainRow, &$data, $main, $link)`
- Описание: Проверяет условие или валидирует данные `main table id` и возвращает результат либо выбрасывает исключение.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/block/admin/upload_flash.php:157`
- Сигнатура: `function checkLinkTableId(&$linkRow, &$data, $main, $link)`
- Описание: Проверяет условие или валидирует данные `link table id` и возвращает результат либо выбрасывает исключение.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/block/admin/upload_flash.php:176`
...
- Расположение: `core/block/admin/upload_flash.php:195`
...
- Расположение: `core/block/admin/upload_flash.php:213`
...
- Расположение: `core/block/admin/upload_image.php:46`
- Сигнатура: `function finishConstruct($container, $containerMeta, $allowSetEmbedded = true)`
...
- Расположение: `core/block/admin/upload_image.php:93`
- Сигнатура: `function init()`
...
- Расположение: `core/block/admin/upload_image.php:156`
...
- Расположение: `core/block/admin/upload_image.php:182`
...
- Расположение: `core/block/admin/upload_image.php:204`
...
- Расположение: `core/block/admin/upload_image.php:224`
- Сигнатура: `function checkMainTableId(&$mainRow, &$data, $main, $link)`
- Описание: Проверяет условие или валидирует данные `main table id` и возвращает результат либо выбрасывает исключение.

### `fan\core\block\admin\upload_image::checkLinkTableId`

- Расположение: `core/block/admin/upload_image.php:244`
- Сигнатура: `function checkLinkTableId(&$linkRow, &$data, $main, $link)`
- Описание: Проверяет условие или валидирует данные `link table id` и возвращает результат либо выбрасывает исключение.

### `fan\core\block\admin\upload_image::getImageLineData`

- Расположение: `core/block/admin/upload_image.php:263`
...
- Расположение: `core/block/admin/upload_image.php:287`
...
- Расположение: `core/block/admin/upload_image.php:305`
...
- Расположение: `core/block/admin/upload_image.php:325`
...
- Расположение: `core/block/admin/upload_image.php:343`
...
- Расположение: `core/block/admin/upload_image.php:354`
...
- Расположение: `core/block/base.php:153`
...
- Расположение: `core/block/base.php:184`
...
- Расположение: `core/block/base.php:226`
- Сигнатура: `function init()`
...
- Расположение: `core/block/base.php:234`
- Сигнатура: `function initRequired()`
...
- Расположение: `core/block/base.php:242`
...
- Расположение: `core/block/base.php:252`
...
- Расположение: `core/block/base.php:262`
...
- Расположение: `core/block/base.php:272`
...
- Расположение: `core/block/base.php:282`
...
- Расположение: `core/block/base.php:296`
...
- Расположение: `core/block/base.php:309`
...
- Расположение: `core/block/base.php:323`
- Сигнатура: `function setMeta(string|array $key, mixed $value)`
...
- Расположение: `core/block/base.php:366`
...
- Расположение: `core/block/base.php:386`
...
- Расположение: `core/block/base.php:396`
...
- Расположение: `core/block/base.php:411`
...
- Расположение: `core/block/base.php:437`
...
- Расположение: `core/block/base.php:448`
...
- Расположение: `core/block/base.php:458`
...
- Расположение: `core/block/base.php:468`
...
- Расположение: `core/block/base.php:479`
- Сигнатура: `function getTemplate()`
...
- Расположение: `core/block/base.php:494`
...
- Расположение: `core/block/base.php:510`
- Сигнатура: `function getRequest()`
...
- Расположение: `core/block/base.php:520`
...
- Расположение: `core/block/base.php:532`
...
- Расположение: `core/block/base.php:544`
...
- Расположение: `core/block/base.php:557`
...
- Расположение: `core/block/base.php:567`
...
- Расположение: `core/block/base.php:577`
...
- Расположение: `core/block/base.php:587`
- Сигнатура: `function getDebugInfo()`
...
- Расположение: `core/block/base.php:617`
...
- Расположение: `core/block/base.php:627`
...
- Расположение: `core/block/base.php:640`
...
- Расположение: `core/block/base.php:651`
...
- Расположение: `core/block/base.php:676`
...
- Расположение: `core/block/base.php:776`
...
- Расположение: `core/block/base.php:793`
...
- Расположение: `core/block/base.php:835`
...
- Расположение: `core/block/base.php:857`
...
- Расположение: `core/block/base.php:883`
...
- Расположение: `core/block/base.php:923`
...
- Расположение: `core/block/base.php:941`
...
- Расположение: `core/block/base.php:961`
...
- Расположение: `core/block/base.php:977`
...
- Расположение: `core/block/base.php:1007`
...
- Расположение: `core/block/base.php:1021`
...
- Расположение: `core/block/base.php:1039`
- Сигнатура: `function __get($key)`
...
- Расположение: `core/block/base.php:1056`
- Сигнатура: `function __call($method, $args)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\block\base`.
- Побочные эффекты: использует service locator/helpers фреймворка; может выбрасывать исключения
...
- Расположение: `core/block/common/html_nav.php:33`
- Сигнатура: `function init()`
...
- Расположение: `core/block/common/html_nav.php:45`
...
- Расположение: `core/block/common/html_nav.php:57`
...
- Расположение: `core/block/common/html_nav.php:82`
...
- Расположение: `core/block/common/html_nav.php:100`
...
- Расположение: `core/block/common/html_nav.php:130`
...
- Расположение: `core/block/common/html_nav_db.php:40`
...
- Расположение: `core/block/common/html_nav_db.php:89`
...
- Расположение: `core/block/common/html_nav_db.php:108`
...
- Расположение: `core/block/common/html_pager.php:32`
- Сигнатура: `function init()`
...
- Расположение: `core/block/common/html_pager.php:44`
...
- Расположение: `core/block/common/html_pager.php:54`
...
- Расположение: `core/block/common/html_pager.php:67`
...
- Расположение: `core/block/common/html_pager.php:110`
- Сигнатура: `function _postCreate()`
- Описание: Выполняет workflow-логику `post create`.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/block/common/html_pager.php:121`
- Сигнатура: `function _preOutput()`
- Описание: Выполняет workflow-логику `pre output`.

## `core/block/common/html_pager_quantifier.php`

### `fan\core\block\common\html_pager_quantifier::init`

- Расположение: `core/block/common/html_pager_quantifier.php:26`
- Сигнатура: `function init()`
...
- Расположение: `core/block/common/html_pager_quantifier.php:45`
...
- Расположение: `core/block/common/html_pager_quantifier.php:57`
- Сигнатура: `function getDynamicMeta($meta)`
...
- Расположение: `core/block/common/html_pager_quantifier.php:90`
...
- Расположение: `core/block/error/error403.php:31`
...
- Расположение: `core/block/error/error404.php:31`
- Сигнатура: `function setViewVars(string $error, string $message, string $combiMessage)`
...
- Расположение: `core/block/error/error500.php:31`
- Сигнатура: `function setViewVars(string $error, string $message, string $combiMessage)`
...
## `core/block/form/parser.php`

### `fan\core\block\form\parser::finishConstruct`

- Расположение: `core/block/form/parser.php:56`
- Сигнатура: `function finishConstruct($container = null, $containerMeta = [], $allowSetEmbedded = true)`
...
- Расположение: `core/block/form/parser.php:70`
...
- Расположение: `core/block/form/parser.php:80`
...
- Расположение: `core/block/form/parser.php:95`
...
- Расположение: `core/block/form/parser.php:108`
...
- Расположение: `core/block/form/parser.php:122`
...
- Расположение: `core/block/form/parser.php:134`
...
- Расположение: `core/block/form/parser.php:154`
...
- Расположение: `core/block/form/parser.php:169`
...
- Расположение: `core/block/form/parser.php:179`
...
- Расположение: `core/block/form/parser.php:239`
...
- Расположение: `core/block/form/parser.php:276`
...
- Расположение: `core/block/form/parser.php:290`
...
## `core/block/form/part.php`

### `fan\core\block\form\part::partInit`

- Расположение: `core/block/form/part.php:30`
...
- Расположение: `core/block/form/usual.php:57`
...
- Расположение: `core/block/form/usual.php:74`
- Сигнатура: `function getViewData()`
...
- Расположение: `core/block/loader/base.php:45`
- Сигнатура: `function finishConstruct($container = null, $containerMeta = [], $allowSetEmbedded = true)`
...
- Расположение: `core/block/loader/base.php:66`
...
- Расположение: `core/block/loader/base.php:83`
...
- Расположение: `core/block/loader/base.php:100`
...
- Расположение: `core/block/loader/base.php:118`
...
- Расположение: `core/block/loader/base.php:132`
...
- Расположение: `core/block/loader/base.php:143`
- Сигнатура: `function checkRunInit()`
- Описание: Проверяет условие или валидирует данные `run init` и возвращает результат либо выбрасывает исключение.

### `fan\core\block\loader\base::getOutcome`

- Расположение: `core/block/loader/base.php:153`
...
- Расположение: `core/block/loader/loader_form_validation.php:28`
- Сигнатура: `function init()`
...
- Расположение: `core/block/root/html.php:79`
- Сигнатура: `function init()`
...
- Расположение: `core/block/root/html.php:105`
- Сигнатура: `function runAfterInit()`
...
- Расположение: `core/block/root/html.php:138`
...
- Расположение: `core/block/root/html.php:151`
...
- Расположение: `core/block/root/html.php:163`
...
- Расположение: `core/block/root/html.php:188`
...
- Расположение: `core/block/root/html.php:203`
...
- Расположение: `core/block/root/html.php:223`
...
- Расположение: `core/block/root/html.php:266`
...
- Расположение: `core/block/root/html.php:298`
...
- Расположение: `core/block/root/html.php:319`
...
- Расположение: `core/block/root/html.php:352`
...
- Расположение: `core/block/root/html.php:394`
...
- Расположение: `core/block/root/html.php:408`
...
- Расположение: `core/block/root/html.php:425`
...
- Расположение: `core/block/root/html.php:461`
...
- Расположение: `core/block/root/html.php:486`
...
- Расположение: `core/block/root/html.php:509`
- Сигнатура: `function _preOutput()`
- Описание: Выполняет workflow-логику `pre output`.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/block/root/html.php:532`
...
- Расположение: `core/bootstrap.php:83`
...
- Расположение: `core/bootstrap.php:150`
...
- Расположение: `core/bootstrap.php:164`
...
- Расположение: `core/bootstrap.php:178`
...
- Расположение: `core/bootstrap.php:217`
...
- Расположение: `core/bootstrap.php:230`
...
- Расположение: `core/bootstrap.php:244`
...
- Расположение: `core/bootstrap.php:256`
...
- Расположение: `core/bootstrap.php:269`
...
- Расположение: `core/bootstrap.php:287`
...
- Расположение: `core/bootstrap.php:405`
...
## `core/bootstrap/initializer.php`

### `fan\core\bootstrap\initializer::__construct`

- Расположение: `core/bootstrap/initializer.php:33`
...
- Расположение: `core/bootstrap/initializer.php:47`
...
- Расположение: `core/bootstrap/initializer.php:66`
...
- Расположение: `core/bootstrap/initializer.php:79`
...
- Расположение: `core/bootstrap/initializer.php:98`
...
- Расположение: `core/bootstrap/initializer.php:108`
...
- Расположение: `core/bootstrap/initializer.php:118`
...
- Расположение: `core/bootstrap/initializer.php:132`
...
- Расположение: `core/bootstrap/initializer.php:144`
...
- Расположение: `core/bootstrap/initializer.php:157`
...
- Расположение: `core/bootstrap/initializer.php:183`
...
## `core/bootstrap/loader.php`

### `fan\core\bootstrap\loader::__construct`

- Расположение: `core/bootstrap/loader.php:97`
- Сигнатура: `function __construct($config)`
...
- Расположение: `core/bootstrap/loader.php:133`
...
- Расположение: `core/bootstrap/loader.php:172`
...
- Расположение: `core/bootstrap/loader.php:188`
...
- Расположение: `core/bootstrap/loader.php:201`
- Сигнатура: `function loadClass(string $class, bool $makeAlias = true)`
...
- Расположение: `core/bootstrap/loader.php:259`
...
- Расположение: `core/bootstrap/loader.php:280`
...
- Расположение: `core/bootstrap/loader.php:315`
...
- Расположение: `core/bootstrap/loader.php:349`
...
- Расположение: `core/bootstrap/loader.php:372`
- Сигнатура: `function parsePath(string $path)`
...
- Расположение: `core/bootstrap/loader.php:392`
...
- Расположение: `core/bootstrap/loader.php:406`
...
- Расположение: `core/bootstrap/loader.php:420`
...
- Расположение: `core/bootstrap/loader.php:451`
...
- Расположение: `core/bootstrap/loader.php:464`
...
- Расположение: `core/bootstrap/loader.php:483`
...
- Расположение: `core/bootstrap/loader.php:495`
...
- Расположение: `core/bootstrap/loader.php:507`
...
- Расположение: `core/bootstrap/loader.php:519`
...
- Расположение: `core/bootstrap/loader.php:530`
...
- Расположение: `core/bootstrap/loader.php:549`
...
- Расположение: `core/bootstrap/loader.php:562`
...
- Расположение: `core/bootstrap/loader.php:589`
...
- Расположение: `core/bootstrap/loader.php:607`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/bootstrap/loader.php:619`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\bootstrap\loader`.

### `fan\core\bootstrap\loader::offsetSet`

- Расположение: `core/bootstrap/loader.php:634`
...
- Расположение: `core/bootstrap/loader.php:646`
- Сигнатура: `function offsetExists($key)`
- Описание: Выполняет логику `offset exists` и возвращает вычисленный результат.

### `fan\core\bootstrap\loader::offsetUnset`

- Расположение: `core/bootstrap/loader.php:659`
...
- Расположение: `core/bootstrap/loader.php:671`
- Сигнатура: `function offsetGet($key)`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.

## `core/bootstrap/runner.php`

### `fan\core\bootstrap\runner::__construct`

- Расположение: `core/bootstrap/runner.php:36`
- Сигнатура: `function __construct($config)`
...
- Расположение: `core/bootstrap/runner.php:50`
...
- Расположение: `core/bootstrap/runner.php:89`
...
- Расположение: `core/bootstrap/runner.php:118`
...
- Расположение: `core/bootstrap/runner.php:131`
...
- Расположение: `core/bootstrap/runner.php:165`
...
- Расположение: `core/bootstrap/runner.php:208`
...
- Расположение: `core/cli/restore_password.php:60`
...
- Расположение: `core/cli/restore_password.php:97`
...
## `core/di/container.php`

### `fan\core\di\container::set`

- Расположение: `core/di/container.php:42`
...
- Расположение: `core/di/container.php:59`
...
- Расположение: `core/di/container.php:76`
...
- Расположение: `core/di/container.php:90`
...
- Расположение: `core/di/container.php:105`
...
- Расположение: `core/di/container.php:131`
...
- Расположение: `core/di/container.php:144`
...
- Расположение: `core/di/container.php:161`
...
- Расположение: `core/di/container.php:173`
...
## `core/di/container_registry.php`

### `fan\core\di\container_registry::get`

- Расположение: `core/di/container_registry.php:20`
...
- Расположение: `core/di/container_registry.php:36`
...
- Расположение: `core/di/container_registry.php:46`
...
- Расположение: `core/error/demonstrator.php:87`
...
- Расположение: `core/error/demonstrator.php:101`
...
- Расположение: `core/error/demonstrator.php:117`
...
- Расположение: `core/error/demonstrator.php:129`
...
- Расположение: `core/error/demonstrator.php:160`
...
- Расположение: `core/error/demonstrator.php:176`
...
- Расположение: `core/error/demonstrator.php:214`
...
- Расположение: `core/error/demonstrator.php:227`
...
- Расположение: `core/error/demonstrator.php:248`
...
- Расположение: `core/error/demonstrator.php:267`
...
- Расположение: `core/error/demonstrator.php:280`
...
- Расположение: `core/error/demonstrator.php:301`
...
- Расположение: `core/exception/base.php:66`
...
- Расположение: `core/exception/base.php:93`
...
- Расположение: `core/exception/base.php:103`
...
- Расположение: `core/exception/base.php:113`
...
- Расположение: `core/exception/base.php:123`
...
- Расположение: `core/exception/base.php:133`
...
- Расположение: `core/exception/base.php:163`
...
- Расположение: `core/exception/base.php:181`
...
- Расположение: `core/exception/base.php:200`
...
- Расположение: `core/exception/block/fatal.php:29`
...
- Расположение: `core/exception/block/fatal.php:47`
- Сигнатура: `function _defineDbOper($dbOper = 'rollback')`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.

## `core/exception/block/form_part.php`

### `fan\core\exception\block\form_part::__construct`

- Расположение: `core/exception/block/form_part.php:40`
...
- Расположение: `core/exception/block/form_part.php:52`
- Сигнатура: `function getBlockName()`
...
- Расположение: `core/exception/block/form_part.php:62`
...
- Расположение: `core/exception/block/form_part.php:74`
...
- Расположение: `core/exception/block/local.php:35`
...
- Расположение: `core/exception/block/local.php:46`
- Сигнатура: `function getBlock()`
...
- Расположение: `core/exception/block/local.php:58`
- Сигнатура: `function _defineDbOper($dbOper = null)`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.
...
- Расположение: `core/exception/error500.php:28`
- Сигнатура: `function __construct($logErrMsg, $code = E_USER_ERROR, $previous = null)`
...
- Расположение: `core/exception/fatal.php:30`
...
## `core/exception/model/entity/fatal.php`

### `fan\core\exception\model\entity\fatal::__construct`

- Расположение: `core/exception/model/entity/fatal.php:35`
...
- Расположение: `core/exception/model/entity/fatal.php:50`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/exception/model/entity/fatal.php:62`
- Сигнатура: `function _defineDbOper($dbOper = 'rollback')`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.
...
- Расположение: `core/exception/model/reverse.php:34`
...
- Расположение: `core/exception/model/reverse.php:45`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/exception/model/reverse.php:57`
- Сигнатура: `function _defineDbOper($dbOper = 'nothing')`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.
...
- Расположение: `core/exception/plain/fatal.php:36`
...
- Расположение: `core/exception/plain/fatal.php:55`
...
## `core/exception/service/database.php`

### `fan\core\exception\service\database::__construct`

- Расположение: `core/exception/service/database.php:55`
...
- Расположение: `core/exception/service/database.php:72`
...
- Расположение: `core/exception/service/database.php:82`
...
- Расположение: `core/exception/service/database.php:92`
...
- Расположение: `core/exception/service/database.php:102`
...
- Расположение: `core/exception/service/database.php:115`
...
- Расположение: `core/exception/service/date.php:29`
- Сигнатура: `function __construct($logErrMsg, $code = E_USER_ERROR, $previous = null)`
...
- Расположение: `core/exception/service/fatal.php:35`
...
- Расположение: `core/exception/service/fatal.php:49`
- Сигнатура: `function getService()`
...
- Расположение: `core/exception/service/fatal.php:61`
- Сигнатура: `function _logErrorMessage($logType)`
- Описание: Выполняет логику `log error message` и возвращает вычисленный результат.

### `fan\core\exception\service\fatal::_defineDbOper`

- Расположение: `core/exception/service/fatal.php:77`
- Сигнатура: `function _defineDbOper($dbOper = null)`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.
...
- Расположение: `core/exception/template/fatal.php:28`
...
- Расположение: `core/functions.php:34`
...
- Расположение: `core/functions.php:46`
...
- Расположение: `core/functions.php:65`
...
- Расположение: `core/functions.php:92`
...
- Расположение: `core/functions.php:106`
...
- Расположение: `core/functions.php:120`
...
- Расположение: `core/functions.php:153`
...
- Расположение: `core/functions.php:186`
...
- Расположение: `core/functions.php:255`
...
- Расположение: `core/functions.php:281`
...
- Расположение: `core/functions.php:295`
...
- Расположение: `core/functions.php:305`
...
- Расположение: `core/functions.php:334`
...
- Расположение: `core/functions.php:357`
...
- Расположение: `core/functions.php:371`
...
- Расположение: `core/functions.php:387`
...
- Расположение: `core/functions.php:410`
...
- Расположение: `core/functions.php:426`
...
- Расположение: `core/functions.php:440`
...
- Расположение: `core/functions.php:451`
...
- Расположение: `core/functions.php:465`
...
- Расположение: `core/functions.php:479`
...
- Расположение: `core/functions.php:493`
...
- Расположение: `core/functions.php:506`
...
- Расположение: `core/functions.php:520`
...
- Расположение: `core/functions.php:534`
...
- Расположение: `core/functions.php:548`
...
- Расположение: `core/functions.php:561`
...
- Расположение: `core/functions.php:574`
...
- Расположение: `core/functions.php:584`
...
- Расположение: `core/functions.php:619`
...
- Расположение: `core/functions.php:636`
...
- Расположение: `core/functions.php:651`
...
## `core/plain/captcha.php`

### `fan\core\plain\captcha::__construct`

- Расположение: `core/plain/captcha.php:58`
...
- Расположение: `core/plain/captcha.php:75`
...
- Расположение: `core/plain/captcha.php:87`
...
- Расположение: `core/plain/captcha.php:99`
- Сигнатура: `function _init()`
- Описание: Выполняет логику `init` и возвращает вычисленный результат.

### `fan\core\plain\captcha::_getContent`

- Расположение: `core/plain/captcha.php:114`
...
- Расположение: `core/plain/captcha.php:129`
...
- Расположение: `core/plain/db_file.php:88`
- Сигнатура: `function __construct(\fan\core\service\plain $handler, $key)`
...
- Расположение: `core/plain/db_file.php:135`
- Сигнатура: `function setConfig(\fan\core\service\config\row $config)`
...
- Расположение: `core/plain/db_file.php:148`
- Сигнатура: `function getKey()`
...
- Расположение: `core/plain/db_file.php:160`
- Сигнатура: `function _getContent()`
- Описание: Выполняет логику `get content` и возвращает вычисленный результат.

### `fan\core\plain\db_file::_prepare`

- Расположение: `core/plain/db_file.php:170`
...
- Расположение: `core/plain/db_file.php:192`
- Сигнатура: `function _init()`
- Описание: Выполняет логику `init` и возвращает вычисленный результат.

### `fan\core\plain\db_file::_getFileData`

- Расположение: `core/plain/db_file.php:228`
...
- Расположение: `core/plain/db_file.php:281`
...
- Расположение: `core/plain/image.php:53`
...
- Расположение: `core/plain/image.php:64`
...
- Расположение: `core/plain/image.php:75`
...
- Расположение: `core/plain/image.php:88`
...
- Расположение: `core/plain/image.php:109`
...
- Расположение: `core/plain/image.php:125`
- Сигнатура: `function _getFileData($idIsEncrypt = null)`
- Описание: Выполняет логику `get file data` и возвращает вычисленный результат.

### `fan\core\plain\image::_getNailFileData`

- Расположение: `core/plain/image.php:141`
...
- Расположение: `core/plain/image.php:177`
...
- Расположение: `core/plain/image.php:209`
...
- Расположение: `core/plain/image.php:241`
- Сигнатура: `function _getCacheData($mainData)`
- Описание: Выполняет логику `get cache data` и возвращает вычисленный результат.

### `fan\core\plain\image::_getNailData`

- Расположение: `core/plain/image.php:269`
...
- Расположение: `core/plain/obfuscator.php:39`
- Сигнатура: `function __construct(\fan\core\service\plain $handler, $key)`
...
- Расположение: `core/plain/obfuscator.php:55`
...
- Расположение: `core/plain/obfuscator.php:64`
...
- Расположение: `core/plain/obfuscator.php:76`
- Сигнатура: `function _getContent()`
- Описание: Выполняет логику `get content` и возвращает вычисленный результат.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/service/application.php:38`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/application.php:61`
...
- Расположение: `core/service/application.php:82`
...
- Расположение: `core/service/application.php:95`
...
- Расположение: `core/service/application.php:106`
...
- Расположение: `core/service/application.php:116`
...
- Расположение: `core/service/cache.php:57`
...
- Расположение: `core/service/cache.php:81`
...
- Расположение: `core/service/cache.php:105`
...
- Расположение: `core/service/cache.php:133`
...
- Расположение: `core/service/cache.php:147`
...
- Расположение: `core/service/cache.php:164`
...
- Расположение: `core/service/cache.php:186`
...
- Расположение: `core/service/cache.php:199`
...
- Расположение: `core/service/cache.php:213`
...
- Расположение: `core/service/cache.php:230`
...
- Расположение: `core/service/cache.php:279`
...
- Расположение: `core/service/cache.php:292`
...
- Расположение: `core/service/cache.php:306`
...
- Расположение: `core/service/cache.php:322`
...
- Расположение: `core/service/cache.php:338`
...
- Расположение: `core/service/cache.php:351`
...
- Расположение: `core/service/cache.php:365`
...
- Расположение: `core/service/cache.php:378`
...
- Расположение: `core/service/cache.php:390`
...
- Расположение: `core/service/cache/base.php:85`
...
- Расположение: `core/service/cache/base.php:96`
...
- Расположение: `core/service/cache/base.php:114`
...
- Расположение: `core/service/cache/base.php:133`
...
- Расположение: `core/service/cache/base.php:154`
...
- Расположение: `core/service/cache/base.php:172`
...
- Расположение: `core/service/cache/base.php:190`
...
- Расположение: `core/service/cache/base.php:204`
...
- Расположение: `core/service/cache/base.php:222`
...
- Расположение: `core/service/cache/base.php:236`
...
- Расположение: `core/service/cache/base.php:252`
- Сигнатура: `function isActual()`
- Описание: Проверяет условие или валидирует данные `actual` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\cache\base::save`

- Расположение: `core/service/cache/base.php:262`
- Сигнатура: `function save()`
...
- Расположение: `core/service/cache/base.php:276`
- Сигнатура: `function delete()`
...
- Расположение: `core/service/cache/base.php:291`
...
- Расположение: `core/service/cache/base.php:302`
...
- Расположение: `core/service/cache/base.php:312`
- Сигнатура: `function isSaved()`
- Описание: Проверяет условие или валидирует данные `saved` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\cache\base::setFacade`

- Расположение: `core/service/cache/base.php:324`
...
- Расположение: `core/service/cache/base.php:340`
...
- Расположение: `core/service/cache/base.php:367`
...
- Расположение: `core/service/cache/base.php:384`
...
- Расположение: `core/service/cache/base.php:406`
...
- Расположение: `core/service/cache/base.php:427`
...
- Расположение: `core/service/cache/base.php:440`
...
- Расположение: `core/service/cache/base.php:466`
...
- Расположение: `core/service/cache/base.php:490`
...
- Расположение: `core/service/cache/base.php:510`
...
- Расположение: `core/service/cache/file.php:106`
- Сигнатура: `function _deleteData()`
- Описание: Выполняет логику `delete data` и возвращает вычисленный результат.
- Побочные эффекты: работает с файловой системой
...
- Расположение: `core/service/cache/file.php:124`
...
- Расположение: `core/service/cache/file.php:171`
...
- Расположение: `core/service/cache/file.php:185`
...
- Расположение: `core/service/cache/memcache.php:35`
- Сигнатура: `function _loadData($loadMetaOnly)`
- Описание: Выполняет логику `load data` и возвращает вычисленный результат.

### `fan\core\service\cache\memcache::_saveData`

- Расположение: `core/service/cache/memcache.php:53`
- Сигнатура: `function _saveData()`
- Описание: Выполняет workflow-логику `save data`.

### `fan\core\service\cache\memcache::_deleteData`

- Расположение: `core/service/cache/memcache.php:65`
- Сигнатура: `function _deleteData()`
- Описание: Выполняет логику `delete data` и возвращает вычисленный результат.

### `fan\core\service\cache\memcache::_getKeeper`

- Расположение: `core/service/cache/memcache.php:81`
...
- Расположение: `core/service/cache/memcache.php:108`
...
- Расположение: `core/service/cache/memcached.php:29`
- Сигнатура: `function _loadData($loadMetaOnly)`
- Описание: Выполняет workflow-логику `load data`.

### `fan\core\service\cache\memcached::_saveData`

- Расположение: `core/service/cache/memcached.php:39`
- Сигнатура: `function _saveData()`
- Описание: Выполняет workflow-логику `save data`.

### `fan\core\service\cache\memcached::_deleteData`

- Расположение: `core/service/cache/memcached.php:49`
- Сигнатура: `function _deleteData()`
...
- Расположение: `core/service/cache/wrapper/file_data.php:54`
...
- Расположение: `core/service/cache/wrapper/file_data.php:75`
...
- Расположение: `core/service/cache/wrapper/file_data.php:93`
...
- Расположение: `core/service/cache/wrapper/file_data.php:122`
...
- Расположение: `core/service/captcha.php:105`
...
- Расположение: `core/service/captcha.php:115`
...
- Расположение: `core/service/captcha.php:128`
...
- Расположение: `core/service/captcha.php:142`
...
- Расположение: `core/service/captcha.php:152`
...
- Расположение: `core/service/captcha.php:162`
...
- Расположение: `core/service/captcha.php:173`
...
- Расположение: `core/service/captcha.php:188`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:44`
- Сигнатура: `function getData()`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:59`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:122`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:142`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:162`
...
- Расположение: `core/service/captcha/file_maker/picture_1.php:189`
...
## `core/service/captcha/text_generator/simple.php`

### `fan\core\service\captcha\text_generator\simple::makeNewText`

- Расположение: `core/service/captcha/text_generator/simple.php:29`
...
## `core/service/cli.php`

### `fan\core\service\cli::__construct`

- Расположение: `core/service/cli.php:27`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/cli.php:43`
...
- Расположение: `core/service/cli.php:62`
...
- Расположение: `core/service/cli.php:83`
...
- Расположение: `core/service/config.php:71`
...
- Расположение: `core/service/config.php:125`
...
- Расположение: `core/service/config.php:139`
...
- Расположение: `core/service/config.php:162`
...
- Расположение: `core/service/config.php:180`
...
- Расположение: `core/service/config.php:199`
...
- Расположение: `core/service/config.php:227`
...
- Расположение: `core/service/config.php:239`
...
- Расположение: `core/service/config.php:266`
...
- Расположение: `core/service/config.php:287`
...
- Расположение: `core/service/config.php:313`
...
- Расположение: `core/service/config.php:336`
...
- Расположение: `core/service/config.php:358`
...
- Расположение: `core/service/config.php:383`
- Сигнатура: `function _setConfig()`
- Описание: Выполняет логику `set config` и возвращает вычисленный результат.

### `fan\core\service\config::_getConfigEngine`

- Расположение: `core/service/config.php:393`
...
- Расположение: `core/service/config.php:418`
...
- Расположение: `core/service/config.php:434`
...
- Расположение: `core/service/config/base.php:45`
...
- Расположение: `core/service/config/base.php:61`
...
- Расположение: `core/service/config/base.php:80`
...
- Расположение: `core/service/config/base.php:95`
...
- Расположение: `core/service/config/base.php:108`
...
## `core/service/config/ini.php`

### `fan\core\service\config\ini::_loadSourceData`

- Расположение: `core/service/config/ini.php:34`
- Сигнатура: `function _loadSourceData($srcFilePath)`
- Описание: Выполняет логику `load source data` и возвращает вычисленный результат.

### `fan\core\service\config\ini::_separateByDot`

- Расположение: `core/service/config/ini.php:48`
...
- Расположение: `core/service/config/ini.php:72`
...
- Расположение: `core/service/config/row.php:52`
...
- Расположение: `core/service/config/row.php:68`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/config/row.php:87`
...
- Расположение: `core/service/config/row.php:107`
...
- Расположение: `core/service/config/row.php:127`
...
- Расположение: `core/service/config/row.php:147`
...
- Расположение: `core/service/config/row.php:163`
...
- Расположение: `core/service/config/row.php:173`
...
- Расположение: `core/service/config/row.php:187`
...
- Расположение: `core/service/config/row.php:214`
...
- Расположение: `core/service/config/row.php:238`
- Сигнатура: `function _makeSubData($key, $value)`
- Описание: Выполняет логику `make sub data` и возвращает вычисленный результат.

### `fan\core\service\config\row::_checkSetter`

- Расположение: `core/service/config/row.php:253`
- Сигнатура: `function _checkSetter()`
- Описание: Выполняет логику `check setter` и возвращает вычисленный результат.

### `fan\core\service\config\row::__clone`

- Расположение: `core/service/config/row.php:264`
...
- Расположение: `core/service/config/row.php:275`
- Сигнатура: `function __unset($key)`
...
- Расположение: `core/service/config/row.php:288`
- Сигнатура: `function __serialize(): array`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\config\row`.

### `fan\core\service\config\row::__unserialize`

- Расположение: `core/service/config/row.php:304`
- Сигнатура: `function __unserialize(array $recover): void`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\config\row`.

### `fan\core\service\config\row::serialize`

- Расположение: `core/service/config/row.php:317`
- Сигнатура: `function serialize(): string`
- Описание: Выполняет логику `serialize` и возвращает вычисленный результат.
- Побочные эффекты: сериализует или десериализует данные
...
- Расположение: `core/service/config/row.php:329`
- Сигнатура: `function unserialize($recover): void`
- Описание: Выполняет workflow-логику `unserialize`.
- Побочные эффекты: сериализует или десериализует данные
...
- Расположение: `core/service/cookie.php:62`
...
- Расположение: `core/service/cookie.php:129`
...
- Расположение: `core/service/cookie.php:151`
...
- Расположение: `core/service/cookie.php:172`
...
- Расположение: `core/service/cookie.php:192`
...
- Расположение: `core/service/cookie.php:215`
...
- Расположение: `core/service/cookie.php:232`
...
- Расположение: `core/service/cookie.php:246`
...
- Расположение: `core/service/cookie.php:271`
...
- Расположение: `core/service/cookie.php:304`
...
- Расположение: `core/service/cookie.php:316`
...
- Расположение: `core/service/curl.php:70`
...
- Расположение: `core/service/curl.php:94`
- Сигнатура: `function __destruct()`
...
- Расположение: `core/service/curl.php:107`
- Сигнатура: `function instance($url, $index = 0)`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\core\service\curl::setOption`

- Расположение: `core/service/curl.php:123`
...
- Расположение: `core/service/curl.php:136`
...
- Расположение: `core/service/curl.php:151`
...
- Расположение: `core/service/curl.php:164`
...
- Расположение: `core/service/curl.php:188`
...
- Расположение: `core/service/curl.php:206`
...
- Расположение: `core/service/curl.php:221`
...
- Расположение: `core/service/curl.php:233`
...
- Расположение: `core/service/curl.php:243`
...
- Расположение: `core/service/curl.php:256`
...
- Расположение: `core/service/curl.php:320`
...
- Расположение: `core/service/curl.php:333`
...
- Расположение: `core/service/curl.php:343`
...
- Расположение: `core/service/curl.php:355`
- Сигнатура: `function _saveInstance()`
- Описание: Выполняет логику `save instance` и возвращает вычисленный результат.

### `fan\core\service\curl::_getSeparator`

- Расположение: `core/service/curl.php:368`
...
- Расположение: `core/service/curl.php:388`
...
## `core/service/database.php`

### `fan\core\service\database::__construct`

- Расположение: `core/service/database.php:104`
...
- Расположение: `core/service/database.php:154`
- Сигнатура: `function __destruct()`
...
- Расположение: `core/service/database.php:210`
- Сигнатура: `function close()`
- Описание: Выполняет workflow-логику `close`.

### `fan\core\service\database::getCurrentInstance`

- Расположение: `core/service/database.php:228`
...
- Расположение: `core/service/database.php:238`
...
- Расположение: `core/service/database.php:271`
...
- Расположение: `core/service/database.php:293`
- Сигнатура: `function getConnectionName()`
...
- Расположение: `core/service/database.php:302`
...
- Расположение: `core/service/database.php:314`
...
- Расположение: `core/service/database.php:325`
...
- Расположение: `core/service/database.php:339`
...
- Расположение: `core/service/database.php:349`
...
- Расположение: `core/service/database.php:363`
...
- Расположение: `core/service/database.php:379`
...
- Расположение: `core/service/database.php:392`
...
- Расположение: `core/service/database.php:405`
...
- Расположение: `core/service/database.php:422`
...
- Расположение: `core/service/database.php:445`
...
- Расположение: `core/service/database.php:474`
...
- Расположение: `core/service/database.php:505`
...
- Расположение: `core/service/database.php:519`
...
- Расположение: `core/service/database.php:533`
...
- Расположение: `core/service/database.php:546`
...
- Расположение: `core/service/database.php:560`
...
- Расположение: `core/service/database.php:573`
...
- Расположение: `core/service/database.php:586`
...
- Расположение: `core/service/database.php:596`
...
- Расположение: `core/service/database.php:611`
...
- Расположение: `core/service/database.php:623`
...
- Расположение: `core/service/database.php:658`
...
- Расположение: `core/service/database.php:668`
- Сигнатура: `function getParsedSql()`
...
- Расположение: `core/service/database.php:683`
...
- Расположение: `core/service/database.php:717`
...
- Расположение: `core/service/database.php:743`
...
- Расположение: `core/service/database.php:763`
...
- Расположение: `core/service/database.php:793`
...
- Расположение: `core/service/database.php:811`
...
- Расположение: `core/service/database/adodb.php:58`
...
- Расположение: `core/service/database/adodb.php:68`
...
- Расположение: `core/service/database/adodb.php:133`
- Сигнатура: `function getInsertId()`
...
- Расположение: `core/service/database/adodb.php:150`
...
- Расположение: `core/service/database/adodb.php:163`
...
- Расположение: `core/service/database/adodb.php:176`
...
- Расположение: `core/service/database/adodb.php:196`
...
- Расположение: `core/service/database/adodb.php:209`
...
- Расположение: `core/service/database/adodb.php:222`
...
- Расположение: `core/service/database/adodb.php:237`
...
- Расположение: `core/service/database/adodb.php:256`
- Сигнатура: `function getVersion()`
...
- Расположение: `core/service/database/adodb.php:271`
...
- Расположение: `core/service/database/adodb.php:292`
...
- Расположение: `core/service/database/adodb.php:314`
...
## `core/service/database/base.php`

### `fan\core\service\database\base::__construct`

- Расположение: `core/service/database/base.php:58`
...
- Расположение: `core/service/database/base.php:72`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/database/base.php:87`
- Сигнатура: `function setResultTypes($resultType = MYSQL_ASSOC)`
...
- Расположение: `core/service/database/base.php:120`
- Сигнатура: `function resetError()`
...
- Расположение: `core/service/database/base.php:133`
...
- Расположение: `core/service/database/base.php:154`
...
- Расположение: `core/service/database/mysql.php:183`
- Сигнатура: `function startTransaction()`
...
- Расположение: `core/service/database/mysql.php:195`
- Сигнатура: `function setSavePoint(string $savePoint)`
...
- Расположение: `core/service/database/mysql.php:205`
- Сигнатура: `function commit()`
- Описание: Выполняет логику `commit` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/database/mysql.php:217`
...
- Расположение: `core/service/database/mysql.php:227`
- Сигнатура: `function getInsertId()`
...
- Расположение: `core/service/database/mysql.php:245`
- Сигнатура: `function getOne(string $sql, string $fieldName, ?array $param = null)`
...
- Расположение: `core/service/database/mysql.php:260`
- Сигнатура: `function getRow(string $sql, ?array $param = null, ?int $resultType = null)`
...
- Расположение: `core/service/database/mysql.php:274`
- Сигнатура: `function getRowAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysql.php:288`
...
- Расположение: `core/service/database/mysql.php:308`
- Сигнатура: `function getAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysql.php:331`
...
- Расположение: `core/service/database/mysql.php:348`
...
- Расположение: `core/service/database/mysql.php:362`
- Сигнатура: `function getVersion()`
...
- Расположение: `core/service/database/mysql.php:378`
- Сигнатура: `function getTableStatus(string $tableName)`
...
- Расположение: `core/service/database/mysql.php:392`
- Сигнатура: `function parseSql(string $sql, array $param)`
...
- Расположение: `core/service/database/mysql.php:402`
- Сигнатура: `function getParsedSql()`
...
- Расположение: `core/service/database/mysql.php:417`
...
- Расположение: `core/service/database/mysqlImproved.php:31`
- Сигнатура: `function reconnect(array $param, bool $makeException = true)`
- Описание: Выполняет workflow-логику `reconnect`.

### `fan\core\service\database\mysqlImproved::connectionClose`

- Расположение: `core/service/database/mysqlImproved.php:40`
- Сигнатура: `function connectionClose()`
- Описание: Выполняет логику `connection close` и возвращает вычисленный результат.

### `fan\core\service\database\mysqlImproved::execute`

- Расположение: `core/service/database/mysqlImproved.php:54`
...
- Расположение: `core/service/database/mysqlImproved.php:64`
- Сигнатура: `function startTransaction()`
...
- Расположение: `core/service/database/mysqlImproved.php:76`
- Сигнатура: `function setSavePoint(string $savePoint)`
...
- Расположение: `core/service/database/mysqlImproved.php:86`
- Сигнатура: `function commit()`
- Описание: Выполняет логику `commit` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/database/mysqlImproved.php:98`
- Сигнатура: `function rollback(?string $savePoint = null)`
- Описание: Выполняет логику `rollback` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/database/mysqlImproved.php:108`
- Сигнатура: `function getInsertId()`
...
- Расположение: `core/service/database/mysqlImproved.php:126`
- Сигнатура: `function getOne(string $sql, string $fieldName, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:141`
- Сигнатура: `function getRow(string $sql, ?array $param = null, ?int $resultType = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:155`
- Сигнатура: `function getRowAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:169`
- Сигнатура: `function getCol(string $sql, $colName, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:189`
- Сигнатура: `function getAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:212`
- Сигнатура: `function getAll(string $sql, ?array $param = null, $resultType = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:229`
- Сигнатура: `function getAllLimit(string $sql, ?array $param = null, $qtt = -1, $offset = -1, $resultType = null)`
...
- Расположение: `core/service/database/mysqlImproved.php:243`
- Сигнатура: `function getVersion()`
...
- Расположение: `core/service/database/mysqlImproved.php:259`
- Сигнатура: `function getTableStatus(string $tableName)`
...
- Расположение: `core/service/database/mysqlImproved.php:273`
- Сигнатура: `function parseSql(string $sql, array $param)`
...
- Расположение: `core/service/database/mysqlImproved.php:283`
- Сигнатура: `function getParsedSql()`
...
- Расположение: `core/service/database/mysqlPdo.php:31`
- Сигнатура: `function reconnect(array $param, bool $makeException = true)`
- Описание: Выполняет workflow-логику `reconnect`.

### `fan\core\service\database\mysqlPdo::connectionClose`

- Расположение: `core/service/database/mysqlPdo.php:40`
- Сигнатура: `function connectionClose()`
- Описание: Выполняет логику `connection close` и возвращает вычисленный результат.

### `fan\core\service\database\mysqlPdo::execute`

- Расположение: `core/service/database/mysqlPdo.php:54`
- Сигнатура: `function execute(string $sql, ?array $param = null, ?int $resultType = null)`
- Описание: Выполняет логику `execute` и возвращает вычисленный результат.

### `fan\core\service\database\mysqlPdo::startTransaction`

- Расположение: `core/service/database/mysqlPdo.php:64`
- Сигнатура: `function startTransaction()`
...
- Расположение: `core/service/database/mysqlPdo.php:76`
- Сигнатура: `function setSavePoint(string $savePoint)`
...
- Расположение: `core/service/database/mysqlPdo.php:86`
- Сигнатура: `function commit()`
- Описание: Выполняет логику `commit` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/database/mysqlPdo.php:98`
- Сигнатура: `function rollback(?string $savePoint = null)`
- Описание: Выполняет логику `rollback` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/database/mysqlPdo.php:108`
- Сигнатура: `function getInsertId()`
...
- Расположение: `core/service/database/mysqlPdo.php:126`
- Сигнатура: `function getOne(string $sql, string $fieldName, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:141`
- Сигнатура: `function getRow(string $sql, ?array $param = null, ?int $resultType = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:155`
- Сигнатура: `function getRowAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:169`
- Сигнатура: `function getCol(string $sql, $colName, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:189`
- Сигнатура: `function getAssoc(string $sql, ?array $param = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:212`
- Сигнатура: `function getAll(string $sql, ?array $param = null, $resultType = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:229`
- Сигнатура: `function getAllLimit(string $sql, ?array $param = null, $qtt = -1, $offset = -1, $resultType = null)`
...
- Расположение: `core/service/database/mysqlPdo.php:243`
- Сигнатура: `function getVersion()`
...
- Расположение: `core/service/database/mysqlPdo.php:259`
- Сигнатура: `function getTableStatus(string $tableName)`
...
- Расположение: `core/service/database/mysqlPdo.php:273`
- Сигнатура: `function parseSql(string $sql, array $param)`
...
- Расположение: `core/service/database/mysqlPdo.php:283`
- Сигнатура: `function getParsedSql()`
...
- Расположение: `core/service/date.php:69`
...
- Расположение: `core/service/date.php:94`
...
- Расположение: `core/service/date.php:134`
...
- Расположение: `core/service/date.php:153`
...
- Расположение: `core/service/date.php:182`
...
- Расположение: `core/service/date.php:194`
...
- Расположение: `core/service/date.php:208`
...
- Расположение: `core/service/date.php:225`
...
- Расположение: `core/service/date.php:235`
...
- Расположение: `core/service/date.php:251`
...
- Расположение: `core/service/date.php:264`
...
- Расположение: `core/service/date.php:278`
...
- Расположение: `core/service/date.php:290`
...
- Расположение: `core/service/date.php:311`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\date::isValid`

- Расположение: `core/service/date.php:321`
...
- Расположение: `core/service/date.php:333`
- Сигнатура: `function _saveInstance()`
- Описание: Выполняет логику `save instance` и возвращает вычисленный результат.

### `fan\core\service\date::_getPattern`

- Расположение: `core/service/date.php:350`
...
- Расположение: `core/service/date.php:366`
- Сигнатура: `function __toString()`
...
- Расположение: `core/service/debug.php:35`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/debug.php:51`
...
- Расположение: `core/service/debug.php:81`
...
- Расположение: `core/service/debug.php:94`
...
- Расположение: `core/service/debug.php:116`
...
- Расположение: `core/service/debug.php:155`
...
- Расположение: `core/service/debug.php:199`
...
- Расположение: `core/service/debug.php:241`
...
- Расположение: `core/service/debug.php:260`
...
- Расположение: `core/service/debug.php:274`
...
- Расположение: `core/service/debug.php:303`
...
- Расположение: `core/service/debug.php:320`
...
- Расположение: `core/service/debug.php:359`
...
- Расположение: `core/service/email.php:73`
...
- Расположение: `core/service/email.php:94`
...
- Расположение: `core/service/email.php:107`
...
- Расположение: `core/service/email.php:123`
...
- Расположение: `core/service/email.php:139`
...
- Расположение: `core/service/email.php:155`
...
- Расположение: `core/service/email.php:173`
...
- Расположение: `core/service/email.php:192`
...
- Расположение: `core/service/email.php:208`
...
- Расположение: `core/service/email.php:251`
...
- Расположение: `core/service/email.php:275`
...
- Расположение: `core/service/email.php:287`
...
- Расположение: `core/service/email.php:318`
...
- Расположение: `core/service/email.php:330`
...
## `core/service/email/phpmailer.php`

### `fan\core\service\email\phpmailer::__construct`

- Расположение: `core/service/email/phpmailer.php:36`
...
- Расположение: `core/service/email/phpmailer.php:54`
...
- Расположение: `core/service/email/phpmailer.php:102`
...
- Расположение: `core/service/email/phpmailer.php:120`
- Сигнатура: `function setFrom(string $emailFrom, string $nameFrom = '')`
...
- Расположение: `core/service/email/phpmailer.php:139`
- Сигнатура: `function send(string $subj, string $body, string $emailTo, string $nameTo = '', bool $isHtml = false)`
- Описание: Выполняет логику `send` и возвращает вычисленный результат.
- Побочные эффекты: использует service locator/helpers фреймворка; логирует или сообщает об ошибках
...
- Расположение: `core/service/entity.php:83`
- Сигнатура: `function instance($collection = 0)`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\core\service\entity::__get`

- Расположение: `core/service/entity.php:99`
...
- Расположение: `core/service/entity.php:115`
...
- Расположение: `core/service/entity.php:139`
...
- Расположение: `core/service/entity.php:153`
...
- Расположение: `core/service/entity.php:172`
...
- Расположение: `core/service/entity.php:183`
...
- Расположение: `core/service/entity.php:193`
...
- Расположение: `core/service/entity.php:204`
...
- Расположение: `core/service/entity.php:217`
...
- Расположение: `core/service/entity.php:232`
...
- Расположение: `core/service/entity.php:251`
...
- Расположение: `core/service/entity.php:263`
...
- Расположение: `core/service/entity.php:281`
...
- Расположение: `core/service/entity.php:301`
...
- Расположение: `core/service/entity.php:318`
...
- Расположение: `core/service/entity.php:375`
...
- Расположение: `core/service/entity/description.php:89`
...
- Расположение: `core/service/entity/description.php:107`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/service/entity/description.php:119`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\entity\description`.

### `fan\core\service\entity\description::__call`

- Расположение: `core/service/entity/description.php:133`
- Сигнатура: `function __call($method, $args)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\entity\description`.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/service/entity/description.php:155`
...
- Расположение: `core/service/entity/description.php:174`
...
- Расположение: `core/service/entity/description.php:194`
...
- Расположение: `core/service/entity/description.php:210`
...
- Расположение: `core/service/entity/description.php:220`
- Сигнатура: `function getTableName()`
...
- Расположение: `core/service/entity/description.php:232`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\entity\description::getEntity`

- Расположение: `core/service/entity/description.php:242`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/service/entity/description.php:258`
...
- Расположение: `core/service/entity/description.php:274`
...
- Расположение: `core/service/entity/description.php:294`
...
- Расположение: `core/service/entity/description.php:315`
...
- Расположение: `core/service/entity/description.php:346`
...
- Расположение: `core/service/entity/descriptor.php:59`
...
- Расположение: `core/service/entity/descriptor.php:65`
...
- Расположение: `core/service/entity/descriptor.php:71`
...
- Расположение: `core/service/entity/descriptor.php:77`
...
- Расположение: `core/service/entity/descriptor.php:83`
...
- Расположение: `core/service/entity/descriptor.php:89`
...
- Расположение: `core/service/entity/descriptor.php:95`
...
- Расположение: `core/service/entity/descriptor.php:101`
...
## `core/service/entity/descriptor/mysql.php`

### `fan\core\service\entity\descriptor\mysql::getPrimeryKey`

- Расположение: `core/service/entity/descriptor/mysql.php:41`
- Сигнатура: `function getPrimeryKey()`
...
- Расположение: `core/service/entity/descriptor/mysql.php:57`
- Сигнатура: `function getKeys()`
...
- Расположение: `core/service/entity/descriptor/mysql.php:89`
...
- Расположение: `core/service/entity/descriptor/mysql.php:106`
- Сигнатура: `function _getKeys()`
- Описание: Выполняет логику `get keys` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции

## `core/service/entity/descriptor/mysql/direct.php`

### `fan\core\service\entity\descriptor\mysql\direct::isTableExists`

- Расположение: `core/service/entity/descriptor/mysql/direct.php:37`
- Сигнатура: `function isTableExists()`
- Описание: Проверяет условие или валидирует данные `table exists` и возвращает результат либо выбрасывает исключение.
- Побочные эффекты: выполняет database операции
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:47`
- Сигнатура: `function getFields()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:99`
- Сигнатура: `function getRelations()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:139`
- Сигнатура: `function getEngine()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:149`
- Сигнатура: `function getCreateTime()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:159`
- Сигнатура: `function getTableCollation()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:169`
- Сигнатура: `function getComment()`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:185`
...
- Расположение: `core/service/entity/descriptor/mysql/direct.php:198`
- Сигнатура: `function _getCreateTable()`
- Описание: Выполняет логику `get create table` и возвращает вычисленный результат.
- Побочные эффекты: выполняет database операции

## `core/service/entity/descriptor/mysql/schema.php`

### `fan\core\service\entity\descriptor\mysql\schema::__construct`

- Расположение: `core/service/entity/descriptor/mysql/schema.php:51`
- Сигнатура: `function __construct(\fan\core\service\entity\description $description)`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:103`
- Сигнатура: `function isTableExists()`
- Описание: Проверяет условие или валидирует данные `table exists` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\entity\descriptor\mysql\schema::getFields`

- Расположение: `core/service/entity/descriptor/mysql/schema.php:113`
- Сигнатура: `function getFields()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:150`
- Сигнатура: `function getRelations()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:173`
- Сигнатура: `function getEngine()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:183`
- Сигнатура: `function getCreateTime()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:193`
- Сигнатура: `function getTableCollation()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:203`
- Сигнатура: `function getComment()`
...
- Расположение: `core/service/entity/descriptor/mysql/schema.php:215`
...
- Расположение: `core/service/entity/designer.php:65`
...
- Расположение: `core/service/entity/designer.php:77`
- Сигнатура: `function __get($partName)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\entity\designer`.

### `fan\core\service\entity\designer::__toString`

- Расположение: `core/service/entity/designer.php:87`
- Сигнатура: `function __toString()`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\entity\designer`.

### `fan\core\service\entity\designer::set`

- Расположение: `core/service/entity/designer.php:102`
...
- Расположение: `core/service/entity/designer.php:118`
...
- Расположение: `core/service/entity/designer.php:133`
...
- Расположение: `core/service/entity/designer.php:163`
...
- Расположение: `core/service/entity/designer.php:216`
...
- Расположение: `core/service/entity/designer.php:236`
...
- Расположение: `core/service/entity/designer.php:246`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\entity\designer::getEntity`

- Расположение: `core/service/entity/designer.php:255`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/service/entity/designer.php:271`
...
- Расположение: `core/service/entity/designer.php:289`
...
## `core/service/entity/designer/insert.php`

### `fan\core\service\entity\designer\insert::setInsertByParam`

- Расположение: `core/service/entity/designer/insert.php:44`
...
## `core/service/entity/designer/select.php`

### `fan\core\service\entity\designer\select::setSelectByParam`

- Расположение: `core/service/entity/designer/select.php:50`
...
- Расположение: `core/service/entity/designer/select.php:64`
...
## `core/service/entity/designer/snippety.php`

### `fan\core\service\entity\designer\snippety::setSqlRequest`

- Расположение: `core/service/entity/designer/snippety.php:44`
...
- Расположение: `core/service/entity/designer/snippety.php:64`
...
- Расположение: `core/service/entity/designer/snippety.php:79`
...
- Расположение: `core/service/entity/designer/snippety.php:93`
...
- Расположение: `core/service/entity/designer/snippety.php:110`
...
## `core/service/entity/encapsulant/simple.php`

### `fan\core\service\entity\encapsulant\simple::__construct`

- Расположение: `core/service/entity/encapsulant/simple.php:32`
...
- Расположение: `core/service/entity/encapsulant/simple.php:47`
...
- Расположение: `core/service/entity/encapsulant/simple.php:77`
...
- Расположение: `core/service/entity/encapsulant/simple.php:115`
...
- Расположение: `core/service/entity/encapsulant/simple.php:126`
...
- Расположение: `core/service/entity/encapsulant/simple.php:140`
...
- Расположение: `core/service/entity/encapsulant/simple.php:152`
...
- Расположение: `core/service/entity/encapsulant/simple.php:164`
...
- Расположение: `core/service/entity/snippet.php:106`
...
- Расположение: `core/service/entity/snippet.php:129`
...
- Расположение: `core/service/entity/snippet.php:161`
...
- Расположение: `core/service/entity/snippet.php:170`
...
- Расположение: `core/service/entity/snippet.php:179`
- Сигнатура: `function getCondition()`
...
- Расположение: `core/service/entity/snippet.php:188`
...
- Расположение: `core/service/entity/snippet.php:197`
...
- Расположение: `core/service/entity/snippet.php:207`
...
- Расположение: `core/service/entity/snippet.php:216`
- Сигнатура: `function getEntity()`
...
- Расположение: `core/service/entity/snippet.php:231`
...
- Расположение: `core/service/entity/snippet.php:279`
...
- Расположение: `core/service/entity/snippet.php:303`
...
- Расположение: `core/service/entity/snippet.php:337`
...
- Расположение: `core/service/error.php:112`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/error.php:157`
...
- Расположение: `core/service/error.php:241`
...
- Расположение: `core/service/error.php:258`
...
- Расположение: `core/service/error.php:268`
...
- Расположение: `core/service/error.php:284`
...
- Расположение: `core/service/error.php:304`
...
- Расположение: `core/service/error.php:320`
...
- Расположение: `core/service/error.php:340`
...
- Расположение: `core/service/error.php:359`
...
- Расположение: `core/service/error.php:373`
...
- Расположение: `core/service/error.php:390`
...
- Расположение: `core/service/error.php:418`
...
- Расположение: `core/service/error.php:462`
...
- Расположение: `core/service/error.php:496`
...
- Расположение: `core/service/error.php:518`
...
- Расположение: `core/service/error.php:536`
...
- Расположение: `core/service/file_system.php:51`
...
- Расположение: `core/service/file_system.php:69`
- Сигнатура: `function instance(?string $srcPath = null)`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\core\service\file_system::isFile`

- Расположение: `core/service/file_system.php:86`
...
- Расположение: `core/service/file_system.php:96`
...
- Расположение: `core/service/file_system.php:106`
...
- Расположение: `core/service/file_system.php:121`
...
- Расположение: `core/service/file_system.php:140`
...
- Расположение: `core/service/file_system.php:152`
...
- Расположение: `core/service/file_system.php:166`
...
- Расположение: `core/service/file_system.php:214`
...
## `core/service/form.php`

### `fan\core\service\form::__construct`

- Расположение: `core/service/form.php:103`
...
- Расположение: `core/service/form.php:246`
...
- Расположение: `core/service/form.php:314`
...
- Расположение: `core/service/form.php:396`
...
- Расположение: `core/service/form.php:410`
...
- Расположение: `core/service/form.php:426`
...
- Расположение: `core/service/form.php:450`
...
- Расположение: `core/service/form.php:470`
...
- Расположение: `core/service/form.php:487`
...
- Расположение: `core/service/form.php:518`
...
- Расположение: `core/service/form.php:534`
...
- Расположение: `core/service/form.php:555`
...
- Расположение: `core/service/form.php:578`
...
- Расположение: `core/service/form.php:588`
...
- Расположение: `core/service/form.php:598`
- Сигнатура: `function isError()`
- Описание: Проверяет условие или валидирует данные `error` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\form::checkFormRole`

- Расположение: `core/service/form.php:608`
- Сигнатура: `function checkFormRole()`
- Описание: Проверяет условие или валидирует данные `form role` и возвращает результат либо выбрасывает исключение.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/service/form.php:622`
...
- Расположение: `core/service/form.php:644`
...
- Расположение: `core/service/form.php:669`
...
- Расположение: `core/service/form.php:680`
...
- Расположение: `core/service/form.php:780`
...
- Расположение: `core/service/form.php:826`
...
- Расположение: `core/service/form.php:848`
...
- Расположение: `core/service/form.php:866`
...
- Расположение: `core/service/form.php:940`
...
- Расположение: `core/service/form.php:976`
...
- Расположение: `core/service/form.php:995`
...
- Расположение: `core/service/form.php:1023`
...
- Расположение: `core/service/form.php:1043`
...
- Расположение: `core/service/form.php:1085`
...
- Расположение: `core/service/form.php:1102`
...
- Расположение: `core/service/form.php:1125`
- Сигнатура: `function __set($key, $value)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\form`.

### `fan\core\service\form::__get`

- Расположение: `core/service/form.php:1137`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\form`.

### `fan\core\service\form::__isset`

- Расположение: `core/service/form.php:1149`
- Сигнатура: `function __isset($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\form`.

## `core/service/form/validator/base.php`

### `fan\core\service\form\validator\base::setFacade`

- Расположение: `core/service/form/validator/base.php:40`
...
## `core/service/form/validator/common.php`

### `fan\core\service\form\validator\common::isRequired`

- Расположение: `core/service/form/validator/common.php:30`
...
## `core/service/form/validator/date.php`

### `fan\core\service\form\validator\date::isDate`

- Расположение: `core/service/form/validator/date.php:30`
...
## `core/service/form/validator/number.php`

### `fan\core\service\form\validator\number::isInt`

- Расположение: `core/service/form/validator/number.php:30`
...
- Расположение: `core/service/form/validator/number.php:52`
...
- Расположение: `core/service/form/validator/number.php:109`
...
- Расположение: `core/service/form/validator/number.php:130`
...
- Расположение: `core/service/form/validator/number.php:151`
...
- Расположение: `core/service/form/validator/number.php:168`
...
## `core/service/form/validator/phone.php`

### `fan\core\service\form\validator\phone::isUkrainianPhone`

- Расположение: `core/service/form/validator/phone.php:28`
...
## `core/service/form/validator/select.php`

### `fan\core\service\form\validator\select::checkSelect`

- Расположение: `core/service/form/validator/select.php:30`
...
- Расположение: `core/service/form/validator/string_validator.php:50`
...
- Расположение: `core/service/form/validator/string_validator.php:70`
...
- Расположение: `core/service/form/validator/string_validator.php:83`
...
- Расположение: `core/service/form/validator/string_validator.php:96`
...
## `core/service/form/validator/upload.php`

### `fan\core\service\form\validator\upload::uploadError`

- Расположение: `core/service/form/validator/upload.php:29`
...
- Расположение: `core/service/form/validator/upload.php:42`
...
- Расположение: `core/service/form/validator/upload.php:65`
...
## `core/service/form/validator/uri.php`

### `fan\core\service\form\validator\uri::isEmail`

- Расположение: `core/service/form/validator/uri.php:30`
...
- Расположение: `core/service/form/validator/uri.php:43`
...
- Расположение: `core/service/header.php:90`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/header.php:110`
...
- Расположение: `core/service/header.php:128`
- Сигнатура: `function setHeaders(array $headers)`
...
- Расположение: `core/service/header.php:144`
...
- Расположение: `core/service/header.php:157`
...
- Расположение: `core/service/header.php:167`
...
- Расположение: `core/service/header.php:191`
...
- Расположение: `core/service/header.php:209`
...
- Расположение: `core/service/header.php:226`
...
- Расположение: `core/service/header.php:236`
...
- Расположение: `core/service/header.php:250`
...
- Расположение: `core/service/header.php:263`
...
- Расположение: `core/service/header.php:282`
...
- Расположение: `core/service/header.php:302`
...
- Расположение: `core/service/header.php:322`
...
- Расположение: `core/service/header.php:335`
...
- Расположение: `core/service/header.php:363`
...
- Расположение: `core/service/header.php:380`
...
- Расположение: `core/service/header.php:398`
...
- Расположение: `core/service/header.php:412`
...
- Расположение: `core/service/header.php:424`
...
- Расположение: `core/service/header.php:436`
...
- Расположение: `core/service/header.php:448`
...
- Расположение: `core/service/header.php:459`
...
- Расположение: `core/service/header.php:472`
...
- Расположение: `core/service/header.php:487`
...
- Расположение: `core/service/header.php:505`
...
- Расположение: `core/service/header.php:526`
...
- Расположение: `core/service/header.php:544`
...
- Расположение: `core/service/header.php:569`
...
- Расположение: `core/service/header/code.php:26`
...
- Расположение: `core/service/header/code.php:40`
...
- Расположение: `core/service/header/code.php:60`
...
- Расположение: `core/service/header/code.php:80`
...
- Расположение: `core/service/header/code.php:116`
...
- Расположение: `core/service/image_draw.php:33`
...
- Расположение: `core/service/image_draw.php:51`
...
- Расположение: `core/service/image_draw.php:87`
...
- Расположение: `core/service/image_draw.php:129`
...
- Расположение: `core/service/image_draw.php:159`
...
- Расположение: `core/service/image_draw.php:179`
...
- Расположение: `core/service/image_draw.php:213`
...
- Расположение: `core/service/image_draw.php:253`
...
- Расположение: `core/service/image_draw.php:274`
...
- Расположение: `core/service/image_draw.php:291`
...
- Расположение: `core/service/image_draw.php:307`
...
- Расположение: `core/service/image_draw.php:319`
...
- Расположение: `core/service/image_modify.php:83`
...
- Расположение: `core/service/image_modify.php:103`
...
- Расположение: `core/service/image_modify.php:127`
...
- Расположение: `core/service/image_modify.php:194`
...
- Расположение: `core/service/image_modify.php:224`
...
- Расположение: `core/service/image_modify.php:235`
...
- Расположение: `core/service/image_modify.php:245`
...
- Расположение: `core/service/image_modify.php:254`
...
- Расположение: `core/service/image_modify.php:263`
...
- Расположение: `core/service/image_modify.php:272`
...
- Расположение: `core/service/image_modify.php:288`
...
- Расположение: `core/service/image_modify.php:327`
...
- Расположение: `core/service/image_modify.php:385`
...
- Расположение: `core/service/image_modify.php:425`
...
- Расположение: `core/service/image_modify.php:465`
...
- Расположение: `core/service/image_modify.php:493`
...
- Расположение: `core/service/image_modify.php:505`
...
- Расположение: `core/service/image_modify.php:516`
...
- Расположение: `core/service/image_modify.php:527`
...
- Расположение: `core/service/image_modify.php:542`
...
- Расположение: `core/service/image_modify.php:614`
...
- Расположение: `core/service/image_modify.php:656`
...
- Расположение: `core/service/image_modify.php:669`
...
- Расположение: `core/service/image_modify.php:694`
- Сигнатура: `function getImage()`
...
- Расположение: `core/service/image_modify.php:712`
...
- Расположение: `core/service/image_modify.php:735`
...
- Расположение: `core/service/image_modify.php:756`
...
- Расположение: `core/service/image_modify.php:778`
...
- Расположение: `core/service/image_modify.php:794`
...
- Расположение: `core/service/image_modify.php:819`
...
- Расположение: `core/service/json.php:45`
...
- Расположение: `core/service/json.php:111`
...
- Расположение: `core/service/json.php:147`
...
- Расположение: `core/service/json.php:189`
...
- Расположение: `core/service/json.php:214`
...
- Расположение: `core/service/json.php:254`
...
- Расположение: `core/service/locale.php:81`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/locale.php:100`
...
- Расположение: `core/service/locale.php:110`
...
- Расположение: `core/service/locale.php:122`
...
- Расположение: `core/service/locale.php:135`
...
- Расположение: `core/service/locale.php:145`
...
- Расположение: `core/service/locale.php:158`
...
- Расположение: `core/service/locale.php:199`
...
- Расположение: `core/service/locale.php:212`
...
- Расположение: `core/service/locale.php:224`
...
- Расположение: `core/service/locale.php:238`
...
- Расположение: `core/service/locale.php:250`
...
- Расположение: `core/service/locale.php:264`
...
- Расположение: `core/service/locale.php:276`
...
- Расположение: `core/service/locale.php:290`
...
- Расположение: `core/service/locale.php:300`
...
- Расположение: `core/service/locale.php:313`
...
- Расположение: `core/service/locale.php:335`
...
- Расположение: `core/service/locale.php:395`
...
- Расположение: `core/service/locale.php:462`
...
- Расположение: `core/service/locale.php:484`
...
- Расположение: `core/service/locale.php:541`
...
- Расположение: `core/service/locale.php:573`
...
- Расположение: `core/service/locale.php:586`
...
- Расположение: `core/service/locale.php:611`
...
## `core/service/log.php`

### `fan\core\service\log::getLogParser`

- Расположение: `core/service/log.php:53`
...
- Расположение: `core/service/log.php:81`
...
- Расположение: `core/service/log.php:107`
...
- Расположение: `core/service/log.php:129`
...
- Расположение: `core/service/log.php:144`
...
- Расположение: `core/service/log.php:168`
...
- Расположение: `core/service/log.php:281`
...
- Расположение: `core/service/log.php:299`
...
- Расположение: `core/service/log.php:344`
...
## `core/service/log/parser_base.php`

### `fan\core\service\log\parser_base::setFilePath`

- Расположение: `core/service/log/parser_base.php:104`
...
- Расположение: `core/service/log/parser_base.php:124`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/log/parser_base.php:134`
...
- Расположение: `core/service/log/parser_base.php:166`
- Сигнатура: `function isData($reindex = false)`
- Описание: Проверяет условие или валидирует данные `data` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\log\parser_base::getQtt`

- Расположение: `core/service/log/parser_base.php:181`
...
- Расположение: `core/service/log/parser_base.php:201`
...
- Расположение: `core/service/log/parser_base.php:224`
...
- Расположение: `core/service/log/parser_base.php:301`
...
- Расположение: `core/service/log/parser_base.php:328`
...
- Расположение: `core/service/log/parser_base.php:377`
...
- Расположение: `core/service/log/parser_base.php:395`
...
- Расположение: `core/service/log/parser_base.php:435`
...
- Расположение: `core/service/log/parser_base.php:465`
...
- Расположение: `core/service/log/parser_base.php:492`
...
- Расположение: `core/service/log/parser_base.php:511`
...
- Расположение: `core/service/matcher.php:32`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/matcher.php:47`
...
- Расположение: `core/service/matcher.php:62`
...
- Расположение: `core/service/matcher.php:75`
...
- Расположение: `core/service/matcher.php:85`
...
- Расположение: `core/service/matcher.php:96`
...
- Расположение: `core/service/matcher.php:110`
...
- Расположение: `core/service/matcher.php:123`
...
- Расположение: `core/service/matcher.php:133`
...
- Расположение: `core/service/matcher.php:146`
...
- Расположение: `core/service/matcher.php:157`
...
- Расположение: `core/service/matcher.php:167`
...
- Расположение: `core/service/matcher.php:181`
...
- Расположение: `core/service/matcher.php:194`
...
- Расположение: `core/service/matcher.php:207`
...
- Расположение: `core/service/matcher.php:218`
...
- Расположение: `core/service/matcher.php:228`
...
- Расположение: `core/service/matcher/item.php:59`
...
- Расположение: `core/service/matcher/item.php:77`
...
- Расположение: `core/service/matcher/item.php:96`
...
- Расположение: `core/service/matcher/item.php:115`
...
- Расположение: `core/service/matcher/item.php:129`
...
- Расположение: `core/service/matcher/item.php:139`
...
- Расположение: `core/service/matcher/item.php:151`
...
- Расположение: `core/service/matcher/item.php:167`
...
- Расположение: `core/service/matcher/item.php:246`
...
- Расположение: `core/service/matcher/item.php:268`
...
- Расположение: `core/service/matcher/item.php:289`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\matcher\item::_parseRequestedUri`

- Расположение: `core/service/matcher/item.php:305`
...
- Расположение: `core/service/matcher/item.php:374`
...
- Расположение: `core/service/matcher/item.php:392`
...
- Расположение: `core/service/matcher/item.php:436`
...
- Расположение: `core/service/matcher/item.php:454`
...
- Расположение: `core/service/matcher/item.php:477`
...
- Расположение: `core/service/matcher/item.php:524`
...
- Расположение: `core/service/matcher/item.php:550`
...
- Расположение: `core/service/matcher/item.php:562`
...
- Расположение: `core/service/matcher/item.php:579`
...
- Расположение: `core/service/matcher/item.php:595`
...
- Расположение: `core/service/matcher/item.php:618`
...
- Расположение: `core/service/matcher/item.php:632`
- Сигнатура: `function offsetSet(string $key, mixed $value)`
- Описание: Выполняет workflow-логику `offset set`.

### `fan\core\service\matcher\item::offsetExists`

- Расположение: `core/service/matcher/item.php:645`
- Сигнатура: `function offsetExists($key)`
- Описание: Выполняет логику `offset exists` и возвращает вычисленный результат.

### `fan\core\service\matcher\item::offsetUnset`

- Расположение: `core/service/matcher/item.php:658`
- Сигнатура: `function offsetUnset($key)`
- Описание: Выполняет workflow-логику `offset unset`.

### `fan\core\service\matcher\item::offsetGet`

- Расположение: `core/service/matcher/item.php:671`
- Сигнатура: `function offsetGet($key)`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.

### `fan\core\service\matcher\item::__set`

- Расположение: `core/service/matcher/item.php:686`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/service/matcher/item.php:698`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\matcher\item`.
...
- Расположение: `core/service/matcher/item/base.php:57`
...
- Расположение: `core/service/matcher/item/base.php:73`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/service/matcher/item/base.php:222`
- Сигнатура: `function get(string $key)`
...
- Расположение: `core/service/matcher/item/base.php:233`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\matcher\item\base::setFacade`

- Расположение: `core/service/matcher/item/base.php:245`
- Сигнатура: `function setFacade(\fan\core\service\matcher $facade)`
...
- Расположение: `core/service/matcher/item/base.php:261`
...
- Расположение: `core/service/matcher/item/base.php:279`
...
- Расположение: `core/service/matcher/item/base.php:295`
- Сигнатура: `function _makeException(string $errMsg)`
- Описание: Выполняет workflow-логику `make exception`.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/service/matcher/item/base.php:311`
- Сигнатура: `function _getConfig($key, $default = null)`
- Описание: Выполняет логику `get config` и возвращает вычисленный результат.

## `core/service/matcher/item/cli.php`

### `fan\core\service\matcher\item\cli::__toString`

- Расположение: `core/service/matcher/item/cli.php:45`
- Сигнатура: `function __toString()`
...
- Расположение: `core/service/matcher/item/handler.php:43`
- Сигнатура: `function offsetGet($key)`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.
...
- Расположение: `core/service/matcher/item/parsed.php:59`
- Сигнатура: `function __toString()`
...
- Расположение: `core/service/matcher/item/parsed.php:70`
...
- Расположение: `core/service/matcher/item/parsed.php:83`
...
- Расположение: `core/service/matcher/item/parsed.php:96`
...
- Расположение: `core/service/matcher/item/parsed.php:109`
...
- Расположение: `core/service/matcher/item/parsed.php:129`
- Сигнатура: `function getFile()`
...
- Расположение: `core/service/matcher/item/parsed.php:148`
- Сигнатура: `function getUrn()`
...
- Расположение: `core/service/matcher/item/parsed.php:172`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.
...
- Расположение: `core/service/matcher/item/source.php:40`
- Сигнатура: `function __toString()`
...
- Расположение: `core/service/matcher/item/uri.php:50`
- Сигнатура: `function __toString()`
...
- Расположение: `core/service/matcher/stack.php:38`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/matcher/stack.php:54`
...
- Расположение: `core/service/matcher/stack.php:83`
- Сигнатура: `function getLastIndex()`
...
- Расположение: `core/service/matcher/stack.php:93`
- Сигнатура: `function getCurrentIndex()`
...
- Расположение: `core/service/obfuscator.php:65`
- Сигнатура: `function __construct($type)`
...
- Расположение: `core/service/obfuscator.php:87`
- Сигнатура: `function instance(string $type)`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\core\service\obfuscator::getNewList`

- Расположение: `core/service/obfuscator.php:105`
...
- Расположение: `core/service/obfuscator.php:122`
...
- Расположение: `core/service/obfuscator.php:135`
...
- Расположение: `core/service/obfuscator.php:149`
...
- Расположение: `core/service/obfuscator.php:177`
- Сигнатура: `function getConfig($key = null, $default = null)`
...
- Расположение: `core/service/obfuscator.php:187`
- Сигнатура: `function isEnabled()`
- Описание: Проверяет условие или валидирует данные `enabled` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\obfuscator::resetEnabled`

- Расположение: `core/service/obfuscator.php:197`
- Сигнатура: `function resetEnabled()`
...
- Расположение: `core/service/obfuscator.php:210`
- Сигнатура: `function _saveInstance()`
- Описание: Выполняет логику `save instance` и возвращает вычисленный результат.

### `fan\core\service\obfuscator::_defineDir`

- Расположение: `core/service/obfuscator.php:223`
...
- Расположение: `core/service/obfuscator.php:247`
...
- Расположение: `core/service/obfuscator.php:264`
...
- Расположение: `core/service/obfuscator.php:279`
...
- Расположение: `core/service/obfuscator.php:327`
...
- Расположение: `core/service/obfuscator.php:403`
- Сигнатура: `function _getDelegate($class)`
- Описание: Выполняет логику `get delegate` и возвращает вычисленный результат.
...
- Расположение: `core/service/obfuscator/base.php:47`
- Сигнатура: `function __construct()`
...
- Расположение: `core/service/obfuscator/base.php:62`
...
- Расположение: `core/service/obfuscator/base.php:87`
...
- Расположение: `core/service/obfuscator/simple.php:34`
- Сигнатура: `function obfuscate(string $text)`
- Описание: Выполняет логику `obfuscate` и возвращает вычисленный результат.
...
- Расположение: `core/service/pager.php:61`
- Сигнатура: `function __construct(\fan\core\block\base $block)`
...
- Расположение: `core/service/pager.php:75`
...
- Расположение: `core/service/pager.php:100`
...
- Расположение: `core/service/pager.php:121`
...
- Расположение: `core/service/pager.php:134`
...
- Расположение: `core/service/pager.php:155`
...
- Расположение: `core/service/pager.php:167`
...
- Расположение: `core/service/pager.php:181`
...
- Расположение: `core/service/pager.php:194`
...
- Расположение: `core/service/pager.php:209`
...
- Расположение: `core/service/pager.php:219`
...
- Расположение: `core/service/pager.php:234`
...
- Расположение: `core/service/pager.php:255`
...
- Расположение: `core/service/pager.php:282`
...
- Расположение: `core/service/pager.php:310`
...
- Расположение: `core/service/pager.php:326`
...
- Расположение: `core/service/pager.php:344`
...
- Расположение: `core/service/pager.php:361`
...
- Расположение: `core/service/plain.php:66`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/plain.php:83`
...
- Расположение: `core/service/plain.php:97`
...
- Расположение: `core/service/plain.php:111`
...
- Расположение: `core/service/plain.php:128`
...
- Расположение: `core/service/plain.php:144`
...
- Расположение: `core/service/plain.php:162`
...
- Расположение: `core/service/plain.php:182`
- Сигнатура: `function isError()`
- Описание: Проверяет условие или валидирует данные `error` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\plain::_getFinalContent`

- Расположение: `core/service/plain.php:198`
- Сигнатура: `function _getFinalContent($method)`
- Описание: Выполняет логику `get final content` и возвращает вычисленный результат.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/service/plain.php:222`
...
- Расположение: `core/service/plain.php:240`
...
- Расположение: `core/service/plain.php:251`
...
- Расположение: `core/service/reflector.php:37`
...
- Расположение: `core/service/reflector.php:78`
...
- Расположение: `core/service/reflector.php:91`
...
- Расположение: `core/service/reflector.php:104`
...
- Расположение: `core/service/request.php:94`
- Сигнатура: `function __construct()`
...
- Расположение: `core/service/request.php:124`
- Сигнатура: `function __get($key)`
...
- Расположение: `core/service/request.php:173`
...
- Расположение: `core/service/request.php:192`
...
- Расположение: `core/service/request.php:208`
...
- Расположение: `core/service/request.php:229`
...
- Расположение: `core/service/request.php:245`
...
- Расположение: `core/service/request.php:268`
...
- Расположение: `core/service/request.php:284`
...
- Расположение: `core/service/request.php:304`
...
- Расположение: `core/service/request.php:319`
...
- Расположение: `core/service/request.php:336`
...
- Расположение: `core/service/request.php:366`
...
- Расположение: `core/service/request.php:395`
...
- Расположение: `core/service/request.php:419`
...
- Расположение: `core/service/request.php:430`
...
- Расположение: `core/service/request.php:442`
...
- Расположение: `core/service/request.php:457`
...
- Расположение: `core/service/request.php:467`
...
- Расположение: `core/service/request.php:482`
...
- Расположение: `core/service/request.php:497`
...
- Расположение: `core/service/request.php:514`
...
- Расположение: `core/service/rest.php:42`
...
- Расположение: `core/service/rest.php:65`
- Сигнатура: `function __destruct()`
...
- Расположение: `core/service/rest.php:124`
...
- Расположение: `core/service/rest.php:146`
...
- Расположение: `core/service/rest.php:164`
...
- Расположение: `core/service/rest.php:182`
- Сигнатура: `function getConnectionName()`
...
- Расположение: `core/service/rest.php:193`
...
- Расположение: `core/service/rest.php:217`
...
- Расположение: `core/service/role.php:90`
- Сигнатура: `function __construct()`
...
- Расположение: `core/service/role.php:120`
- Сигнатура: `function __destruct()`
...
- Расположение: `core/service/role.php:141`
...
- Расположение: `core/service/role.php:155`
...
- Расположение: `core/service/role.php:188`
...
- Расположение: `core/service/role.php:223`
...
- Расположение: `core/service/role.php:238`
...
- Расположение: `core/service/role.php:264`
...
- Расположение: `core/service/role.php:277`
...
- Расположение: `core/service/role.php:296`
...
- Расположение: `core/service/role.php:308`
...
- Расположение: `core/service/role.php:333`
...
- Расположение: `core/service/role.php:345`
...
- Расположение: `core/service/role.php:361`
...
- Расположение: `core/service/role.php:437`
...
- Расположение: `core/service/role.php:467`
...
- Расположение: `core/service/role.php:483`
...
- Расположение: `core/service/role.php:499`
...
- Расположение: `core/service/role.php:526`
...
- Расположение: `core/service/role.php:544`
...
- Расположение: `core/service/role.php:556`
...
- Расположение: `core/service/session.php:68`
...
- Расположение: `core/service/session.php:118`
...
- Расположение: `core/service/session.php:150`
...
- Расположение: `core/service/session.php:171`
...
- Расположение: `core/service/session.php:189`
...
- Расположение: `core/service/session.php:202`
...
- Расположение: `core/service/session.php:226`
...
- Расположение: `core/service/session.php:254`
...
- Расположение: `core/service/session.php:272`
...
- Расположение: `core/service/session.php:286`
...
- Расположение: `core/service/session.php:296`
...
- Расположение: `core/service/session.php:309`
...
- Расположение: `core/service/session.php:321`
...
- Расположение: `core/service/session.php:338`
...
- Расположение: `core/service/session.php:351`
...
- Расположение: `core/service/session.php:361`
- Сигнатура: `function getNameSpace()`
...
- Расположение: `core/service/session.php:371`
...
- Расположение: `core/service/session.php:383`
...
- Расположение: `core/service/session.php:397`
...
- Расположение: `core/service/session.php:416`
...
- Расположение: `core/service/session.php:466`
...
- Расположение: `core/service/session.php:477`
...
- Расположение: `core/service/session.php:490`
...
- Расположение: `core/service/session.php:509`
...
- Расположение: `core/service/session.php:545`
...
- Расположение: `core/service/session.php:571`
- Сигнатура: `function _killAll()`
- Описание: Выполняет workflow-логику `kill all`.

## `core/service/session/adodb.php`

### `fan\core\service\session\adodb::__construct`

- Расположение: `core/service/session/adodb.php:32`
- Сигнатура: `function __construct($config)`
...
- Расположение: `core/service/session/inbuilt.php:32`
...
- Расположение: `core/service/session/inbuilt.php:47`
...
- Расположение: `core/service/session/inbuilt.php:60`
- Сигнатура: `function getSessionId()`
...
- Расположение: `core/service/session/inbuilt.php:72`
- Сигнатура: `function setSessionId(string $sid)`
...
- Расположение: `core/service/session/inbuilt.php:83`
- Сигнатура: `function getSessionName()`
...
- Расположение: `core/service/session/inbuilt.php:96`
...
- Расположение: `core/service/session/inbuilt.php:111`
...
- Расположение: `core/service/session/inbuilt.php:121`
- Сигнатура: `function destroy()`
...
- Расположение: `core/service/session/pear.php:26`
- Сигнатура: `function __construct($config)`
...
- Расположение: `core/service/session/pear.php:51`
- Сигнатура: `function getSessionId()`
...
- Расположение: `core/service/session/pear.php:64`
...
- Расположение: `core/service/session/pear.php:77`
- Сигнатура: `function set(string $key, string $value)`
...
- Расположение: `core/service/session/pear.php:89`
...
- Расположение: `core/service/session/pear.php:99`
...
- Расположение: `core/service/session/pear.php:109`
- Сигнатура: `function destroy()`
...
- Расположение: `core/service/soap.php:45`
...
- Расположение: `core/service/soap.php:138`
...
- Расположение: `core/service/soap.php:153`
...
- Расположение: `core/service/soap.php:166`
...
- Расположение: `core/service/soap.php:176`
- Сигнатура: `function isError()`
- Описание: Проверяет условие или валидирует данные `error` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\soap::getSoapFault`

- Расположение: `core/service/soap.php:186`
...
- Расположение: `core/service/soap.php:196`
- Сигнатура: `function getDebugInfo()`
...
- Расположение: `core/service/soap.php:224`
...
- Расположение: `core/service/soap.php:285`
...
- Расположение: `core/service/soap.php:312`
...
- Расположение: `core/service/tab.php:172`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/tab.php:185`
- Сигнатура: `function getContent()`
...
- Расположение: `core/service/tab.php:197`
...
- Расположение: `core/service/tab.php:207`
- Сигнатура: `function getAppName()`
...
- Расположение: `core/service/tab.php:217`
...
- Расположение: `core/service/tab.php:227`
...
- Расположение: `core/service/tab.php:239`
...
- Расположение: `core/service/tab.php:251`
...
- Расположение: `core/service/tab.php:264`
...
- Расположение: `core/service/tab.php:280`
...
- Расположение: `core/service/tab.php:290`
...
- Расположение: `core/service/tab.php:303`
...
- Расположение: `core/service/tab.php:346`
...
- Расположение: `core/service/tab.php:365`
...
- Расположение: `core/service/tab.php:376`
...
- Расположение: `core/service/tab.php:391`
...
- Расположение: `core/service/tab.php:413`
...
- Расположение: `core/service/tab.php:431`
...
- Расположение: `core/service/tab.php:441`
...
- Расположение: `core/service/tab.php:451`
...
- Расположение: `core/service/tab.php:461`
...
- Расположение: `core/service/tab.php:475`
...
- Расположение: `core/service/tab.php:492`
...
- Расположение: `core/service/tab.php:506`
...
- Расположение: `core/service/tab.php:515`
...
- Расположение: `core/service/tab.php:530`
...
- Расположение: `core/service/tab.php:582`
...
- Расположение: `core/service/tab.php:644`
- Сигнатура: `function _resetProperty()`
- Описание: Выполняет логику `reset property` и возвращает вычисленный результат.

### `fan\core\service\tab::_parseError`

- Расположение: `core/service/tab.php:668`
...
- Расположение: `core/service/tab.php:705`
...
- Расположение: `core/service/tab.php:741`
...
- Расположение: `core/service/tab.php:759`
...
- Расположение: `core/service/tab.php:777`
...
- Расположение: `core/service/tab.php:807`
...
- Расположение: `core/service/tab.php:897`
...
- Расположение: `core/service/tab.php:920`
...
- Расположение: `core/service/tab.php:931`
...
- Расположение: `core/service/tab.php:952`
...
- Расположение: `core/service/tab.php:975`
...
- Расположение: `core/service/tab.php:999`
...
- Расположение: `core/service/tab.php:1016`
...
- Расположение: `core/service/tab.php:1033`
...
- Расположение: `core/service/tab.php:1044`
...
- Расположение: `core/service/tab.php:1055`
...
- Расположение: `core/service/tab.php:1066`
...
- Расположение: `core/service/tab.php:1097`
...
- Расположение: `core/service/tab/delegate.php:38`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/tab/delegate.php:53`
- Сигнатура: `function getConfig(mixed $key = null, mixed $default = null)`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:29`
- Сигнатура: `function __construct()`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:40`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:56`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:145`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:225`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:271`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:291`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:305`
...
- Расположение: `core/service/tab/delegate/urlMaker.php:323`
...
- Расположение: `core/service/tab/engine.php:38`
- Сигнатура: `function setFacade(\fan\core\base\service $facade)`
...
- Расположение: `core/service/tab/engine.php:56`
...
- Расположение: `core/service/tab/subscriber.php:41`
...
- Расположение: `core/service/tab/subscriber.php:58`
...
- Расположение: `core/service/tab/subscriber.php:75`
...
- Расположение: `core/service/tab/subscriber.php:90`
...
- Расположение: `core/service/tab/subscriber.php:105`
...
- Расположение: `core/service/tab/subscriber.php:119`
...
- Расположение: `core/service/tab/subscriber.php:151`
...
- Расположение: `core/service/tab/subscriber.php:178`
...
- Расположение: `core/service/template.php:86`
...
- Расположение: `core/service/template.php:107`
...
- Расположение: `core/service/template.php:119`
...
- Расположение: `core/service/template.php:133`
...
- Расположение: `core/service/template.php:145`
...
- Расположение: `core/service/template.php:177`
...
- Расположение: `core/service/template.php:204`
...
- Расположение: `core/service/template.php:289`
...
- Расположение: `core/service/template/parser/base.php:45`
...
- Расположение: `core/service/template/parser/base.php:58`
- Сигнатура: `function __call($method, $args)`
...
- Расположение: `core/service/template/parser/base.php:76`
...
- Расположение: `core/service/template/parser/base.php:89`
...
- Расположение: `core/service/template/parser/base.php:102`
...
- Расположение: `core/service/template/parser/base.php:127`
...
- Расположение: `core/service/template/parser/base.php:166`
...
## `core/service/template/parser/form.php`

### `fan\core\service\template\parser\form::parse_form_key_field`

- Расположение: `core/service/template/parser/form.php:31`
...
- Расположение: `core/service/template/parser/form.php:41`
...
- Расположение: `core/service/template/parser/image.php:31`
...
- Расположение: `core/service/template/parser/main.php:33`
...
- Расположение: `core/service/template/parser/main.php:50`
...
- Расположение: `core/service/template/parser/main.php:62`
...
- Расположение: `core/service/template/parser/main.php:74`
...
- Расположение: `core/service/template/parser/main.php:92`
...
- Расположение: `core/service/template/parser/main.php:112`
...
- Расположение: `core/service/template/parser/main.php:124`
...
- Расположение: `core/service/template/parser/main.php:136`
...
- Расположение: `core/service/template/parser/main.php:148`
...
- Расположение: `core/service/template/type/base.php:55`
...
- Расположение: `core/service/template/type/base.php:78`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/service/template/type/base.php:90`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\service\template\type\base`.

### `fan\core\service\template\type\base::offsetSet`

- Расположение: `core/service/template/type/base.php:104`
- Сигнатура: `function offsetSet($key, mixed $value)`
- Описание: Выполняет workflow-логику `offset set`.

### `fan\core\service\template\type\base::offsetExists`

- Расположение: `core/service/template/type/base.php:124`
- Сигнатура: `function offsetExists($key)`
- Описание: Выполняет логику `offset exists` и возвращает вычисленный результат.

### `fan\core\service\template\type\base::offsetUnset`

- Расположение: `core/service/template/type/base.php:136`
- Сигнатура: `function offsetUnset($key)`
- Описание: Выполняет workflow-логику `offset unset`.

### `fan\core\service\template\type\base::offsetGet`

- Расположение: `core/service/template/type/base.php:148`
- Сигнатура: `function offsetGet($key)`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.

### `fan\core\service\template\type\base::getEngineList`

- Расположение: `core/service/template/type/base.php:163`
...
- Расположение: `core/service/template/type/base.php:173`
...
- Расположение: `core/service/template/type/base.php:186`
...
- Расположение: `core/service/template/type/base.php:200`
...
- Расположение: `core/service/template/type/base.php:214`
...
- Расположение: `core/service/template/type/base.php:227`
...
- Расположение: `core/service/template/type/base.php:237`
...
- Расположение: `core/service/template/type/base.php:249`
...
- Расположение: `core/service/template/type/base.php:258`
...
- Расположение: `core/service/template/type/base.php:271`
...
- Расположение: `core/service/template/type/base.php:283`
...
- Расположение: `core/service/template/type/base.php:295`
...
- Расположение: `core/service/template/type/base.php:307`
...
- Расположение: `core/service/template/type/base.php:320`
...
- Расположение: `core/service/template/type/base.php:335`
...
- Расположение: `core/service/template/type/base.php:356`
...
- Расположение: `core/service/template/type/base.php:369`
...
- Расположение: `core/service/template/type/base.php:381`
...
## `core/service/template/type/form.php`

### `fan\core\service\template\type\form::__construct`

- Расположение: `core/service/template/type/form.php:72`
...
- Расположение: `core/service/template/type/form.php:100`
- Сигнатура: `function getEngineList()`
...
- Расположение: `core/service/template/type/form.php:110`
- Сигнатура: `function getAutoParseTag()`
...
- Расположение: `core/service/template/type/form.php:127`
...
- Расположение: `core/service/template/type/form.php:144`
...
- Расположение: `core/service/template/type/form.php:157`
...
- Расположение: `core/service/template/type/form.php:187`
...
- Расположение: `core/service/template/type/form.php:220`
...
- Расположение: `core/service/template/type/form.php:258`
...
- Расположение: `core/service/template/type/form.php:291`
...
- Расположение: `core/service/template/type/form.php:320`
...
- Расположение: `core/service/template/type/form.php:355`
...
- Расположение: `core/service/template/type/form.php:388`
...
- Расположение: `core/service/template/type/form.php:414`
...
- Расположение: `core/service/template/type/form.php:458`
...
- Расположение: `core/service/template/type/form.php:512`
...
- Расположение: `core/service/template/type/form.php:528`
...
- Расположение: `core/service/template/type/form.php:565`
...
- Расположение: `core/service/template/type/form.php:590`
...
- Расположение: `core/service/template/type/form.php:611`
...
- Расположение: `core/service/template/type/form.php:706`
...
- Расположение: `core/service/template/type/image.php:31`
- Сигнатура: `function getEngineList()`
...
- Расположение: `core/service/template/type/image.php:41`
- Сигнатура: `function getAutoParseTag()`
...
- Расположение: `core/service/template/type/image.php:57`
...
- Расположение: `core/service/template/type/image.php:71`
...
- Расположение: `core/service/template/type/image.php:92`
...
- Расположение: `core/service/template/type/image.php:104`
...
- Расположение: `core/service/template/type/image.php:116`
...
- Расположение: `core/service/timer.php:47`
- Сигнатура: `function __construct()`
...
- Расположение: `core/service/timer.php:68`
...
- Расположение: `core/service/timer.php:120`
...
- Расположение: `core/service/timer.php:144`
...
- Расположение: `core/service/timer.php:162`
...
- Расположение: `core/service/timer.php:206`
...
- Расположение: `core/service/timer.php:225`
...
- Расположение: `core/service/timer.php:250`
...
- Расположение: `core/service/timer.php:347`
...
- Расположение: `core/service/timer.php:368`
...
- Расположение: `core/service/timer.php:380`
...
- Расположение: `core/service/translation.php:70`
- Сигнатура: `function __construct($allowIni = true)`
...
- Расположение: `core/service/translation.php:80`
- Сигнатура: `function __destruct()`
...
- Расположение: `core/service/translation.php:96`
...
- Расположение: `core/service/translation.php:113`
...
- Расположение: `core/service/translation.php:131`
...
- Расположение: `core/service/translation.php:147`
...
- Расположение: `core/service/translation.php:164`
...
- Расположение: `core/service/translation.php:229`
...
- Расположение: `core/service/translation.php:244`
...
- Расположение: `core/service/translation.php:266`
...
- Расположение: `core/service/translation.php:288`
...
- Расположение: `core/service/translation.php:317`
...
- Расположение: `core/service/translation.php:347`
...
- Расположение: `core/service/translation.php:363`
...
- Расположение: `core/service/translation.php:391`
...
- Расположение: `core/service/translation.php:421`
...
- Расположение: `core/service/translation.php:439`
...
- Расположение: `core/service/translation.php:476`
...
- Расположение: `core/service/translation.php:495`
...
- Расположение: `core/service/translation.php:524`
...
- Расположение: `core/service/translation.php:547`
...
- Расположение: `core/service/translation.php:561`
...
- Расположение: `core/service/translation.php:583`
...
- Расположение: `core/service/translation.php:599`
...
- Расположение: `core/service/translation.php:615`
...
- Расположение: `core/service/user.php:135`
...
- Расположение: `core/service/user.php:208`
...
- Расположение: `core/service/user.php:222`
...
- Расположение: `core/service/user.php:271`
...
- Расположение: `core/service/user.php:291`
...
- Расположение: `core/service/user.php:304`
...
- Расположение: `core/service/user.php:322`
...
- Расположение: `core/service/user.php:348`
...
- Расположение: `core/service/user.php:361`
...
- Расположение: `core/service/user.php:375`
...
- Расположение: `core/service/user.php:391`
...
- Расположение: `core/service/user.php:416`
...
- Расположение: `core/service/user.php:428`
...
- Расположение: `core/service/user.php:440`
...
- Расположение: `core/service/user.php:453`
- Сигнатура: `function getData()`
...
- Расположение: `core/service/user.php:463`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\service\user::getEngine`

- Расположение: `core/service/user.php:473`
- Сигнатура: `function getEngine()`
...
- Расположение: `core/service/user.php:485`
...
- Расположение: `core/service/user.php:501`
- Сигнатура: `function set(string $key, mixed $value)`
...
- Расположение: `core/service/user.php:516`
- Сигнатура: `function get(string $key)`
...
- Расположение: `core/service/user.php:529`
- Сигнатура: `function _saveInstance()`
- Описание: Выполняет логику `save instance` и возвращает вычисленный результат.

### `fan\core\service\user::_getCurrentUsers`

- Расположение: `core/service/user.php:540`
...
- Расположение: `core/service/user.php:565`
...
- Расположение: `core/service/user.php:582`
- Сигнатура: `function _getSession()`
- Описание: Выполняет логику `get session` и возвращает вычисленный результат.

### `fan\core\service\user::_getDelegate`

- Расположение: `core/service/user.php:597`
- Сигнатура: `function _getDelegate($class)`
- Описание: Выполняет логику `get delegate` и возвращает вычисленный результат.

### `fan\core\service\user::_getSpaceConfig`

- Расположение: `core/service/user.php:610`
...
- Расположение: `core/service/user.php:622`
...
- Расположение: `core/service/user.php:640`
...
- Расположение: `core/service/user.php:724`
- Сигнатура: `function unserialize($data)`
- Описание: Выполняет workflow-логику `unserialize`.
- Побочные эффекты: сериализует или десериализует данные
...
- Расположение: `core/service/user/base.php:112`
...
- Расположение: `core/service/user/base.php:127`
...
- Расположение: `core/service/user/base.php:136`
...
- Расположение: `core/service/user/base.php:151`
- Сигнатура: `function setConfig(\fan\core\service\config\row $config)`
...
- Расположение: `core/service/user/base.php:177`
...
- Расположение: `core/service/user/base.php:189`
...
- Расположение: `core/service/user/base.php:206`
- Сигнатура: `function getRoles(bool $force = false)`
...
- Расположение: `core/service/user/base.php:216`
...
- Расположение: `core/service/user/base.php:235`
...
- Расположение: `core/service/user/base.php:254`
...
- Расположение: `core/service/user/base.php:271`
...
- Расположение: `core/service/user/base.php:297`
...
- Расположение: `core/service/user/base.php:311`
- Сигнатура: `function logout()`
- Описание: Выполняет логику `logout` и возвращает вычисленный результат.

### `fan\core\service\user\base::save`

- Расположение: `core/service/user/base.php:321`
- Сигнатура: `function save()`
...
- Расположение: `core/service/user/base.php:339`
- Сигнатура: `function isValid()`
- Описание: Проверяет условие или валидирует данные `valid` и возвращает результат либо выбрасывает исключение.

### `fan\core\service\user\base::isNew`

- Расположение: `core/service/user/base.php:348`
...
- Расположение: `core/service/user/base.php:357`
...
- Расположение: `core/service/user/base.php:369`
- Сигнатура: `function _loadData();`
- Описание: Выполняет workflow-логику `load data`.

### `fan\core\service\user\base::_saveData`

- Расположение: `core/service/user/base.php:375`
- Сигнатура: `function _saveData();`
- Описание: Выполняет workflow-логику `save data`.

### `fan\core\service\user\base::_validateForSave`

- Расположение: `core/service/user/base.php:381`
...
- Расположение: `core/service/user/base.php:388`
...
- Расположение: `core/service/user/base.php:419`
...
- Расположение: `core/service/user/base.php:434`
...
- Расположение: `core/service/user/base.php:446`
...
- Расположение: `core/service/user/base.php:463`
- Сигнатура: `function __call($method, $args)`
...
- Расположение: `core/service/user/base.php:481`
- Сигнатура: `function serialize()`
- Описание: Выполняет логику `serialize` и возвращает вычисленный результат.
- Побочные эффекты: сериализует или десериализует данные
...
- Расположение: `core/service/user/base.php:501`
- Сигнатура: `function unserialize($data)`
- Описание: Выполняет workflow-логику `unserialize`.
- Побочные эффекты: сериализует или десериализует данные
...
- Расположение: `core/service/user/config.php:36`
- Сигнатура: `function makePasswordHash(string $password)`
...
- Расположение: `core/service/user/config.php:49`
- Сигнатура: `function _loadData()`
- Описание: Выполняет логику `load data` и возвращает вычисленный результат.
- Побочные эффекты: может выбрасывать исключения
...
- Расположение: `core/service/user/config.php:88`
...
- Расположение: `core/service/user/config.php:112`
...
- Расположение: `core/service/user/config.php:141`
- Сигнатура: `function _saveData()`
- Описание: Выполняет логику `save data` и возвращает вычисленный результат.

### `fan\core\service\user\config::_validateForSave`

- Расположение: `core/service/user/config.php:151`
- Сигнатура: `function _validateForSave()`
...
- Расположение: `core/service/user/config.php:161`
...
- Расположение: `core/service/user/config.php:182`
...
- Расположение: `core/service/user/config.php:202`
...
- Расположение: `core/service/user/entity.php:43`
- Сигнатура: `function makePasswordHash(string $password)`
...
- Расположение: `core/service/user/entity.php:56`
- Сигнатура: `function _loadData()`
- Описание: Выполняет логику `load data` и возвращает вычисленный результат.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/service/user/entity.php:76`
- Сигнатура: `function _saveData()`
- Описание: Выполняет логику `save data` и возвращает вычисленный результат.

### `fan\core\service\user\entity::_validateForSave`

- Расположение: `core/service/user/entity.php:100`
- Сигнатура: `function _validateForSave()`
- Описание: Выполняет логику `validate for save` и возвращает вычисленный результат.

### `fan\core\service\user\entity::_getEntityData`

- Расположение: `core/service/user/entity.php:111`
...
- Расположение: `core/service/user/entity.php:146`
...
- Расположение: `core/service/user/entity.php:181`
- Сигнатура: `function _getRow()`
- Описание: Выполняет логику `get row` и возвращает вычисленный результат.
- Побочные эффекты: использует service locator/helpers фреймворка
...
- Расположение: `core/view/definer.php:60`
...
- Расположение: `core/view/definer.php:76`
- Сигнатура: `function getViewParserName()`
...
- Расположение: `core/view/definer.php:96`
...
- Расположение: `core/view/definer.php:168`
...
- Расположение: `core/view/definer.php:199`
...
- Расположение: `core/view/definer.php:213`
...
- Расположение: `core/view/definer.php:227`
...
- Расположение: `core/view/definer.php:255`
...
- Расположение: `core/view/definer.php:269`
...
- Расположение: `core/view/keeper.php:31`
...
- Расположение: `core/view/keeper.php:50`
...
- Расположение: `core/view/keeper.php:65`
- Сигнатура: `function set($key, $value, $rewriteExisting = true, $convArray = null)`
...
- Расположение: `core/view/keeper.php:80`
...
- Расположение: `core/view/keeper.php:93`
...
- Расположение: `core/view/keeper.php:103`
- Сигнатура: `function getBlock()`
...
- Расположение: `core/view/keeper/loader/json.php:26`
- Сигнатура: `function __construct(\fan\core\view\router $router)`
...
- Расположение: `core/view/keeper/loader/json.php:42`
...
- Расположение: `core/view/keeper/loader/text.php:26`
- Сигнатура: `function __construct(\fan\core\view\router $router)`
...
- Расположение: `core/view/keeper/loader/text.php:45`
- Сигнатура: `function get($key = null, $default = null, $logError = true)`
...
- Расположение: `core/view/keeper/loader/text.php:61`
- Сигнатура: `function set($key, $value, $rewriteExisting = true, $convArray = null)`
...
- Расположение: `core/view/keeper/loader/text.php:84`
- Сигнатура: `function addRouter(\fan\core\view\router\loader $router)`
...
- Расположение: `core/view/keeper/loader/text.php:103`
- Сигнатура: `function __set($key, $value)`
...
- Расположение: `core/view/keeper/loader/text.php:115`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\view\keeper\loader\text`.

### `fan\core\view\keeper\loader\text::__toString`

- Расположение: `core/view/keeper/loader/text.php:125`
- Сигнатура: `function __toString()`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\view\keeper\loader\text`.
...
- Расположение: `core/view/parser.php:43`
...
- Расположение: `core/view/parser.php:54`
...
- Расположение: `core/view/parser.php:65`
...
- Расположение: `core/view/parser.php:79`
...
- Расположение: `core/view/parser.php:91`
...
- Расположение: `core/view/parser.php:105`
...
- Расположение: `core/view/parser.php:118`
...
- Расположение: `core/view/parser.php:140`
...
- Расположение: `core/view/parser.php:157`
...
- Расположение: `core/view/parser.php:195`
...
- Расположение: `core/view/parser.php:209`
...
- Расположение: `core/view/parser/debug1.php:31`
- Сигнатура: `function __construct(\fan\core\block\base $mainBlock)`
...
- Расположение: `core/view/parser/debug1.php:48`
...
- Расположение: `core/view/parser/debug1.php:76`
...
- Расположение: `core/view/parser/debug2.php:31`
- Сигнатура: `function __construct(\fan\core\block\base $mainBlock)`
...
- Расположение: `core/view/parser/debug2.php:45`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/debug2.php:59`
- Сигнатура: `function getResultData(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/html.php:27`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/html.php:38`
- Сигнатура: `function getRouter(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/html.php:52`
- Сигнатура: `function getResultData(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/html.php:74`
- Сигнатура: `function _setHeaders($result, $contentType = 'text/html', $encoding = null)`
- Описание: Выполняет логику `set headers` и возвращает вычисленный результат.
...
- Расположение: `core/view/parser/json.php:28`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/json.php:38`
- Сигнатура: `function getRouter(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/json.php:48`
- Сигнатура: `function getFinalContent()`
...
- Расположение: `core/view/parser/loader.php:27`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/loader.php:38`
- Сигнатура: `function getRouter(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/loader.php:50`
- Сигнатура: `function getFinalContent()`
...
- Расположение: `core/view/parser/loader.php:74`
- Сигнатура: `function getResultData(\fan\core\block\base $block)`
...
- Расположение: `core/view/parser/loader.php:93`
...
- Расположение: `core/view/parser/soap.php:27`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/xml.php:27`
- Сигнатура: `function getFormat()`
...
- Расположение: `core/view/parser/xml.php:39`
- Сигнатура: `function getFinalContent()`
...
- Расположение: `core/view/parser/xml.php:59`
...
- Расположение: `core/view/router.php:42`
- Сигнатура: `function __construct(\fan\core\block\base $block)`
...
- Расположение: `core/view/router.php:66`
- Сигнатура: `function __set($key, $value)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\view\router`.

### `fan\core\view\router::__get`

- Расположение: `core/view/router.php:78`
- Сигнатура: `function __get($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\view\router`.

### `fan\core\view\router::__isset`

- Расположение: `core/view/router.php:90`
- Сигнатура: `function __isset($key)`
- Описание: Реализует магическое поведение PHP для этого метода класса `fan\core\view\router`.

### `fan\core\view\router::offsetSet`

- Расположение: `core/view/router.php:105`
- Сигнатура: `function offsetSet($key, mixed $value)`
- Описание: Выполняет workflow-логику `offset set`.

### `fan\core\view\router::offsetGet`

- Расположение: `core/view/router.php:117`
- Сигнатура: `function offsetGet($key)`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.

### `fan\core\view\router::offsetExists`

- Расположение: `core/view/router.php:129`
- Сигнатура: `function offsetExists($key)`
- Описание: Выполняет логику `offset exists` и возвращает вычисленный результат.

### `fan\core\view\router::offsetUnset`

- Расположение: `core/view/router.php:141`
- Сигнатура: `function offsetUnset($key)`
- Описание: Выполняет workflow-логику `offset unset`.

### `fan\core\view\router::set`

- Расположение: `core/view/router.php:153`
...
- Расположение: `core/view/router.php:180`
...
- Расположение: `core/view/router.php:200`
...
- Расположение: `core/view/router.php:213`
- Сигнатура: `function getBlock()`
...
- Расположение: `core/view/router.php:223`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\core\view\router::getAll`

- Расположение: `core/view/router.php:233`
- Сигнатура: `function getAll()`
...
- Расположение: `core/view/router.php:250`
- Сигнатура: `function count()`
- Описание: Выполняет логику `count` и возвращает вычисленный результат.

### `fan\core\view\router::_getKeeper`

- Расположение: `core/view/router.php:265`
...
- Расположение: `core/view/router.php:282`
- Сигнатура: `function _checkSetter()`
- Описание: Выполняет логику `check setter` и возвращает вычисленный результат.
...
- Расположение: `core/view/router/json.php:35`
...
- Расположение: `core/view/router/json.php:45`
...
- Расположение: `core/view/router/loader.php:59`
- Сигнатура: `function set($key, $value)`
...
- Расположение: `core/view/router/loader.php:78`
...
- Расположение: `core/view/router/loader.php:92`
...
- Расположение: `core/view/router/loader.php:102`
- Сигнатура: `function getText()`
...
- Расположение: `core/view/router/loader.php:115`
...
## `project/app/__log_viewer/design/header.php`

### `fan\app\__log_viewer\design\header::init`

- Расположение: `project/app/__log_viewer/design/header.php:26`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__log_viewer/design/header.php:71`
...
## `project/app/__log_viewer/design/nav.php`

### `fan\app\__log_viewer\design\nav::getNavUrl`

- Расположение: `project/app/__log_viewer/design/nav.php:29`
...
- Расположение: `project/app/__log_viewer/design/nav.php:39`
...
- Расположение: `project/app/__tools/design/nav/application_subnav.php:48`
...
## `project/app/__tools/design/nav/counter_subnav.php`

### `fan\app\__tools\design\counter_subnav::init`

- Расположение: `project/app/__tools/design/nav/counter_subnav.php:19`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/design/nav/counter_subnav.php:38`
- Сигнатура: `function getNavUrl(string $key, string $addUrl = '')`
- Описание: Получает, читает или вычисляет данные `nav url` в рамках этого метода класса `fan\app\__tools\design\counter_subnav`.

## `project/app/__tools/design/nav/db_connection_subnav.php`

### `fan\app\__tools\design\db_connection_subnav::init`

- Расположение: `project/app/__tools/design/nav/db_connection_subnav.php:25`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/design/nav/db_connection_subnav.php:48`
- Сигнатура: `function getCurrentName()`
...
## `project/app/__tools/form/entity_filter.php`

### `fan\app\__tools\form\entity_filter::init`

- Расположение: `project/app/__tools/form/entity_filter.php:26`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/form/entity_filter.php:36`
...
- Расположение: `project/app/__tools/form/entity_filter.php:54`
...
## `project/app/__tools/main/conv_entity.php`

### `fan\app\__tools\main\conv_entity::init`

- Расположение: `project/app/__tools/main/conv_entity.php:38`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/main/conv_entity.php:48`
- Сигнатура: `function onSubmit()`
- Описание: Выполняет workflow-логику `on submit`.
- Побочные эффекты: работает с файловой системой; может выбрасывать исключения
...
- Расположение: `project/app/__tools/main/conv_entity.php:107`
...
- Расположение: `project/app/__tools/main/conv_entity.php:142`
...
- Расположение: `project/app/__tools/main/conv_entity.php:158`
...
- Расположение: `project/app/__tools/main/conv_entity.php:205`
...
- Расположение: `project/app/__tools/main/conv_entity.php:263`
...
- Расположение: `project/app/__tools/main/conv_entity.php:294`
...
- Расположение: `project/app/__tools/main/conv_entity.php:341`
...
- Расположение: `project/app/__tools/main/conv_entity.php:357`
- Сигнатура: `function _removeUsed(&$content, $texts)`
- Описание: Выполняет логику `remove used` и возвращает вычисленный результат.

## `project/app/__tools/main/create_entity.php`

### `fan\app\__tools\main\create_entity::init`

- Расположение: `project/app/__tools/main/create_entity.php:28`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/main/create_entity.php:86`
- Сигнатура: `function onSubmit()`
- Описание: Выполняет workflow-логику `on submit`.
- Побочные эффекты: работает с файловой системой; использует service locator/helpers фреймворка
...
- Расположение: `project/app/__tools/main/create_entity.php:159`
...
- Расположение: `project/app/__tools/main/create_entity.php:185`
...
- Расположение: `project/app/__tools/main/create_entity.php:216`
...
## `project/app/__tools/main/db_up/db_up.php`

### `fan\app\__tools\main\db_up::init`

- Расположение: `project/app/__tools/main/db_up/db_up.php:15`
- Сигнатура: `function init()`
- Описание: Запускает или обрабатывает workflow `инициализацию` для этого метода класса `fan\app\__tools\main\db_up`.

## `project/app/__tools/main/db_up/scenario.php`

### `fan\app\__tools\main\scenario::__construct`

- Расположение: `project/app/__tools/main/db_up/scenario.php:53`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:72`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:81`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:90`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:107`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:139`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:150`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:166`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:176`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:193`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:208`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:249`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:263`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:274`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:288`
...
- Расположение: `project/app/__tools/main/db_up/scenario.php:307`
...
## `project/app/__tools/main/db_up/scenario_processing.php`

### `fan\app\__tools\main\scenario_processing::init`

- Расположение: `project/app/__tools/main/db_up/scenario_processing.php:20`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/main/request_password.php:45`
- Сигнатура: `function checkPassword(mixed $value, array $data)`
- Описание: Проверяет условие или валидирует данные `password` и возвращает результат либо выбрасывает исключение.

### `fan\app\__tools\main\request_password::onSubmit`

- Расположение: `project/app/__tools/main/request_password.php:56`
- Сигнатура: `function onSubmit()`
- Описание: Выполняет workflow-логику `on submit`.

## `project/app/__tools/main/upgrade_blocks.php`

### `fan\app\__tools\main\upgrade_blocks::init`

- Расположение: `project/app/__tools/main/upgrade_blocks.php:96`
- Сигнатура: `function init()`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:144`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:181`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:213`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:244`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:327`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:359`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:400`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:415`
- Сигнатура: `function _getContent($type)`
- Описание: Выполняет логику `get content` и возвращает вычисленный результат.

### `fan\app\__tools\main\upgrade_blocks::_makeFileList`

- Расположение: `project/app/__tools/main/upgrade_blocks.php:432`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:465`
...
- Расположение: `project/app/__tools/main/upgrade_blocks.php:487`
...
- Расположение: `project/block/carcass/common.php:52`
...
## `project/block/common/html_pager_quantifier.php`

### `fan\project\block\common\html_pager_quantifier::init`

- Расположение: `project/block/common/html_pager_quantifier.php:26`
- Сигнатура: `function init()`
...
- Расположение: `project/block/common/html_pager_quantifier.php:45`
...
- Расположение: `project/block/common/html_pager_quantifier.php:60`
- Сигнатура: `function onSubmit()`
- Описание: Выполняет workflow-логику `on submit`.

### `fan\project\block\common\html_pager_quantifier::getPagerSession`

- Расположение: `project/block/common/html_pager_quantifier.php:78`
...
- Расположение: `project/block/common/html_pager_quantifier.php:96`
...
## `unit/core/CoreSourceInventoryTest.php`

### `CoreSourceInventoryTest::getDiscoveredSourceFiles`

- Расположение: `unit/core/CoreSourceInventoryTest.php:9`
...
- Расположение: `unit/core/CoreSourceInventoryTest.php:243`
...
- Расположение: `unit/core/CoreSourceInventoryTest.php:455`
...
- Расположение: `unit/core/CoreSourceInventoryTest.php:488`
...
- Расположение: `unit/core/CoreSourceInventoryTest.php:502`
...
- Расположение: `unit/core/CoreSourceInventoryTest.php:516`
...
## `unit/core/FunctionsServiceContainerTest.php`

### `FunctionsServiceContainerTest::setUp`

- Расположение: `unit/core/FunctionsServiceContainerTest.php:17`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:27`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:37`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:51`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:67`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:88`
...
- Расположение: `unit/core/FunctionsServiceContainerTest.php:98`
...
## `unit/core/base/DataTest.php`

### `DataTest::setUp`

- Расположение: `unit/core/base/DataTest.php:16`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/base/DataTest.php:26`
...
- Расположение: `unit/core/base/DataTest.php:54`
...
- Расположение: `unit/core/base/DataTest.php:75`
...
- Расположение: `unit/core/base/DataTest.php:103`
...
- Расположение: `unit/core/base/DataTest.php:124`
...
- Расположение: `unit/core/base/DataTest.php:142`
...
## `unit/core/base/ExpressionEvaluatorTest.php`

### `ExpressionEvaluatorTest::testEvaluatesBooleanExpressionsWithResolvedIdentifiers`

- Расположение: `unit/core/base/ExpressionEvaluatorTest.php:13`
...
- Расположение: `unit/core/base/ExpressionEvaluatorTest.php:34`
...
- Расположение: `unit/core/base/ExpressionEvaluatorTest.php:52`
...
- Расположение: `unit/core/base/ExpressionEvaluatorTest.php:63`
- Сигнатура: `function testRejectsInvalidExpression()`
- Описание: Выполняет workflow-логику `test rejects invalid expression`.

## `unit/core/base/TransferTest.php`

### `TransferTest::setUp`

- Расположение: `unit/core/base/TransferTest.php:15`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/base/TransferTest.php:25`
...
- Расположение: `unit/core/base/TransferTest.php:43`
...
- Расположение: `unit/core/base/TransferTest.php:55`
...
- Расположение: `unit/core/base/TransferTest.php:68`
...
## `unit/core/base/meta/DelayedTest.php`

### `DelayedTest::testCallsObjectMethodWithArrayArguments`

- Расположение: `unit/core/base/meta/DelayedTest.php:12`
...
- Расположение: `unit/core/base/meta/DelayedTest.php:23`
...
- Расположение: `unit/core/base/meta/DelayedTest.php:39`
...
- Расположение: `unit/core/base/meta/DelayedTest.php:49`
...
- Расположение: `unit/core/base/meta/DelayedTest.php:65`
...
- Расположение: `unit/core/base/meta/DelayedTest.php:73`
- Сигнатура: `function value()`
- Описание: Выполняет логику `value` и возвращает вычисленный результат.

## `unit/core/base/meta/MakerTest.php`

### `MetaMakerTest::tearDown`

- Расположение: `unit/core/base/meta/MakerTest.php:18`
- Сигнатура: `function tearDown(): void`
- Описание: Выполняет workflow-логику `tear down`.

### `MetaMakerTest::handleError`

- Расположение: `unit/core/base/meta/MakerTest.php:35`
...
- Расположение: `unit/core/base/meta/MakerTest.php:91`
...
- Расположение: `unit/core/base/meta/MakerTest.php:114`
...
- Расположение: `unit/core/base/meta/MakerTest.php:147`
...
- Расположение: `unit/core/base/meta/MakerTest.php:170`
...
- Расположение: `unit/core/base/meta/MakerTest.php:189`
...
- Расположение: `unit/core/base/meta/MakerTest.php:205`
...
## `unit/core/base/meta/RowTest.php`

### `MetaRowTest::setUp`

- Расположение: `unit/core/base/meta/RowTest.php:14`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/base/meta/RowTest.php:24`
...
- Расположение: `unit/core/base/meta/RowTest.php:53`
...
- Расположение: `unit/core/base/meta/RowTest.php:80`
...
## `unit/core/base/transfer/IntTest.php`

### `IntTest::testCompatibilityLoaderDefinesTransferIntClass`

- Расположение: `unit/core/base/transfer/IntTest.php:14`
...
## `unit/core/base/transfer/OutTest.php`

### `OutTest::setUp`

- Расположение: `unit/core/base/transfer/OutTest.php:14`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/base/transfer/OutTest.php:24`
...
- Расположение: `unit/core/base/transfer/OutTest.php:39`
...
## `unit/core/base/transfer/ShamTest.php`

### `ShamTest::testCreatesShamTransferWithoutCurrentShift`

- Расположение: `unit/core/base/transfer/ShamTest.php:14`
...
- Расположение: `unit/core/block/BaseTest.php:74`
- Сигнатура: `function captureErrors()`
- Описание: Выполняет workflow-логику `capture errors`.

### `BaseTest::fixturePath`

- Расположение: `unit/core/block/BaseTest.php:91`
...
- Расположение: `unit/core/block/BaseTest.php:104`
...
- Расположение: `unit/core/block/BaseTest.php:116`
...
- Расположение: `unit/core/block/BaseTest.php:140`
...
- Расположение: `unit/core/block/BaseTest.php:155`
...
- Расположение: `unit/core/block/BaseTest.php:180`
...
- Расположение: `unit/core/block/BaseTest.php:204`
...
- Расположение: `unit/core/block/BaseTest.php:237`
...
- Расположение: `unit/core/block/BaseTest.php:248`
- Сигнатура: `function value($value)`
- Описание: Выполняет логику `value` и возвращает вычисленный результат.

### `BaseTest::testForcedDynamicMetaCanBeEnabledByMetaFlag`

- Расположение: `unit/core/block/BaseTest.php:286`
...
- Расположение: `unit/core/block/BaseTest.php:300`
...
- Расположение: `unit/core/block/BaseTest.php:324`
...
- Расположение: `unit/core/block/BaseTest.php:346`
...
- Расположение: `unit/core/block/BaseTest.php:374`
...
- Расположение: `unit/core/block/BaseTest.php:393`
...
- Расположение: `unit/core/block/BaseTest.php:433`
...
- Расположение: `unit/core/block/BaseTest.php:458`
...
- Расположение: `unit/core/block/BaseTest.php:488`
...
- Расположение: `unit/core/block/BaseTest.php:508`
...
- Расположение: `unit/core/block/BaseTest.php:526`
...
- Расположение: `unit/core/block/BaseTest.php:571`
...
- Расположение: `unit/core/block/BaseTest.php:602`
...
## `unit/core/block/MetaFilesTest.php`

### `role`

- Расположение: `unit/core/block/MetaFilesTest.php:13`
...
- Расположение: `unit/core/block/MetaFilesTest.php:26`
...
- Расположение: `unit/core/block/MetaFilesTest.php:53`
...
- Расположение: `unit/core/block/MetaFilesTest.php:68`
...
- Расположение: `unit/core/block/MetaFilesTest.php:84`
...
- Расположение: `unit/core/block/MetaFilesTest.php:98`
...
- Расположение: `unit/core/block/MetaFilesTest.php:114`
...
## `unit/core/di/ContainerTest.php`

### `ContainerTest::testFactoryReceivesContainerAndRuntimeArguments`

- Расположение: `unit/core/di/ContainerTest.php:13`
...
- Расположение: `unit/core/di/ContainerTest.php:36`
...
- Расположение: `unit/core/di/ContainerTest.php:49`
...
- Расположение: `unit/core/di/ContainerTest.php:65`
...
- Расположение: `unit/core/di/ContainerTest.php:82`
...
## `unit/core/error/TemplateFilesTest.php`

### `TemplateFilesTest::testDefaultTemplateRendersTextResponseFromTplVars`

- Расположение: `unit/core/error/TemplateFilesTest.php:10`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:25`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:41`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:56`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:75`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:86`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:98`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:110`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:120`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:130`
...
- Расположение: `unit/core/error/TemplateFilesTest.php:143`
- Сигнатура: `function convArrayToSting(array $data, string $separator = "\n"): string`
- Описание: Выполняет логику `conv array to sting` и возвращает вычисленный результат.

## `unit/core/exception/BaseTest.php`

### `ExceptionBaseTest::tearDown`

- Расположение: `unit/core/exception/BaseTest.php:17`
- Сигнатура: `function tearDown(): void`
- Описание: Выполняет workflow-логику `tear down`.

### `ExceptionBaseTest::handleError`

- Расположение: `unit/core/exception/BaseTest.php:35`
- Сигнатура: `function handleError($type, $message, $fileName = null, $lineNum = null, $errContext = null)`
...
- Расположение: `unit/core/exception/BaseTest.php:46`
- Сигнатура: `function captureErrors()`
- Описание: Выполняет workflow-логику `capture errors`.

### `ExceptionBaseTest::testConstructorSetsDefaultPublicMessageFileAndLogMessage`

- Расположение: `unit/core/exception/BaseTest.php:58`
...
- Расположение: `unit/core/exception/BaseTest.php:77`
...
- Расположение: `unit/core/exception/BaseTest.php:90`
...
- Расположение: `unit/core/exception/BaseTest.php:105`
...
## `unit/core/exception/Error500Test.php`

### `ExceptionError500Test::setUp`

- Расположение: `unit/core/exception/Error500Test.php:20`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/Error500Test.php:35`
...
## `unit/core/exception/FatalTest.php`

### `ExceptionFatalTest::setUp`

- Расположение: `unit/core/exception/FatalTest.php:14`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/FatalTest.php:24`
...
## `unit/core/exception/block/FatalTest.php`

### `ExceptionBlockFatalTest::setUp`

- Расположение: `unit/core/exception/block/FatalTest.php:26`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/block/FatalTest.php:42`
...
## `unit/core/exception/block/FormPartTest.php`

### `ExceptionBlockFormPartTest::setUp`

- Расположение: `unit/core/exception/block/FormPartTest.php:22`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/block/FormPartTest.php:33`
...
## `unit/core/exception/block/LocalTest.php`

### `ExceptionBlockLocalTest::setUp`

- Расположение: `unit/core/exception/block/LocalTest.php:21`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/block/LocalTest.php:32`
...
## `unit/core/exception/model/ReverseTest.php`

### `ExceptionModelReverseTest::setUp`

- Расположение: `unit/core/exception/model/ReverseTest.php:16`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/model/ReverseTest.php:26`
...
## `unit/core/exception/model/entity/FatalTest.php`

### `ExceptionModelEntityFatalTest::setUp`

- Расположение: `unit/core/exception/model/entity/FatalTest.php:21`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/model/entity/FatalTest.php:36`
...
## `unit/core/exception/plain/FatalTest.php`

### `ExceptionPlainFatalTest::setUp`

- Расположение: `unit/core/exception/plain/FatalTest.php:20`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/plain/FatalTest.php:35`
...
## `unit/core/exception/service/DatabaseTest.php`

### `ExceptionServiceDatabaseTest::setUp`

- Расположение: `unit/core/exception/service/DatabaseTest.php:22`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/service/DatabaseTest.php:40`
...
- Расположение: `unit/core/exception/service/DatabaseTest.php:68`
...
- Расположение: `unit/core/exception/service/DatabaseTest.php:84`
...
## `unit/core/exception/service/DateTest.php`

### `ExceptionServiceDateTest::setUp`

- Расположение: `unit/core/exception/service/DateTest.php:14`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/service/DateTest.php:24`
...
## `unit/core/exception/service/FatalTest.php`

### `ExceptionServiceFatalTest::setUp`

- Расположение: `unit/core/exception/service/FatalTest.php:21`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/service/FatalTest.php:37`
...
- Расположение: `unit/core/exception/service/FatalTest.php:59`
...
## `unit/core/exception/template/FatalTest.php`

### `ExceptionTemplateFatalTest::setUp`

- Расположение: `unit/core/exception/template/FatalTest.php:20`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/exception/template/FatalTest.php:35`
...
## `unit/core/service/RoleTest.php`

### `RoleTest::setUp`

- Расположение: `unit/core/service/RoleTest.php:15`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/service/RoleTest.php:25`
...
- Расположение: `unit/core/service/RoleTest.php:41`
...
- Расположение: `unit/core/service/RoleTest.php:57`
...
## `unit/core/service/config/ArrTest.php`

### `ServiceConfigArrTest::testPhpExtensionIsAppliedWhenResolvingConfigFile`

- Расположение: `unit/core/service/config/ArrTest.php:13`
...
## `unit/core/service/config/BaseTest.php`

### `ServiceConfigBaseTest::setUp`

- Расположение: `unit/core/service/config/BaseTest.php:14`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/service/config/BaseTest.php:25`
- Сигнатура: `function tearDown(): void`
- Описание: Выполняет workflow-логику `tear down`.
- Побочные эффекты: работает с файловой системой
...
- Расположение: `unit/core/service/config/BaseTest.php:40`
...
- Расположение: `unit/core/service/config/BaseTest.php:57`
...
## `unit/core/service/config/IniTest.php`

### `ServiceConfigIniTest::setUp`

- Расположение: `unit/core/service/config/IniTest.php:15`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/service/config/IniTest.php:25`
- Сигнатура: `function tearDown(): void`
- Описание: Выполняет workflow-логику `tear down`.
- Побочные эффекты: работает с файловой системой
...
- Расположение: `unit/core/service/config/IniTest.php:37`
...
- Расположение: `unit/core/service/config/IniTest.php:68`
...
## `unit/core/service/config/RowTest.php`

### `ServiceConfigRowTest::setUp`

- Расположение: `unit/core/service/config/RowTest.php:17`
- Сигнатура: `function setUp(): void`
...
- Расположение: `unit/core/service/config/RowTest.php:27`
...
- Расположение: `unit/core/service/config/RowTest.php:57`
...
- Расположение: `unit/core/service/config/RowTest.php:96`
...
## `unit/core/service/config/XmlTest.php`

### `ServiceConfigXmlTest::testXmlExtensionIsAppliedWhenResolvingConfigFile`

- Расположение: `unit/core/service/config/XmlTest.php:13`
...
## `unit/core/service/config/YamlTest.php`

### `ServiceConfigYamlTest::testYamlExtensionIsAppliedWhenResolvingConfigFile`

- Расположение: `unit/core/service/config/YamlTest.php:13`
...
## `unit/core/service/entity/SnippetTest.php`

### `SnippetTest::testSnippetConditionFiltersQueryAndPreparesData`

- Расположение: `unit/core/service/entity/SnippetTest.php:12`
...
- Расположение: `unit/core/service/entity/SnippetTest.php:35`
...
- Расположение: `unit/core/service/entity/SnippetTest.php:51`
...
- Расположение: `unit/core/service/entity/SnippetTest.php:66`
...
## `unit/core/service/header/CodeTest.php`

### `ServiceHeaderCodeTest::testCodeGroupsExposeExpectedStatusTexts`

- Расположение: `unit/core/service/header/CodeTest.php:12`
...
- Расположение: `unit/core/service/header/CodeTest.php:26`
...
## `unit/core/view/DefinerTest.php`

### `DefinerTest::testGetViewParserNameEvaluatesConfiguredRulesWithoutEval`

- Расположение: `unit/core/view/DefinerTest.php:12`
...
- Расположение: `unit/core/view/DefinerTest.php:46`
...
- Расположение: `unit/core/view/DefinerTest.php:81`
...
- Расположение: `unit/core/view/DefinerTest.php:94`
...
- Расположение: `unit/core/view/DefinerTest.php:107`
...
## `unit/mock/core/SourceFileContractTestCase.php`

### `FanTest\core\SourceFileContractTestCase::testSourceFileExists`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:14`
- Сигнатура: `function testSourceFileExists(): void`
- Описание: Выполняет workflow-логику `test source file exists`.

### `FanTest\core\SourceFileContractTestCase::testSourceFileIsValidPhpCode`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:24`
...
### `FanTest\core\SourceFileContractTestCase::testSourceFileDeclaresContract`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:37`
...
### `FanTest\core\SourceFileContractTestCase::testTestCaseIsNoLongerPending`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:59`
...
### `FanTest\core\SourceFileContractTestCase::sourcePath`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:72`
- Сигнатура: `function sourcePath(): string`
- Описание: Выполняет логику `source path` и возвращает вычисленный результат.

### `FanTest\core\SourceFileContractTestCase::sourceCode`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:85`
- Сигнатура: `function sourceCode(): string`
- Описание: Выполняет логику `source code` и возвращает вычисленный результат.

### `FanTest\core\SourceFileContractTestCase::readDeclarations`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:98`
- Сигнатура: `function readDeclarations(): array`
- Описание: Получает, читает или вычисляет данные `declarations` в рамках этого метода класса `FanTest\core\SourceFileContractTestCase`.

### `FanTest\core\SourceFileContractTestCase::readNamespace`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:146`
- Сигнатура: `function readNamespace(array $tokens, int $offset): string`
- Описание: Получает, читает или вычисляет данные `namespace` в рамках этого метода класса `FanTest\core\SourceFileContractTestCase`.

### `FanTest\core\SourceFileContractTestCase::readNamedDeclaration`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:169`
- Сигнатура: `function readNamedDeclaration(array $tokens, int $offset): ?string`
- Описание: Получает, читает или вычисляет данные `named declaration` в рамках этого метода класса `FanTest\core\SourceFileContractTestCase`.

### `FanTest\core\SourceFileContractTestCase::isAnonymousClass`

- Расположение: `unit/mock/core/SourceFileContractTestCase.php:189`
- Сигнатура: `function isAnonymousClass(array $tokens, int $classIndex): bool`
- Описание: Проверяет условие или валидирует данные `anonymous class` и возвращает результат либо выбрасывает исключение.

## `unit/mock/core/base/DataFunctions.php`

### `get_class_alt`

- Расположение: `unit/mock/core/base/DataFunctions.php:11`
...
- Расположение: `unit/mock/core/base/DataFunctions.php:27`
...
- Расположение: `unit/mock/core/base/DataFunctions.php:62`
- Сигнатура: `function is_array_alt(mixed $arr)`
- Описание: Evaluates array alt and reports the outcome.
- Параметры: mixed $arr Input value for the arr argument.
- Возвращает: mixed Indicates whether the requested condition is satisfied.
...
- Расположение: `unit/mock/core/base/DataFunctions.php:76`
- Сигнатура: `function array_merge_recursive_alt(mixed $arrFirst)`
- Описание: Runs the array merge recursive alt operation and returns its result.
- Параметры: mixed $arrFirst Input value for the arr first argument.
- Возвращает: mixed Returns the value produced by the operation.
...
- Расположение: `unit/mock/core/base/DataFunctions.php:104`
- Сигнатура: `function adduceToArray(mixed $src)`
- Описание: Applies uce to array to the framework helper.
- Параметры: mixed $src Input value for the src argument.
- Возвращает: mixed Returns the value produced by the operation.
...
- Расположение: `unit/mock/core/base/DataFunctions.php:132`
- Сигнатура: `function instance()`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\project\service\error::reset`

- Расположение: `unit/mock/core/base/DataFunctions.php:145`
- Сигнатура: `function reset()`
...
- Расположение: `unit/mock/core/base/DataFunctions.php:190`
- Сигнатура: `function logDatabaseError($connectionName, string $operation, $errorMessage, int|float $errorNum, $parsedSql)`
- Описание: Выполняет workflow-логику `log database error`.

## `unit/mock/core/base/TestData.php`

### `FanTest\core\base\TestData::allowSetter`

- Расположение: `unit/mock/core/base/TestData.php:13`
- Сигнатура: `function allowSetter(mixed $setter)`
- Описание: Выполняет логику `allow setter` и возвращает вычисленный результат.

### `FanTest\core\base\TestData::setMultiLevel`

- Расположение: `unit/mock/core/base/TestData.php:25`
- Сигнатура: `function setMultiLevel($multiLevel)`
- Описание: Устанавливает, добавляет или сохраняет данные `multi level` в рамках этого метода класса `FanTest\core\base\TestData`.

### `FanTest\core\base\TestData::exposeSubData`

- Расположение: `unit/mock/core/base/TestData.php:35`
- Сигнатура: `function exposeSubData()`
- Описание: Выполняет логику `expose sub data` и возвращает вычисленный результат.

### `FanTest\core\base\TestDataSetter::setValue`

- Расположение: `unit/mock/core/base/TestData.php:52`
- Сигнатура: `function setValue(TestData $data, $key, mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `value` в рамках этого метода класса `FanTest\core\base\TestDataSetter`.

### `FanTest\core\base\TestDataSetter::unsetValue`

- Расположение: `unit/mock/core/base/TestData.php:65`
- Сигнатура: `function unsetValue(TestData $data, $key)`
- Описание: Выполняет workflow-логику `unset value`.

## `unit/mock/core/base/TransferStubs.php`

### `fan\project\service\database::reset`

- Расположение: `unit/mock/core/base/TransferStubs.php:13`
- Сигнатура: `function reset(): void`
...
- Расположение: `unit/mock/core/base/TransferStubs.php:26`
- Сигнатура: `function fixAll($dbOper, $makeException = true): void`
- Описание: Выполняет workflow-логику `fix all`.

## `unit/mock/core/base/meta/MetaDoubles.php`

### `FanTest\core\base\meta\TestMetaTab::getBlocksMetaByMain`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:37`
- Сигнатура: `function getBlocksMetaByMain($blockName)`
- Описание: Получает, читает или вычисляет данные `blocks meta by main` в рамках этого метода класса `FanTest\core\base\meta\TestMetaTab`.

### `FanTest\core\base\meta\TestMetaBlock::__construct`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:54`
- Сигнатура: `function __construct(string $blockName = 'content')`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\base\meta\TestMetaBlock`.

### `FanTest\core\base\meta\TestMetaBlock::getBlockName`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:65`
- Сигнатура: `function getBlockName()`
- Описание: Получает, читает или вычисляет данные `block name` в рамках этого метода класса `FanTest\core\base\meta\TestMetaBlock`.

### `FanTest\core\base\meta\TestMetaBlock::getTab`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:75`
- Сигнатура: `function getTab()`
- Описание: Получает, читает или вычисляет данные `tab` в рамках этого метода класса `FanTest\core\base\meta\TestMetaBlock`.

### `FanTest\core\base\meta\TestMetaBlock::buildValue`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:88`
- Сигнатура: `function buildValue($left, $right = null)`
- Описание: Создает, разбирает, форматирует или конвертирует данные `value` для этого метода класса `FanTest\core\base\meta\TestMetaBlock`.

### `FanTest\core\base\meta\TestMetaMaker::__construct`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:101`
- Сигнатура: `function __construct(?TestMetaBlock $block = null)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\base\meta\TestMetaMaker`.

### `FanTest\core\base\meta\TestMetaMaker::replaceSource`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:115`
...
### `FanTest\core\base\meta\TestMetaMaker::mergeRow`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:129`
- Сигнатура: `function mergeRow(\fan\core\base\meta\row $row, array $data, $rewriteExisting = true)`
- Описание: Устанавливает, добавляет или сохраняет данные `row` в рамках этого метода класса `FanTest\core\base\meta\TestMetaMaker`.

### `FanTest\core\base\meta\TestMetaMaker::exposeMakeActiveMeta`

- Расположение: `unit/mock/core/base/meta/MetaDoubles.php:144`
...
## `unit/mock/core/block/FakeServices.php`

### `FanTest\core\block\FakeServiceRegistry::reset`

- Расположение: `unit/mock/core/block/FakeServices.php:15`
- Сигнатура: `function reset()`
- Описание: Удаляет или сбрасывает состояние `состояние` для этого метода класса `FanTest\core\block\FakeServiceRegistry`.

### `FanTest\core\block\FakeServiceRegistry::set`

- Расположение: `unit/mock/core/block/FakeServices.php:31`
- Сигнатура: `function set($name, $service)`
- Описание: Устанавливает, добавляет или сохраняет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeServiceRegistry`.

### `FanTest\core\block\FakeServiceRegistry::get`

- Расположение: `unit/mock/core/block/FakeServices.php:44`
- Сигнатура: `function get($name, $args = [])`
- Описание: Получает, читает или вычисляет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeServiceRegistry`.

### `FanTest\core\block\FakeRoleRegistry::reset`

- Расположение: `unit/mock/core/block/FakeServices.php:75`
- Сигнатура: `function reset()`
- Описание: Удаляет или сбрасывает состояние `состояние` для этого метода класса `FanTest\core\block\FakeRoleRegistry`.

### `FanTest\core\block\FakeRoleRegistry::set`

- Расположение: `unit/mock/core/block/FakeServices.php:89`
- Сигнатура: `function set($condition, $result)`
- Описание: Устанавливает, добавляет или сохраняет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeRoleRegistry`.

### `FanTest\core\block\FakeRoleRegistry::check`

- Расположение: `unit/mock/core/block/FakeServices.php:101`
- Сигнатура: `function check($condition)`
- Описание: Проверяет условие или валидирует данные `check` и возвращает результат либо выбрасывает исключение.

### `FanTest\core\block\FakeGenericService::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:117`
- Сигнатура: `function __construct($name)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeGenericService`.

### `FanTest\core\block\FakeSession::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:138`
- Сигнатура: `function __construct($args = [])`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeSession`.

### `FanTest\core\block\FakeSession::get`

- Расположение: `unit/mock/core/block/FakeServices.php:152`
- Сигнатура: `function get(mixed $key = null, mixed $default = null, $remove = false)`
- Описание: Получает, читает или вычисляет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeSession`.

### `FanTest\core\block\FakeSession::set`

- Расположение: `unit/mock/core/block/FakeServices.php:173`
- Сигнатура: `function set(mixed $key, mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeSession`.

### `FanTest\core\block\FakeSession::remove`

- Расположение: `unit/mock/core/block/FakeServices.php:187`
- Сигнатура: `function remove(mixed $key)`
- Описание: Удаляет или сбрасывает состояние `элемент` для этого метода класса `FanTest\core\block\FakeSession`.

### `FanTest\core\block\FakeSubscriber::subscribeForEvent`

- Расположение: `unit/mock/core/block/FakeServices.php:208`
- Сигнатура: `function subscribeForEvent($block, $eventName, $listenerMethod = 'eventHandler')`
- Описание: Выполняет логику `subscribe for event` и возвращает вычисленный результат.

### `FanTest\core\block\FakeSubscriber::subscribeByName`

- Расположение: `unit/mock/core/block/FakeServices.php:224`
- Сигнатура: `function subscribeByName($block, $broadcasterName, $eventName, $listenerMethod = 'eventHandler')`
- Описание: Выполняет логику `subscribe by name` и возвращает вычисленный результат.

### `FanTest\core\block\FakeSubscriber::subscribeByClass`

- Расположение: `unit/mock/core/block/FakeServices.php:240`
- Сигнатура: `function subscribeByClass($block, $className, $eventName, $listenerMethod = 'eventHandler')`
- Описание: Выполняет логику `subscribe by class` и возвращает вычисленный результат.

### `FanTest\core\block\FakeSubscriber::unSubscribeForEvent`

- Расположение: `unit/mock/core/block/FakeServices.php:255`
...
### `FanTest\core\block\FakeSubscriber::unSubscribeByName`

- Расположение: `unit/mock/core/block/FakeServices.php:271`
- Сигнатура: `function unSubscribeByName($block, $broadcasterName, $eventName, $listenerMethod = 'eventHandler')`
- Описание: Выполняет логику `un subscribe by name` и возвращает вычисленный результат.

### `FanTest\core\block\FakeSubscriber::unSubscribeByClass`

- Расположение: `unit/mock/core/block/FakeServices.php:287`
- Сигнатура: `function unSubscribeByClass($block, $className, $eventName, $listenerMethod = 'eventHandler')`
- Описание: Выполняет логику `un subscribe by class` и возвращает вычисленный результат.

### `FanTest\core\block\FakeSubscriber::broadcastEvent`

- Расположение: `unit/mock/core/block/FakeServices.php:302`
- Сигнатура: `function broadcastEvent($block, $eventName, $data = [])`
- Описание: Выполняет логику `broadcast event` и возвращает вычисленный результат.

### `FanTest\core\block\FakeViewDefiner::getViewParserName`

- Расположение: `unit/mock/core/block/FakeServices.php:318`
- Сигнатура: `function getViewParserName()`
- Описание: Получает, читает или вычисляет данные `view parser name` в рамках этого метода класса `FanTest\core\block\FakeViewDefiner`.

### `FanTest\core\block\FakeViewClass::getFormat`

- Расположение: `unit/mock/core/block/FakeServices.php:334`
- Сигнатура: `function getFormat()`
- Описание: Получает, читает или вычисляет данные `format` в рамках этого метода класса `FanTest\core\block\FakeViewClass`.

### `FanTest\core\block\FakeViewClass::getRouter`

- Расположение: `unit/mock/core/block/FakeServices.php:346`
- Сигнатура: `function getRouter($block)`
- Описание: Получает, читает или вычисляет данные `router` в рамках этого метода класса `FanTest\core\block\FakeViewClass`.

### `FanTest\core\block\FakeViewRouter::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:364`
- Сигнатура: `function __construct($block = null)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeViewRouter`.

### `FanTest\core\block\FakeViewRouter::set`

- Расположение: `unit/mock/core/block/FakeServices.php:377`
- Сигнатура: `function set($key, mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `значение` в рамках этого метода класса `FanTest\core\block\FakeViewRouter`.

### `FanTest\core\block\FakeViewRouter::getAll`

- Расположение: `unit/mock/core/block/FakeServices.php:388`
- Сигнатура: `function getAll()`
- Описание: Получает, читает или вычисляет данные `all` в рамках этого метода класса `FanTest\core\block\FakeViewRouter`.

### `FanTest\core\block\FakeTab::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:410`
- Сигнатура: `function __construct()`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::setCurrentBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:423`
- Сигнатура: `function setCurrentBlock($block)`
- Описание: Устанавливает, добавляет или сохраняет данные `current block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::setTabBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:438`
- Сигнатура: `function setTabBlock($block, $blockName)`
- Описание: Устанавливает, добавляет или сохраняет данные `tab block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::checkBlockStatus`

- Расположение: `unit/mock/core/block/FakeServices.php:451`
- Сигнатура: `function checkBlockStatus(\fan\core\block\base $block)`
- Описание: Проверяет условие или валидирует данные `block status` и возвращает результат либо выбрасывает исключение.

### `FanTest\core\block\FakeTab::getBlocksMetaByMain`

- Расположение: `unit/mock/core/block/FakeServices.php:463`
- Сигнатура: `function getBlocksMetaByMain($blockName)`
- Описание: Получает, читает или вычисляет данные `blocks meta by main` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::getViewClass`

- Расположение: `unit/mock/core/block/FakeServices.php:473`
- Сигнатура: `function getViewClass()`
- Описание: Получает, читает или вычисляет данные `view class` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::getViewDefiner`

- Расположение: `unit/mock/core/block/FakeServices.php:483`
- Сигнатура: `function getViewDefiner()`
- Описание: Получает, читает или вычисляет данные `view definer` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::getMainBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:493`
- Сигнатура: `function getMainBlock()`
- Описание: Получает, читает или вычисляет данные `main block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::setMainBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:505`
- Сигнатура: `function setMainBlock($block)`
- Описание: Устанавливает, добавляет или сохраняет данные `main block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::getTabBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:518`
- Сигнатура: `function getTabBlock($blockName, $allowException = true)`
- Описание: Получает, читает или вычисляет данные `tab block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::loadBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:530`
- Сигнатура: `function loadBlock($blockPath)`
- Описание: Получает, читает или вычисляет данные `block` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeTab::getSubscriber`

- Расположение: `unit/mock/core/block/FakeServices.php:540`
- Сигнатура: `function getSubscriber()`
- Описание: Получает, читает или вычисляет данные `subscriber` в рамках этого метода класса `FanTest\core\block\FakeTab`.

### `FanTest\core\block\FakeReflector::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:553`
- Сигнатура: `function __construct()`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeReflector`.

### `FanTest\core\block\FakeReflector::getParentPaths`

- Расположение: `unit/mock/core/block/FakeServices.php:567`
- Сигнатура: `function getParentPaths($block)`
- Описание: Получает, читает или вычисляет данные `parent paths` в рамках этого метода класса `FanTest\core\block\FakeReflector`.

### `FanTest\core\block\FakeLocale::getLanguage`

- Расположение: `unit/mock/core/block/FakeServices.php:582`
- Сигнатура: `function getLanguage()`
- Описание: Получает, читает или вычисляет данные `language` в рамках этого метода класса `FanTest\core\block\FakeLocale`.

### `FanTest\core\block\FakeMetaMaker::__construct`

- Расположение: `unit/mock/core/block/FakeServices.php:609`
- Сигнатура: `function __construct($block, $data = [])`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::setContainerMeta`

- Расположение: `unit/mock/core/block/FakeServices.php:624`
- Сигнатура: `function setContainerMeta($containerMeta)`
- Описание: Устанавливает, добавляет или сохраняет данные `container meta` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::setMainBlockMeta`

- Расположение: `unit/mock/core/block/FakeServices.php:635`
- Сигнатура: `function setMainBlockMeta()`
- Описание: Устанавливает, добавляет или сохраняет данные `main block meta` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::assembleBlock`

- Расположение: `unit/mock/core/block/FakeServices.php:646`
- Сигнатура: `function assembleBlock()`
- Описание: Создает, разбирает, форматирует или конвертирует данные `block` для этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::getMeta`

- Расположение: `unit/mock/core/block/FakeServices.php:660`
- Сигнатура: `function getMeta(mixed $key = null, mixed $default = null)`
- Описание: Получает, читает или вычисляет данные `meta` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::setMeta`

- Расположение: `unit/mock/core/block/FakeServices.php:687`
- Сигнатура: `function setMeta(mixed $key, mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `meta` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::getSource`

- Расположение: `unit/mock/core/block/FakeServices.php:714`
- Сигнатура: `function getSource(mixed $key = null)`
- Описание: Получает, читает или вычисляет данные `source` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

### `FanTest\core\block\FakeMetaMaker::getMixSrcMeta`

- Расположение: `unit/mock/core/block/FakeServices.php:737`
- Сигнатура: `function getMixSrcMeta()`
- Описание: Получает, читает или вычисляет данные `mix src meta` в рамках этого метода класса `FanTest\core\block\FakeMetaMaker`.

## `unit/mock/core/block/FrameworkStubs.php`

### `fan\core\base\meta\delayed::__construct`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:19`
- Сигнатура: `function __construct($value)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `fan\core\base\meta\delayed`.

### `fan\core\base\meta\delayed::getValue`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:29`
- Сигнатура: `function getValue()`
- Описание: Получает, читает или вычисляет данные `value` в рамках этого метода класса `fan\core\base\meta\delayed`.

### `fan\core\base\meta\row::__construct`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:46`
- Сигнатура: `function __construct($data = [])`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `fan\core\base\meta\row`.

### `fan\core\base\meta\row::offsetExists`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:60`
- Сигнатура: `function offsetExists(mixed $key): bool`
- Описание: Выполняет логику `offset exists` и возвращает вычисленный результат.

### `fan\core\base\meta\row::offsetGet`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:72`
- Сигнатура: `function offsetGet(mixed $key): mixed`
- Описание: Выполняет логику `offset get` и возвращает вычисленный результат.

### `fan\core\base\meta\row::offsetSet`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:85`
- Сигнатура: `function offsetSet(mixed $key, mixed $value): void`
- Описание: Выполняет workflow-логику `offset set`.

### `fan\core\base\meta\row::offsetUnset`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:101`
- Сигнатура: `function offsetUnset(mixed $key): void`
- Описание: Выполняет workflow-логику `offset unset`.

### `fan\core\base\meta\row::getIterator`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:111`
- Сигнатура: `function getIterator(): \Traversable`
...
- Расположение: `unit/mock/core/block/FrameworkStubs.php:121`
- Сигнатура: `function count(): int`
- Описание: Выполняет логику `count` и возвращает вычисленный результат.

### `fan\core\base\meta\row::mergeData`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:133`
- Сигнатура: `function mergeData(array $data)`
- Описание: Устанавливает, добавляет или сохраняет данные `data` в рамках этого метода класса `fan\core\base\meta\row`.

### `fan\core\base\meta\row::toArray`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:146`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `fan\project\exception\block\fatal::__construct`

- Расположение: `unit/mock/core/block/FrameworkStubs.php:171`
...
- Расположение: `unit/mock/core/block/FrameworkStubs.php:182`
- Сигнатура: `function getBlock()`
...
- Расположение: `unit/mock/core/block/FrameworkStubs.php:200`
- Сигнатура: `function __construct($block, $message = '', $code = 0, ?\Exception $previous = null)`
...
- Расположение: `unit/mock/core/block/FrameworkStubs.php:211`
- Сигнатура: `function getBlock()`
- Описание: Получает, читает или вычисляет данные `block` в рамках этого метода класса `fan\project\exception\block\local`.

## `unit/mock/core/block/GlobalFunctions.php`

### `service`

- Расположение: `unit/mock/core/block/GlobalFunctions.php:11`
...
- Расположение: `unit/mock/core/block/GlobalFunctions.php:25`
- Сигнатура: `function role($condition)`
- Описание: Runs the role operation and returns its result.
- Параметры: mixed $condition Input value for the condition argument.
- Возвращает: mixed Returns the value produced by the operation.
...
- Расположение: `unit/mock/core/block/GlobalFunctions.php:39`
...
- Расположение: `unit/mock/core/block/GlobalFunctions.php:57`
- Сигнатура: `function get_class_alt(mixed $value)`
- Описание: Retrieves class alt used by the framework helper.
- Параметры: mixed $value Value that should be applied or transformed.
- Возвращает: mixed Returns the value produced by the operation.
...
- Расположение: `unit/mock/core/block/GlobalFunctions.php:76`
- Сигнатура: `function parsePath($path)`
- Описание: Создает, разбирает, форматирует или конвертирует данные `path` для этого метода класса `bootstrap`.

### `bootstrap::getInitializer`

- Расположение: `unit/mock/core/block/GlobalFunctions.php:86`
- Сигнатура: `function getInitializer()`
- Описание: Получает, читает или вычисляет данные `initializer` в рамках этого метода класса `bootstrap`.

### `bootstrap::setServiceParam`

- Расположение: `unit/mock/core/block/GlobalFunctions.php:99`
...
- Расположение: `unit/mock/core/block/GlobalFunctions.php:116`
- Сигнатура: `function logError($message)`
- Описание: Выполняет workflow-логику `log error`.

## `unit/mock/core/block/TestableBaseBlock.php`

### `FanTest\core\block\TestableBaseBlock::useMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:24`
- Сигнатура: `function useMeta(array $meta)`
- Описание: Выполняет workflow-логику `use meta`.

### `FanTest\core\block\TestableBaseBlock::_createMetaMaker`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:34`
- Сигнатура: `function _createMetaMaker()`
- Описание: Выполняет логику `create meta maker` и возвращает вычисленный результат.

### `FanTest\core\block\TestableBaseBlock::getDynamicMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:47`
- Сигнатура: `function getDynamicMeta($meta)`
- Описание: Получает, читает или вычисляет данные `dynamic meta` в рамках этого метода класса `FanTest\core\block\TestableBaseBlock`.

### `FanTest\core\block\TestableBaseBlock::_transferor`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:59`
- Сигнатура: `function _transferor()`
- Описание: Выполняет workflow-логику `transferor`.

### `FanTest\core\block\TestableBaseBlock::_postCreate`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:69`
- Сигнатура: `function _postCreate()`
- Описание: Выполняет workflow-логику `post create`.

### `FanTest\core\block\TestableBaseBlock::_preOutput`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:79`
- Сигнатура: `function _preOutput()`
- Описание: Выполняет workflow-логику `pre output`.

### `FanTest\core\block\TestableBaseBlock::_doRoleOperations`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:89`
- Сигнатура: `function _doRoleOperations()`
- Описание: Выполняет workflow-логику `do role operations`.

### `FanTest\core\block\TestableBaseBlock::exposeSetMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:102`
...
### `FanTest\core\block\TestableBaseBlock::exposeAddMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:114`
- Сигнатура: `function exposeAddMeta(mixed $value)`
- Описание: Выполняет логику `expose add meta` и возвращает вычисленный результат.

### `FanTest\core\block\TestableBaseBlock::exposeSetMetaVar`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:127`
...
### `FanTest\core\block\TestableBaseBlock::exposeMakeDynamicMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:139`
...
### `FanTest\core\block\TestableBaseBlock::exposeSetRootBlockParameters`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:152`
...
### `FanTest\core\block\TestableBaseBlock::exposeSetTplVarsByMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:164`
...
### `FanTest\core\block\TestableBaseBlock::exposePreparseMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:174`
- Сигнатура: `function exposePreparseMeta()`
- Описание: Выполняет логику `expose preparse meta` и возвращает вычисленный результат.

### `FanTest\core\block\TestableBaseBlock::exposeSetTemplateInternal`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:186`
...
### `FanTest\core\block\TestableBaseBlock::exposeGetTplSuffixes`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:198`
...
### `FanTest\core\block\TestableBaseBlock::exposeCheckTemplate`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:213`
...
### `FanTest\core\block\TestableBaseBlock::exposeSetEmbeddedBlocks`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:223`
...
### `FanTest\core\block\TestableBaseBlock::exposeGetBlock`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:236`
...
### `FanTest\core\block\TestableBaseBlock::exposeMakeBlockException`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:252`
...
### `FanTest\core\block\TestableBaseBlock::exposeParseClassName`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:265`
...
### `FanTest\core\block\TestableBaseBlock::exposeSetCacheRole`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:277`
...
### `FanTest\core\block\TestableBaseBlock::exposeCallOrdinaryDelegate`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:291`
...
### `FanTest\core\block\TestableBaseBlock::exposeCallIdentifiedDelegate`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:305`
...
### `FanTest\core\block\TestableBaseBlock::exposeSetViewVar`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:318`
...
### `FanTest\core\block\TestableBaseBlock::setEmbeddedBlocksForTest`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:330`
- Сигнатура: `function setEmbeddedBlocksForTest(array $blocks)`
- Описание: Устанавливает, добавляет или сохраняет данные `embedded blocks for test` в рамках этого метода класса `FanTest\core\block\TestableBaseBlock`.

### `FanTest\core\block\TestableBaseBlock::setViewForTest`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:343`
- Сигнатура: `function setViewForTest($view)`
- Описание: Устанавливает, добавляет или сохраняет данные `view for test` в рамках этого метода класса `FanTest\core\block\TestableBaseBlock`.

### `FanTest\core\block\TestableBaseBlock::setMetaRowForTest`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:356`
- Сигнатура: `function setMetaRowForTest(\fan\core\base\meta\row $meta)`
- Описание: Устанавливает, добавляет или сохраняет данные `meta row for test` в рамках этого метода класса `FanTest\core\block\TestableBaseBlock`.

### `FanTest\core\block\FakeRootBlock::setMetaTag`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:375`
- Сигнатура: `function setMetaTag(mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `meta tag` в рамках этого метода класса `FanTest\core\block\FakeRootBlock`.

### `FanTest\core\block\FakeRootBlock::setExternalCss`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:387`
- Сигнатура: `function setExternalCss(mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `external css` в рамках этого метода класса `FanTest\core\block\FakeRootBlock`.

### `FanTest\core\block\FakeRootBlock::setEmbedCssByMeta`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:399`
- Сигнатура: `function setEmbedCssByMeta(mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `embed css by meta` в рамках этого метода класса `FanTest\core\block\FakeRootBlock`.

### `FanTest\core\block\FakeRootBlock::setExternalJs`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:411`
- Сигнатура: `function setExternalJs(mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `external js` в рамках этого метода класса `FanTest\core\block\FakeRootBlock`.

### `FanTest\core\block\FakeRootBlock::setEmbedJs`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:424`
- Сигнатура: `function setEmbedJs(mixed $value, $position)`
- Описание: Устанавливает, добавляет или сохраняет данные `embed js` в рамках этого метода класса `FanTest\core\block\FakeRootBlock`.

### `FanTest\core\block\ObjectWithToArray::__construct`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:443`
- Сигнатура: `function __construct(array $data)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\block\ObjectWithToArray`.

### `FanTest\core\block\ObjectWithToArray::toArray`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:453`
- Сигнатура: `function toArray()`
- Описание: Выполняет логику `to array` и возвращает вычисленный результат.

### `FanTest\core\block\DelegateTarget::callMe`

- Расположение: `unit/mock/core/block/TestableBaseBlock.php:468`
- Сигнатура: `function callMe()`
- Описание: Выполняет логику `call me` и возвращает вычисленный результат.

## `unit/mock/core/exception/ExceptionDoubles.php`

### `FanTest\core\exception\FakeRequestService::getInfoString`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:24`
- Сигнатура: `function getInfoString()`
- Описание: Получает, читает или вычисляет данные `info string` в рамках этого метода класса `FanTest\core\exception\FakeRequestService`.

### `FanTest\core\exception\FakeErrorService::logExceptionMessage`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:44`
- Сигнатура: `function logExceptionMessage(string $message, string $header = '', string $note = '')`
- Описание: Выполняет workflow-логику `log exception message`.
- Побочные эффекты: меняет HTTP/session состояние

### `FanTest\core\exception\FakeErrorService::logDatabaseError`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:60`
- Сигнатура: `function logDatabaseError($connectionName, string $operation, $errorMessage, int|float $errorNum, $parsedSql)`
- Описание: Выполняет workflow-логику `log database error`.

### `FanTest\core\exception\TestService::__construct`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:76`
- Сигнатура: `function __construct(?string $logType = 'service', ?string $dbOper = null)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\exception\TestService`.

### `FanTest\core\exception\TestService::isSingleton`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:87`
- Сигнатура: `function isSingleton()`
- Описание: Проверяет условие или валидирует данные `singleton` и возвращает результат либо выбрасывает исключение.

### `FanTest\core\exception\TestService::getConfigType`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:97`
- Сигнатура: `function getConfigType()`
- Описание: Получает, читает или вычисляет данные `config type` в рамках этого метода класса `FanTest\core\exception\TestService`.

### `FanTest\core\exception\TestService::setConfigValue`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:111`
- Сигнатура: `function setConfigValue(\fan\core\service\config\row $row, mixed $key, mixed $value)`
- Описание: Устанавливает, добавляет или сохраняет данные `config value` в рамках этого метода класса `FanTest\core\exception\TestService`.

### `FanTest\core\exception\TestService::resetConfigValue`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:124`
- Сигнатура: `function resetConfigValue(\fan\core\service\config\row $row, mixed $key)`
- Описание: Удаляет или сбрасывает состояние `config value` для этого метода класса `FanTest\core\exception\TestService`.

### `FanTest\core\exception\TestService::mergeConfigData`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:138`
...
- Описание: Устанавливает, добавляет или сохраняет данные `config data` в рамках этого метода класса `FanTest\core\exception\TestService`.

### `FanTest\core\exception\TestDatabaseService::__construct`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:152`
- Сигнатура: `function __construct(?string $connectionName = 'main', ?string $logType = 'nothing')`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\exception\TestDatabaseService`.

### `FanTest\core\exception\TestEntity::__construct`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:164`
- Сигнатура: `function __construct()`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\exception\TestEntity`.

### `FanTest\core\exception\TestEntity::__toString`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:173`
- Сигнатура: `function __toString()`
- Описание: Реализует магическое поведение PHP для этого метода класса `FanTest\core\exception\TestEntity`.

### `fan\project\service\error::instance`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:191`
- Сигнатура: `function instance()`
- Описание: Выполняет логику `instance` и возвращает вычисленный результат.

### `fan\project\service\error::reset`

- Расположение: `unit/mock/core/exception/ExceptionDoubles.php:204`
- Сигнатура: `function reset()`
- Описание: Удаляет или сбрасывает состояние `состояние` для этого метода класса `fan\project\service\error`.

## `unit/mock/core/exception/RuntimeStubs.php`

### `bootstrap::getInitializer`

- Расположение: `unit/mock/core/exception/RuntimeStubs.php:14`
- Сигнатура: `function getInitializer()`
- Описание: Получает, читает или вычисляет данные `initializer` в рамках этого метода класса `bootstrap`.

### `bootstrap::setServiceParam`

- Расположение: `unit/mock/core/exception/RuntimeStubs.php:27`
- Сигнатура: `function setServiceParam($class)`
- Описание: Устанавливает, добавляет или сохраняет данные `service param` в рамках этого метода класса `bootstrap`.

### `bootstrap::logError`

- Расположение: `unit/mock/core/exception/RuntimeStubs.php:44`
- Сигнатура: `function logError($message): void`
- Описание: Выполняет workflow-логику `log error`.

## `unit/mock/core/exception/TestException.php`

### `FanTest\core\exception\TestException::__construct`

- Расположение: `unit/mock/core/exception/TestException.php:20`
- Сигнатура: `function __construct($message, $nextDbOper = null, $code = E_USER_ERROR, ?\Exception $previous = null)`
- Описание: Инициализирует состояние объекта и его зависимости для этого метода класса `FanTest\core\exception\TestException`.

### `FanTest\core\exception\TestException::_defineDbOper`

- Расположение: `unit/mock/core/exception/TestException.php:34`
- Сигнатура: `function _defineDbOper($dbOper = null)`
- Описание: Выполняет логику `define db oper` и возвращает вычисленный результат.

### `FanTest\core\exception\TestException::exposeDefineDbOper`

- Расположение: `unit/mock/core/exception/TestException.php:46`
