...
return [
    'own' => [
        ...
        'addParam' => [ // NR. Add parameters
            ...
            'new_row_cond' => [ // NR. Set row for insert new data by condition.
                'field_name_0' => [
                    0 => ['value_1', 'value_2', /*....*/ 'value_N'], // 'condition' must be NOT equal to one of values
                    1 => ['value_1', 'value_2', /*....*/ 'value_N'], // 'condition' must be equal to one of values
                ],
                'field_name_1' => [
                    0 => ['value_1', 'value_2', /*....*/ 'value_N'], // Value for disable line 'new'
                    1 => ['value_1', 'value_2', /*....*/ 'value_N'], // Value for enable line 'new'
                ],
                // ....
            ],
            'convId' => ['!', 'default_conv_id'],
