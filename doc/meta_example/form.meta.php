...
return [
    ...
    'own' => [
        ...
        'form' => [
            ...
            'form_exceptions'  => ['value1','value2', 'etc'], //NR. If specified keys form id parsed always if they don't set
            ...
            'form_parts' => [], // NR. Set it for multi-part form in the main part. Contain list of form-parts and order of parsing them.
            ...
            'fields' => [
                'field_name1' => [
                    ...
                    'data' => [ //NR. Data for select, radio-group, etc
                        ['value' => 'value1', 'text' => 'text1'],
                        ['value' => 'value2', 'text' => 'text2'],
                        // ....
                    ],
                    'dataSource' => [ //NR. Method for get data.
                    ...
                    'attributes'    => [ //NR. List of additional attributes with arbitrary name and value
