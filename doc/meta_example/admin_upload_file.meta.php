...
/**
 * Example of meta file for upload different file
 * Note:
...
return [
    'own' => [
        'main_table' => [
            ...
            'file_id'    => 'id_of_image_table', // Not used if link table is set. Else NR. By default: "id_file_data"
        ],
        'link_table' => [ // Use if link table is set
            'table_name' => 'name_of_link_table',
            'main_id'    => 'id_of_main_table',
            'file_id'    => 'id_of_image_table', // NR. By default: "id_file_data"
        ],
